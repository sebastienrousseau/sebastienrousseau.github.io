...
banner_alt: "מבנה כספת קריפטוגרפית מופשט המואר באור כחול וזהוב — המחשה של הגבול הבטוח, בטוח-זיכרון, שבו hashes מורשתיים של סיסמאות משודרגים ל-Argon2id בזמן אמת"
banner_height: "1597"
banner_width: "2584"
...
תחת [Digital Operational Resilience Act (DORA)](https://eur-lex.europa.eu/eli/reg/2022/2554/oj), השארת נכסים קריפטוגרפיים מורשתיים, שלא הוחלפו, בייצור אינה עוד חוב טכני. זוהי אחריות רגולטורית מוגדרת.

[hsh](https://github.com/sebastienrousseau/hsh) סוגרת את הפער. מסגרת בטהור-Rust, היא מנהלת מספר פורמטי hash זה לצד זה ומשדרגת אישורים חלשים תוך כדי תנועה במהלך מפגשי כניסה פעילים. תשתית האימות מתיישרת עם דרישות החוסן של 2026 ללא חלון תחזוקה, ללא איפוס כפוי וללא שנייה אחת של השבתה.
...
[קוד המקור של hsh](https://github.com/sebastienrousseau/hsh) זמין תחת רישיון כפול MIT ו-Apache 2.0.
