...
<p class="post-lead-tldr"><strong>TL;DR.</strong> Cross-border corporate treasury in 2026 runs on four rails in parallel — SWIFT CBPR+, instant A2A under PSD3/FiDA, tokenised deposits, and stablecoin rails — stitched together by ISO 20022 as the common grammar. The work for CIB and corporate treasury teams is orchestration, not rail selection.</p>
<p class="post-lead-heading"><strong>Key takeaways</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Multi-rail is the default.</strong> No single rail clears every corridor, every ticket size, every cut-off. Treasury picks the rail per payment, not per bank.</li>
  <li><strong>ISO 20022 is the lingua franca.</strong> pacs.008, pacs.009 and pain.001 now carry remittance data across RTGS, instant, A2A and tokenised-deposit rails — making routing decisions data-driven rather than rail-locked.</li>
  <li><strong>Open finance widens the perimeter.</strong> PSD3 and FiDA push the open-banking model into pensions, insurance and treasury data; Nexi and Mastercard are building the orchestration layer corporates consume.</li>
  <li><strong>Tokenised deposits are the wholesale leg.</strong> Bank-issued tokenised deposits and integrated stablecoin rails sit underneath the customer-facing instant rail and settle the wholesale leg in near T+0.</li>
</ul>
<p class="post-lead-related"><strong>Related reading:</strong> <a href="https://sebastienrousseau.com/2026-06-07-autonomous-treasury-index-programmable-liquidity-tokenised-deposits-2026">The Autonomous Treasury Index 2026: Programmable Liquidity and Tokenised Deposits</a>, <a href="https://sebastienrousseau.com/2026-06-15-pacs008-automation-iso-20022-interbank-payments-2026">pacs.008 Automation: ISO 20022 Interbank Payments in 2026</a>.</p>
</aside>
<!-- lead-end -->
