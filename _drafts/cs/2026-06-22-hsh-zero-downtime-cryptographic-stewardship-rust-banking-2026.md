...
banner_alt: "Abstraktní struktura kryptografického trezoru osvětlená modrým a zlatým světlem — vizualizace bezpečné, paměťově odolné hranice, na níž jsou starší hashe hesel v reálném čase převáděny na Argon2id"
banner_height: "1597"
banner_width: "2584"
...
Podle [Nařízení o digitální provozní odolnosti (DORA)](https://eur-lex.europa.eu/eli/reg/2022/2554/oj) ponechání nerotovaných starších kryptografických aktiv v produkci už není technický dluh. Je to jmenovitě regulatorní odpovědnost.

[hsh](https://github.com/sebastienrousseau/hsh) tuto mezeru uzavírá. Čistě rustový rámec spravuje více hash formátů vedle sebe a upgraduje slabé přihlašovací údaje za běhu během aktivních přihlašovacích relací. Autentizační infrastruktura odpovídá mandátům odolnosti roku 2026 bez údržbového okna, bez vynuceného resetu, bez jediné sekundy výpadku.
...
[Zdrojový kód hsh](https://github.com/sebastienrousseau/hsh) je dostupný pod duální licencí MIT a Apache 2.0.

<aside class="author-card" aria-label="O autorovi"><img alt="Portrét Sebastiena Rousseaua" src="https://cloudcdn.pro/stocks/images/sebastien-rousseau.png" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">Senior bankovní technolog píšící o aplikované AI, migraci ISO 20022, postkvantové kryptografii pro finanční služby a o strukturální transformaci velkoobchodních plateb.</span><span class="author-credentials">20+ let napříč HSBC Commercial & Investment Bank, PayPal, Barclays a Shazam. <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
