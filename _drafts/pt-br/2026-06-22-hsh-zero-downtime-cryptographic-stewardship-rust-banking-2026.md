...
banner_alt: "Estrutura abstrata de cofre criptográfico iluminada por luz azul e dourada — visualizando a fronteira segura e memory-safe onde hashes de senhas legados são atualizados para Argon2id em tempo real"
banner_height: "1597"
banner_width: "2584"
...
O [código-fonte do hsh](https://github.com/sebastienrousseau/hsh) está disponível sob licença dupla MIT e Apache 2.0.

<aside class="author-card" aria-label="Sobre o autor"><img alt="Retrato de Sebastien Rousseau" src="https://cloudcdn.pro/stocks/images/sebastien-rousseau.png" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">Tecnólogo bancário sênior escrevendo sobre AI aplicada, migração ISO 20022, criptografia pós-quântica para serviços financeiros e a transformação estrutural dos pagamentos atacadistas.</span><span class="author-credentials">20+ anos em HSBC Commercial & Investment Bank, PayPal, Barclays, Shazam. <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
