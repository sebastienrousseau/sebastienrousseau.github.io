...
banner_alt: "Mavi ve altın ışıkla aydınlatılmış soyut kriptografik kasa yapısı — eski parola özetlerinin gerçek zamanlı olarak Argon2id'ye yükseltildiği güvenli, bellek-güvenli sınırı görselleştiriyor"
banner_height: "1597"
banner_width: "2584"
...
[Dijital Operasyonel Dayanıklılık Yasası (DORA)](https://eur-lex.europa.eu/eli/reg/2022/2554/oj) kapsamında, üretimde döndürülmemiş, eski kriptografik varlıkları bırakmak artık teknik borç değildir. Adı konmuş bir düzenleyici yükümlülüktür.

[hsh](https://github.com/sebastienrousseau/hsh) bu açığı kapatır. Saf Rust bir çerçevedir; birden fazla özet biçimini yan yana yönetir ve etkin oturum açma seansları sırasında zayıf kimlik bilgilerini akış halinde yükseltir. Kimlik doğrulama altyapısı 2026 dayanıklılık taleplerine bir bakım penceresi olmadan, bir zorunlu sıfırlama olmadan, tek bir saniyelik kesinti olmadan uyumlanır.
...
[hsh kaynak kodu](https://github.com/sebastienrousseau/hsh) MIT ve Apache 2.0 ikili lisansı altında erişilebilirdir.
