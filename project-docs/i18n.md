...
sequenceDiagram
 ...
 BT->>BT: inject hreflang block (35 entries + x-default)
...
## Adding a new article (34 translations)

You publish a new article by writing the English file first and then translating it for the other locales.

The build tool generates translations for the other thirty-four language folders automatically.
