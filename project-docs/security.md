...
> Per-component cryptographic hashes require hash-pinned dependencies
> (`requirements.txt` currently uses version ranges); adding `--hash` pins and
> surfacing hashes in the SBOM is tracked as a Phase 2 follow-up.
