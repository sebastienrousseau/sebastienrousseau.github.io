...
banner_alt: "夜間發光的資料中心機櫃堆疊——象徵 CloudCDN 所建構、可檢查且可由智能體控制的開源邊緣"
banner_height: "1597"
banner_width: "2584"
...
date: "2026年6月11日"
description: "CloudCDN 將 CDN 轉為以密碼學保障、可由智能體控制的邊緣控制平面——零信任 MCP 閘道、Durable Objects、SLSA Level 3 與 DORA 就緒證據。"
format-detection: "telephone=no"
hreflang: "zh-hant"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/zh-hant/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
...
permalink: "https://sebastienrousseau.com/zh-hant/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "CloudCDN:開源 AI原生邊緣藍圖"
short_name: "sebastienrousseau"
subtitle: "讓全球 CDN 從靜態內容快取,走向以密碼學保障、可由智能體控制的邊緣控制平面。"
tags: "CloudCDN, 開源, CDN, 邊緣, AI 智能體, MCP, Cloudflare Workers, Durable Objects, 速率限制, 零信任, WebAuthn, SLSA, DORA, BCBS 239, Basel III, 雲端原生銀行"
theme-color: "0, 83, 191"
title: "CloudCDN:2026 年 AI原生邊緣的開源藍圖"
url: "https://sebastienrousseau.com/zh-hant/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
...
item_description: "CloudCDN 將 CDN 轉為以密碼學保障、可由智能體控制的邊緣控制平面——零信任 MCP 閘道、Durable Objects、SLSA Level 3 與 DORA 就緒證據。"
...
item_title: "CloudCDN:2026 年 AI原生邊緣的開源藍圖"
...
apple-mobile-web-app-title: "CloudCDN 邊緣藍圖"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "CloudCDN 將 CDN 轉為以密碼學保障、可由智能體控制的邊緣控制平面——零信任 MCP 閘道、Durable Objects、SLSA Level 3 與 DORA 就緒證據。"
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "CloudCDN:開源 AI原生邊緣藍圖"
twitter_url: "https://sebastienrousseau.com/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
excerpt: "CloudCDN 是 AI原生邊緣的開源藍圖——具 42 項工具的零信任 MCP 閘道、Durable Objects 原子速率限制、WebAuthn passkeys、signed URLs、SLSA Level 3 來源證明,以及 3,185 項測試與 100% 覆蓋率,對應 DORA、BCBS 239 與 Basel III。"
...
<p class="post-lead-tldr"><strong>重點速覽。</strong>2026 年的企業技術,由全球分散式無伺服器執行與智能體 AI 的匯流所定義。為靜態檔案快取與基本流量路由而生的標準 CDN,在主動、即時資料協調的時代已屬結構性過時。CloudCDN 是一份開源藍圖,將邊緣重新定位為主動控制平面:無伺服器執行環境、透過 Cloudflare Durable Objects 的有狀態協調,以及零信任的模型上下文協定(Model Context Protocol,MCP)閘道,讓自主 AI 智能體在有界、以密碼學保障的操作範圍內運行 Web 基礎設施。</p>
...
sequenceDiagram
    autonumber
    participant Agent as AI 智能體 / LLM 用戶端
    participant MCP as 零信任 MCP 閘道
    participant DO as Durable Objects(狀態室)
    participant Worker as Cloudflare Workers 執行環境
    participant Edge as 邊緣 CDN / WAF 狀態
    Agent->>MCP: 以簽章酬載呼叫工具(修改路由)
    activate MCP
    Note over MCP: 驗證 WebAuthn passkey<br/>與密碼學簽章的 signed URL
    MCP->>MCP: 依 OPA 規則檢查政策
    alt 政策檢查未通過
        MCP-->>Agent: 拒絕存取(403 Unauthorized)
    else 政策檢查通過
        MCP->>DO: 查詢狀態與現行限額
        activate DO
        Note over DO: 驗證原子速率限制<br/>以防止競態條件
        DO-->>MCP: 限額確認並扣減
        deactivate DO
        MCP->>Worker: 派送有界執行
        activate Worker
        Worker->>Edge: 更新 WAF 規則 / 路由表
        Worker->>Worker: 附加密碼學日誌(SLSA 簽章)
        Worker-->>Agent: 動作完成(200 OK + 稽核雜湊)
        deactivate Worker
    end
    deactivate MCP
```
