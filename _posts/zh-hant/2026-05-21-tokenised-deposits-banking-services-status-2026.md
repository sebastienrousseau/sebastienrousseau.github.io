...
id: "https://sebastienrousseau.com/zh-hant/2026-05-21-tokenised-deposits-banking-services-status-2026"
...
permalink: "https://sebastienrousseau.com/zh-hant/2026-05-21-tokenised-deposits-banking-services-status-2026"
rating: "general"
...
url: "https://sebastienrousseau.com/zh-hant/2026-05-21-tokenised-deposits-banking-services-status-2026"
...
# 2026年的代幣化存款：銀行服務、穩定幣競爭與可程式化商業銀行貨幣的現況
...
穩定幣暴露了對可程式化、全天候數位貨幣的需求。銀行業的回應並非單純複製穩定幣，而是在保留銀行監管、存款關係與審慎管控的同時，將商業銀行貨幣調整到代幣化環境中。Deutsche Bank將代幣化存款描述為在保留商業銀行貨幣作用的同時，將現有銀行模式延伸至可程式化環境（[Deutsche Bank flow](https://flow.db.com/publications/flow-white-papers-and-guides/digital-money-a-perspective-on-stablecoins-tokenised-deposits-and-cbdcs "Digital Money")）。

此一區別至關重要。穩定幣通常是對發行方或準備金結構的債權。代幣化存款的設計意圖是保持為銀行存款或銀行存款的表徵，並附帶銀行的法律、審慎與營運架構。

## 2026年的現況：從試點走向產品，但尚未達到網路規模
...
Lloyds表示正在為企業及機構客戶開發與傳統交易銀行介面並存的錢包，可持有代幣化存款、數位資產與智能合約（[Lloyds Banking Group](https://www.lloydsbankinggroup.com/insights/digital-assets-2026.html "Digital assets in 2026")）。這是一項關鍵的設計選擇。若代幣化存款要求資金管理人放棄現有銀行工作流程，將難以規模化。

勝出的介面很可能是銀行帳戶與錢包的雙重模式。客戶看到的是資金管理平台，而銀行在後端處理轉換、結算路徑選擇與合規管控。

### 3. 穩定幣既製造緊迫感，也使風險更清晰

BIS在2026年4月的演講中肯定了穩定幣在智能合約可程式化與原子結算等技術特性方面的價值，但也強調了圍繞貨幣單一性、擠兌脆弱性、金融完整性、貨幣主權以及在中央銀行貨幣之外完成結算的風險（[BIS](https://www.bis.org/speeches/sp260420.pdf "Stablecoins: framing the debate")）。

這一批評正是代幣化存款的重要性所在。代幣化存款試圖將代幣化貨幣有用的可程式化引入受監管的商業銀行貨幣架構。

### 4. Project Agorá與統一帳本塑造批發問題
...
|---|---|---|---|---|
| **代幣化存款** | 商業銀行存款或其表徵 | 銀行主導的可程式化支付、資金管理、代幣化資產結算 | 試點及早期機構產品設計（[Lloyds Banking Group](https://www.lloydsbankinggroup.com/insights/digital-assets-2026.html "Digital assets in 2026")） | 互通性與法律一致性 |
| **穩定幣** | 對發行方／準備金結構的債權 | 加密流動性、跨境實驗、美元流動性 | 規模龐大且不斷成長，BIS估計2026年4月初市值約為3,150億美元（[BIS](https://www.bis.org/speeches/sp260420.pdf "Stablecoins: framing the debate")） | 擠兌、金融完整性、貨幣主權 |
...
企業錢包需要強身分認證、職責分離、交易策略、制裁篩查、稽核軌跡與復原管控。代幣化存款錢包並非貼著銀行標識的消費者加密錢包，而是資金管理的控制節點。
