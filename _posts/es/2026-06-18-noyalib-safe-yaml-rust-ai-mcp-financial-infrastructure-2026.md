...
| **Control de acceso de agentes** | Permisos limitados y de solo lectura para las herramientas de IA locales que operan vía configuraciones MCP. | Gestión del riesgo de modelos ([SR 11-7](https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm)) | Límites del servidor MCP que restringen las operaciones del agente a directorios aprobados. |
