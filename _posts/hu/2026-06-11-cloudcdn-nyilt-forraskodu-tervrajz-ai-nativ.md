...
- **Modellkockázat-kezelés ([US Fed SR 11-7 ⧉](https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "Supervisory Guidance on Model Risk Management") / UK PRA SS1/23).** A működési feladatokat végrehajtó autonóm modellek a modellkockázati irányítás alá tartoznak. A CloudCDN MCP átjárója az ügynöki eszközöket mennyiségi modellként kezeli: szigorú házirendkorlátok, valós idejű naplózás és kötelező, ember a folyamatban felülbírálások a nagy hatású műveletekhez.
