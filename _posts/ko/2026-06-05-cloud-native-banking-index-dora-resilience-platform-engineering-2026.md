...
banner_alt: "도시 스카이라인으로 이어지는 회로 기판 패턴 — 클라우드 네이티브 뱅킹의 시각적 등록부: 은행의 운영 패브릭에 짜여 들어간 플랫폼 엔지니어링 프리미티브."
banner_height: "571"
banner_width: "1425"
...
date: "June 5, 2026"
description: "DORA 준비도, 플랫폼 엔지니어링 성숙도, 클라우드 집중 위험, 출구 증거, 운영 회복력을 측정하는 2026년 클라우드 네이티브 뱅킹 지수."
format-detection: "telephone=no"
hreflang: "ko"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/ko/2026-06-05-cloud-native-banking-index-dora-resilience-platform-engineering-2026"
image_alt: "Sebastien Rousseau의 흑백 인물 사진"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastien-rousseau.png"
keywords: "클라우드 네이티브 뱅킹 2026, DORA 은행, 클라우드 집중 위험, 플랫폼 엔지니어링 은행, ICT 제3자 위험, 클라우드 출구 전략, 소버린 클라우드"
language: "ko-KR"
...
permalink: "https://sebastienrousseau.com/ko/2026-06-05-cloud-native-banking-index-dora-resilience-platform-engineering-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "2026년 클라우드 네이티브 뱅킹 지수"
short_name: "sebastienrousseau"
subtitle: "DORA 클라우드 회복력은 감사 단계에 들어섰습니다. 2026년 감독 사이클이 들여다보는 것은 2024-2025년에 내린 플랫폼 엔지니어링 결정 — Kubernetes 포장도로, Backstage 포털, GitOps, 어드미션 단계의 Open Policy Agent, 엔드투엔드 OpenTelemetry — 가 제8조 등록부 증거를 시험 시점이 아니라 배포 산출물로 생산하는지 여부입니다."
excerpt: "DORA 감사 단계에 들어선 클라우드 네이티브 뱅킹을 위한 엔지니어링 청사진. 다섯 개의 플랫폼 엔지니어링 프리미티브 — Kubernetes 포장도로, Backstage 포털, ArgoCD GitOps, Open Policy Agent 어드미션, 엔드투엔드 OpenTelemetry — 가 파이프라인 속도로 제8조 등록부 증거를 생산합니다. CTPP 의존 CIF에 대해 BIA 기반 RTO 목표 대비 출구 실행을 매년 시험합니다. 소버린 클라우드 옵션(AWS European Sovereign Cloud, Microsoft EU Data Boundary, Bleu, Thales / S3NS)은 브랜딩이 아닌 엔지니어링 의사결정으로 다룹니다."
tags: "클라우드 네이티브 뱅킹, DORA, 플랫폼 엔지니어링, 클라우드 회복력, 소버린 클라우드, 운영 복원력, ISO 20022, 양자내성 암호, AI, open source"
theme-color: "0, 83, 191"
title: "2026년 클라우드 네이티브 뱅킹 지수: DORA, 플랫폼 엔지니어링, 소버린 클라우드, 운영 회복력"
url: "https://sebastienrousseau.com/ko/2026-06-05-cloud-native-banking-index-dora-resilience-platform-engineering-2026"
...
item_description: "DORA 준비도, 플랫폼 엔지니어링 성숙도, 클라우드 집중 위험, 출구 증거, 운영 회복력을 측정하는 2026년 클라우드 네이티브 뱅킹 지수."
...
item_title: "2026년 클라우드 네이티브 뱅킹 지수: DORA, 플랫폼 엔지니어링, 소버린 클라우드, 운영 회복력"
...
apple-mobile-web-app-title: "2026년 클라우드 네이티브 뱅킹 지수"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "DORA 준비도, 플랫폼 엔지니어링 성숙도, 클라우드 집중 위험, 출구 증거, 운영 회복력을 측정하는 2026년 클라우드 네이티브 뱅킹 지수."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Sebastien Rousseau 로고"
twitter_site: "@wwdseb"
twitter_title: "2026년 클라우드 네이티브 뱅킹 지수"
...
<p class="post-lead-tldr"><strong>요약.</strong> 2026년 클라우드 네이티브 뱅킹은 준비 단계가 아니라 DORA 감사 단계에 있습니다. 규제는 2025년 1월 17일부터 시행되었고, 제28-44조에 따른 CTPP 지정 체계는 2025-2026년에 걸쳐 열리고 있으며, AWS, Microsoft(Azure), Google(GCP), Salesforce는 모두 지정 경계 안이나 그 인접 구역에 위치합니다. ECB의 [2026-28 감독 우선순위 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "ECB Banking Supervision priorities 2026-28")는 클라우드 중단 대비 및 위협 기반 침투 시험에 관한 명시적 프로그램을 담고 있습니다. 의미 있는 엔지니어링 작업은 Kubernetes 위 포장도로에 Backstage, OPA, OpenTelemetry를 결합한 플랫폼 엔지니어링 프리미티브 — DORA 제8조 등록부 증거를 배포 파이프라인 속도로 생산하는 동시에, 신뢰할 수 있는 대체 가능성과 문서상의 시늉을 가르는 시험된 출구 실행 증거를 만들어 내는 것 — 입니다.</p>
<p class="post-lead-heading"><strong>핵심 시사점</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>DORA 클라우드 회복력은 실제 집행 단계에 있습니다.</strong> 제6조(ICT 위험관리 프레임워크), 제8조(정보 등록부 + ITS), 제18조(4시간 사고 보고), 제26조(TIBER-EU 정합 TLPT), 제28-44조(CTPP 체계)가 2025년 1월 17일부터 모두 시행 중입니다. "DORA 대비"라는 프레임은 두 감독 사이클 뒤떨어진 표현입니다.</li>
  <li><strong>CTPP 지정 체계가 열리고 있습니다.</strong> AWS, Microsoft(Azure), Google(GCP), Salesforce가 지정 경계 안이나 그 인접 구역에 위치합니다. 지정은 유럽 감독당국(ESA)에 직접적 감독 권한 — 정보 요청, 현장 검사, 감독 권고 — 을 부여합니다. 클라우드 사업자 집중도는 이제 규제 대상 감독 지표입니다.</li>
  <li><strong>플랫폼 엔지니어링이 운영 모델의 산출물입니다.</strong> 다섯 가지로 지정된 런타임 프리미티브, 즉 Kubernetes 기반 포장도로, Backstage(또는 동등한) 개발자 포털, ArgoCD 또는 Flux 기반 GitOps, 어드미션 단계의 Open Policy Agent, 엔드투엔드 OpenTelemetry입니다. 파이프라인 속도의 증거가 시험 시점의 문서 패킷보다 우월합니다.</li>
  <li><strong>소버린 클라우드는 브랜딩이 아니라 엔지니어링입니다.</strong> AWS European Sovereign Cloud, Microsoft EU Data Boundary, Google Cloud의 소버린 파트너십(Bleu, Thales / S3NS), Oracle EU Sovereign Cloud, 그리고 Gaia-X 정합 옵션은 각각 Schrems II + DORA 제28조 + EBA/GL/2019/02 위탁 차원의 특정 문제를 다룹니다. 어느 것도 턴키 답안이 아닙니다.</li>
  <li><strong>시험된 출구 증거가 차별 요인입니다.</strong> EBA/GL/2019/02 81항과 113-117항은 출구 계획 PDF가 아니라 대체 가능성 평가와 출구 전략 실행 증거를 요구합니다. 분기별 탁상 훈련은 충분하지 않으며, 감독자는 모든 핵심·중요 기능에 대해 연 1회 이상의 엔드투엔드 출구 실행 시험을 기대합니다.</li>
  <li><strong>RTO와 RPO 수치는 플랫폼 편의가 아니라 CIF 인벤토리에서 도출됩니다.</strong> 각 핵심·중요 기능(CIF)에는 등급 기반 RTO / RPO 목표 — 일반적으로 Tier 1은 2h / 15min, Tier 2는 4h / 1h, Tier 3은 24h / 4h — 가 부여되며, 이는 기관의 비즈니스 영향 분석에서 도출되는 것이지 플랫폼 팀이 제공할 수 있는 수준에서 도출되는 것이 아닙니다.</li>
</ul>
</aside>
<!-- lead-end -->

2026년 클라우드 네이티브 뱅킹은 DORA 감사 단계에 있습니다. [규정 (EU) 2022/2554 ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA — Digital Operational Resilience Act")는 2025년 1월 17일부터 시행되고 있습니다. 제28-44조에 따른 중요 제3자 제공자(CTPP) 지정 체계는 2025-2026년에 걸쳐 열리고 있으며, AWS, Microsoft(Azure), Google(GCP), Salesforce가 지정 경계 안이나 그 인접 구역에 위치합니다. 유럽 감독당국(EBA, EIOPA, ESMA)은 2024년에 [정보 등록부 ⧉](https://www.eba.europa.eu/sites/default/files/2024-01/0e155f7a-9b09-4dba-89cb-37f7e8e1c540/JC%202023%2086%20-%20Final%20report%20on%20draft%20ITS%20on%20Register%20of%20information%20under%20DORA.pdf "ESAs ITS on Register of Information")에 관한 최종 RTS와 ITS를 발표했습니다. ECB 은행감독팀은 [2026-28 감독 우선순위 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Supervisory priorities 2026-28")에서 클라우드 중단 대비와 위협 기반 침투 시험에 관한 명시적 프로그램을 두고 있습니다. 기관이 마주한 질문은 클라우드 전략을 DORA에 맞출지 여부 — 이는 이미 결론이 났습니다 — 가 아니라, 기관의 플랫폼 엔지니어링 프리미티브가 시험 일주일 전에 만들어진 PDF가 아니라 배포 파이프라인 속도로 증거를 생산하느냐는 것입니다.
...
| 신호 | 은행에 갖는 의미 | 출처 |
|---|---|---|
| **DORA 2025년 1월 17일부터 실제 집행** | 2025년 4분기에 1차 감독 지적사항 도착, 2차 지적사항은 2026년 하반기 예상 | [EUR-Lex ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA") |
| **2025-2026년에 걸친 CTPP 지정 개시** | AWS, Microsoft, Google, Salesforce가 경계 안이나 인접 구역에 위치, 지정은 ESA에 직접 감독권 부여 | [EBA ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "EBA — DORA direct supervision and oversight") |
| **ECB 2026-28 감독 우선순위가 클라우드 중단을 명시적으로 거명** | 모형화된 감독 시나리오가 지정 CTPP의 장기 장애를 흡수할 능력을 시험 | [ECB Banking Supervision ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Supervisory priorities 2026-28") |
| **TIBER-EU가 DORA 제26조에 정합화** | TLPT 범위가 클라우드 호스팅 서비스를 포함한 핵심·중요 기능을 커버 | [ECB TIBER-EU ⧉](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "TIBER-EU") |
| **EBA 위탁 가이드라인(EBA/GL/2019/02)이 DORA 제28조와 맞물림** | 실질적 존재(64항), 대체 가능성 평가(81항), 출구 전략(113-117항) — 감독자가 실제로 시험하는 항목 | [EBA ⧉](https://www.eba.europa.eu/regulation-and-policy/internal-governance/guidelines-on-outsourcing-arrangements "EBA Outsourcing Guidelines") |
| **EU Cloud Services Scheme(EUCS) 초안 진전** | EU 사이버보안법에 따른 향후 소버린 클라우드 인증 체계, ENISA가 초안 공개 | [ENISA EUCS ⧉](https://www.enisa.europa.eu/publications/eucs-cloud-service-scheme "EUCS — Cybersecurity Scheme for Cloud Services") |
...
중앙 개발자 포털 — Spotify의 오픈소스 [Backstage ⧉](https://backstage.io/ "Backstage developer portal")가 참조 구현이며 다양한 엔터프라이즈 대안 존재 — 이 무엇이 어디에서 동작하는지에 관한 단일 진실 공급원을 제공합니다. 카탈로그는 모든 서비스, 소유자, 의존성, 중요도 분류, 런북, 온콜 로테이션을 나열합니다. 포털은 제8조 등록부와 맞물려, 모든 카탈로그 항목이 등록부 항목과 매핑되고, 등록부 참조가 없는 항목은 CI 실패를 유발하며, 카탈로그에 존재하지 않는 등록부 항목은 감독자 대응에 앞서 작동하는 경보를 트리거합니다.

### 3. ArgoCD 또는 Flux를 통한 GitOps 배포

운영 배포는 GitOps 컨트롤러 — 2026년 운영 표준은 ArgoCD 또는 Flux — 를 통해 진행되며, Git에서 버전 관리되는 선언적 상태를 동작 중인 클러스터와 정합화합니다. 수동 `kubectl apply`는 비활성화되어 있으며, 운영으로 가는 유일한 경로는 머지된 풀 리퀘스트입니다. Git 저장소가 감사 추적이 되며, "Y일 시점 서비스 X의 구성을 보여달라"는 감독자의 요청에는 스크린샷이 아니라 Git 태그로 응답합니다.
...
1. **데이터가 어디에서 처리되고 저장되는가?** EU 회원국 위치, 고중요도 흐름에 대한 하위 리전, 서면화된 데이터 거주성 약정.
2. **누가 데이터에 대한 법적 접근권을 갖는가?** 현지 인력 전담 운영, 외국 정부 접근 요청은 현지 법원 절차 적용, 적법한 접근 요청에 대한 시험된 대응.
3. **대체 가능성 프로파일은 무엇인가?** EBA/GL/2019/02 81항 대체 가능성 평가, 시험된 출구 실행, 식별되고 계약된 대체 사업자(또는 실현 불가 사유 문서화).
4. **기술적 주권 모델은 무엇인가?** 고객 통제 키, 암호학적 분리, 소버린 관리 평면, 감사 가능한 공급망.
...
[EBA/GL/2019/02 ⧉](https://www.eba.europa.eu/regulation-and-policy/internal-governance/guidelines-on-outsourcing-arrangements "EBA Outsourcing Guidelines") 113-117항이 출구 전략 조항입니다. 본문은 요구사항을 명시적으로 적고 있습니다. "기관과 결제 기관은 사업 활동에 부당한 중단 없이 위탁 약정에서 빠져나올 수 있어야 한다… 출구 전략은 위탁 약정의 정기 검토의 일환으로 문서화되고 시험되어야 한다."
