...
<p class="post-lead-related"><strong>관련 읽을거리:</strong> <a href="https://sebastienrousseau.com/2026-05-19-global-wholesale-payments-economics-2026">2026년 글로벌 대규모 결제: ISO 20022, RTGS 재편, 상호운용성의 경제학</a>, <a href="https://sebastienrousseau.com/2026-05-27-ai-operating-system-payments-fraud-routing-resilience-compliance-2026">결제의 운영체제로서의 AI: 2026년 사기 탐지, 라우팅, 회복력, 컴플라이언스</a>, <a href="https://sebastienrousseau.com/2026-05-12-iso-20022-pacs008-structured-address-deadline">2026년 11월 pacs.008 구조화 주소 마감일: 6개월 관점</a>.</p>
</aside>
<!-- lead-end -->
...
## 내가 pacs008을 이렇게 만든 이유

`pacs008`과 그 상류의 자매 라이브러리인 `pain001`은 내가 작성했고, 나는 홀세일
지급결제와 API 제품 관리에 직업 인생을 쓰고 있다. 이 라이브러리의 모양은 그
조합에서 나온다. 그래서 판단을 코드 안에 암묵적으로 남겨 두기보다 명시적으로
적어 두는 편이 낫다.

**검증은 생성 이후가 아니라 이전에 실행된다.** 대다수 지급결제 자산에서의 본능은
메시지를 만들고 나서 확인하는 것이다. 검토 절차가 그렇게 형성되어 있기 때문이다.
파일이 만들어지고, 누군가 살펴보고, 예외는 대기열로 간다. 이 순서는 결함이 지렛대
효과가 가장 작은 지점에서 발견되도록 보장한다. 메시지를 조립하는 작업이 이미 끝난
뒤이고, 흔히 그것이 기관을 떠난 뒤다. 먼저 검증한다는 것은 규정에 맞지 않는 주소나
잘못된 IBAN이 네트워크 거절이 아니라 빌드 실패가 된다는 뜻이다.

**라이선스가 MIT인 이유는 은행이 검증 로직을 신뢰하는 것이 아니라 읽어야 하기
때문이다.** 닫힌 검증기는 이용 지침에 대한 다른 사람의 해석을 그대로 믿고 받아
들이라고 기관에 요구한다. 규제 의무를 지는 팀에게 그것은 합리적인 요구가 아니다.
이 라이브러리의 모든 규칙은 검사하고, 이의를 제기하고, 포크할 수 있다.

**검증은 재구현이 아니라 공식 XSD 스키마를 기준으로 이루어진다.** ISO 20022
규칙을 손으로 근사한 것은 어느 한쪽이 바뀌는 순간 네트워크의 실제 계약에서
어긋난다. 스키마가 곧 계약이며, 그 밖의 것은 모두 어긋나기를 기다리는 두 번째
진실의 출처일 뿐이다.

**검토 단계가 아니라 CI를 겨냥한다.** 사람이 실행을 기억해야 하는 검증기는 마감
압박 아래에서 실행되지 않게 되는 검증기다. 바로 가장 중요한 그때 말이다.

이 라이브러리가 의도적으로 하지 않는 일도 똑같이 의도적이다. 이것은 메시지 계층의
도구 모음이다. 지급결제 엔진이나 제재 스크리닝 시스템, 또는 기관이 원천에서
수행해야 하는 고객 마스터데이터 정비를 대체하지 않는다. 그 정비를 강제할 수 있게
만들 뿐, 대신해 주지는 않는다.
...
<!-- enrich-start -->
<aside class="author-card" aria-label="저자 소개"><img alt="Sebastien Rousseau의 인물 사진" src="https://cloudcdn.pro/stocks/images/sebastienrousseau.webp" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">응용 AI, ISO 20022 이행, 금융 서비스용 양자내성 암호, 대규모 결제의 구조적 전환에 관해 집필하는 시니어 뱅킹 기술 전문가입니다.</span><span class="author-credentials">HSBC 상업·투자은행, PayPal, Barclays, Shazam, AKQA, Virgin Group을 아우르는 20년 이상의 경력. <a href="/about/index.html">전체 프로필</a> &middot; <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
<p class="post-reviewed">최종 검토 <time datetime="2026-06-15">2026-06-15</time>.</p>
<aside class="related-posts" aria-labelledby="related-heading">
<h2 id="related-heading" class="related-heading">관련 읽을거리</h2>
<div class="related-grid">
<article class="related-card"><a href="https://sebastienrousseau.com/2026-05-19-global-wholesale-payments-economics-2026" class="related-media" aria-label="2026년 글로벌 대규모 결제: ISO 20022, RTGS 재편, 상호운용성의 경제학" tabindex="-1"><img alt="2026년 글로벌 대규모 결제 아키텍처 지도 — ISO 20022, RTGS 재편, 국경 간 결제 통로, 유동성 윈도, DLT 결제 시범 사업을 보여 줌" src="https://cloudcdn.pro/stocks/images/meiying-ng-OrwkD-iWgqg.webp" loading="lazy" decoding="async" width="600" height="400" /></a><footer class="related-body"><h3><a href="https://sebastienrousseau.com/2026-05-19-global-wholesale-payments-economics-2026">2026년 글로벌 대규모 결제: ISO 20022, RTGS 재편, 상호운용성의 경제학</a></h3><p><time datetime="2026-05-19">2026-05-19</time></p></footer></article>
<article class="related-card"><a href="https://sebastienrousseau.com/2026-05-27-ai-operating-system-payments-fraud-routing-resilience-compliance-2026" class="related-media" aria-label="결제의 운영체제로서의 AI: 2026년 사기 탐지, 라우팅, 회복력, 컴플라이언스" tabindex="-1"><img alt="AI 결제 운영체제 다이어그램 — 사기 스코어링, 멀티 레일 라우팅, 유동성 예측, ISO 20022 데이터, 컴플라이언스 스크리닝, 예외 수리를 보여 줌" src="https://cloudcdn.pro/stocks/images/corporate-finance-1200.webp" loading="lazy" decoding="async" width="600" height="400" /></a><footer class="related-body"><h3><a href="https://sebastienrousseau.com/2026-05-27-ai-operating-system-payments-fraud-routing-resilience-compliance-2026">결제의 운영체제로서의 AI: 2026년 사기 탐지, 라우팅, 회복력, 컴플라이언스</a></h3><p><time datetime="2026-05-27">2026-05-27</time></p></footer></article>
<article class="related-card"><a href="https://sebastienrousseau.com/2026-05-12-iso-20022-pacs008-structured-address-deadline" class="related-media" aria-label="2026년 11월 pacs.008 구조화 주소 마감일: 6개월 관점" tabindex="-1"><img alt="ISO 20022 pacs.008 구조화 주소 다이어그램 — 국경 간 결제 메시지 필드, TwnNm과 Ctry 강조" src="https://cloudcdn.pro/stocks/images/markus-winkler-IrRbSND5EUc-unsplash.webp" loading="lazy" decoding="async" width="600" height="400" /></a><footer class="related-body"><h3><a href="https://sebastienrousseau.com/2026-05-12-iso-20022-pacs008-structured-address-deadline">2026년 11월 pacs.008 구조화 주소 마감일: 6개월 관점</a></h3><p><time datetime="2026-05-12">2026-05-12</time></p></footer></article>
</div>
</aside>
<!-- enrich-end -->
