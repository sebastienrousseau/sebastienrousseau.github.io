...
sequenceDiagram
    autonumber
    participant CB_A as वाणिज्यिक बैंक A
    participant UL as एकीकृत लेज़र
    participant CBNK as केंद्रीय बैंक
    participant CB_B as वाणिज्यिक बैंक B
    CB_A->>UL: निर्देश प्रस्तुत करें: टोकनयुक्त जमा X डेबिट करें, टोकनयुक्त जमा Y क्रेडिट करें, शर्त = थोक CBDC लेग
    UL->>UL: ISO 20022 एनवेलप, संरचित पता, LEI, उद्देश्य कोड, AML/सैंक्शन्स सत्यापित करें
    UL->>CBNK: थोक CBDC आरक्षित करें (भुगतानकर्ता-पक्ष केंद्रीय-बैंक रिज़र्व)
    CBNK-->>UL: आरक्षण की पुष्टि (परमाणु लॉक)
    UL->>CB_A: टोकनयुक्त जमा X लॉक करें (वाणिज्यिक-बैंक धन लेग)
    CB_A-->>UL: जमा लॉक की पुष्टि
    UL->>UL: दोनों लेग लॉक → परमाणु निपटान ट्रिगर
    UL->>CBNK: थोक CBDC निपटाएँ (भुगतानकर्ता रिज़र्व → प्राप्तकर्ता रिज़र्व)
    UL->>CB_B: टोकनयुक्त जमा Y जारी करें (वाणिज्यिक-बैंक धन लेग)
    CBNK-->>UL: CBDC निपटान अंतिम
    CB_B-->>UL: जमा क्रेडिट हुआ
    UL->>CB_A: PvP निपटान पूर्ण (दोनों लेग अंतिम या दोनों लेग रोलबैक)
