...
banner_alt: "一座建筑的转角,包覆着密布细孔的白色格栅,在明亮的天空下自下方仰拍。"
banner_height: "1597"
banner_width: "2584"
...
date: "July 29, 2026"
description: "DORA 的 TLPT 制度把红队演练变成一项受监管的义务。真正的约束不是技术,而是测试服务商市场、三年周期,以及你的第三方提供商。"
format-detection: "telephone=no"
hreflang: "zh-hans"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/zh-hans/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
image_alt: "Sebastien Rousseau 的黑白肖像"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "基于威胁的渗透测试, threat-led penetration testing, TLPT, DORA Article 26, DORA Article 27, Commission Delegated Regulation 2025/1190, TIBER-EU, 红队演练, red teaming, 威胁情报, threat intelligence, 紫队, purple teaming, ICT 第三方风险, 运营韧性, operational resilience, 金融实体, 主管当局, 批发银行, 检测工程, detection engineering"
language: "zh-hans"
...
permalink: "https://sebastienrousseau.com/zh-hans/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "DORA TLPT:红队已成为一条受监管的供应链"
short_name: "sebastienrousseau"
subtitle: "写给银行 CISO 与韧性负责人的操作解读:DORA Article 26 项下的监管技术标准,把对手模拟变成了一项受监管、必须产出证据的义务;而真正卡住你的约束不是技术,而是通过认证认可的测试服务商市场、三年一轮的执行周期,以及你的关键职能所依赖的那些第三方。"
tags: "DORA, 基于威胁的渗透测试, TLPT, TIBER-EU, 红队演练, 运营韧性, 第三方风险, 安全架构, 银行业, 合规监管, 检测工程"
theme-color: "0, 83, 191"
title: "红队已成为一条受监管的供应链:DORA 的 TLPT 制度究竟要求什么"
...
item_description: "DORA 的 TLPT 制度把红队演练变成一项受监管的义务。真正的约束不是技术,而是测试服务商市场、三年周期,以及你的第三方提供商。"
...
item_title: "红队已成为一条受监管的供应链:DORA 的 TLPT 制度究竟要求什么"
...
twitter_description: "DORA 的 TLPT 制度把红队演练变成一项三年一轮的受监管义务。真正的约束是通过认证认可的测试服务商市场、外部威胁情报,以及你的第三方提供商。"
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Sebastien Rousseau 的标识"
twitter_site: "@wwdseb"
twitter_title: "DORA TLPT:红队已成为一条受监管的供应链"
twitter_url: "https://sebastienrousseau.com/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
excerpt: "多数银行已经算过这场测试的成本。算过它如今所依赖的那条供应链的,要少得多:一个踩在同一个三年时钟上、需要认证认可的测试服务商市场,以及每一次都必须来自外部的威胁情报。"
...
<ul class="post-lead-takeaways">
  <li><strong>是被指定,不是自评。</strong>由主管当局依据系统重要性、规模和 ICT 风险状况,认定哪些实体必须开展 TLPT。微型企业不在其内。你无法主动加入,也无法悄悄退出。</li>
  <li><strong>供应商市场才是约束条件。</strong>Article 27 设定了认证认可或正式行为准则要求、一份独立鉴证报告,以及涵盖不当行为与过失的职业责任保险。这是一个很小的池子,而欧盟境内每一家被指定实体都踩在同一个三年时钟上。</li>
  <li><strong>内部红队撑不起整个项目。</strong>他们最多可以承担三次测试中的两次,且须经监管批准并控制利益冲突——而且无论如何,威胁情报都必须来自机构外部。</li>
  <li><strong>你外包出去的关键职能也在测试范围内。</strong>当一项关键或重要职能依赖某个 ICT 第三方提供商时,该提供商可以被拉进测试。合同必须在划定测试范围的对话之前就允许这件事,而不是之后。</li>
</ul>
<p class="post-lead-related"><strong>延伸阅读:</strong><a href="https://sebastienrousseau.com/2026-06-08-banking-resilience-index-ai-cloud-quantum-payments-third-party-risk-2026">2026 银行韧性指数</a>、<a href="https://sebastienrousseau.com/2026-05-28-dora-ai-act-data-sovereignty-banking-compliance-stack-2026">DORA、欧盟《人工智能法案》与数据主权</a>。</p>
</aside>
<!-- lead-end -->
...
* 欧盟委员会,2025\. *Commission Delegated Regulation (EU) 2025/1190,就基于威胁的渗透测试的监管技术标准补充 Regulation (EU) 2022/2554*。布鲁塞尔:欧盟官方公报。可查阅:[欧盟委员会,2025\.](https://eur-lex.europa.eu/eli/reg_del/2025/1190/oj "欧盟委员会,2025。")。  
* 欧洲中央银行,2026\. *TIBER-EU:基于威胁情报的道德红队演练欧洲框架*。美因河畔法兰克福:欧洲中央银行。可查阅:[欧洲中央银行,2026\.](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "欧洲中央银行,2026。")。
