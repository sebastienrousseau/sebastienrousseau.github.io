...
banner_alt: "Um banco longo e escuro em uma vasta praça pavimentada, vista diretamente de cima, com uma única figura sentada na extremidade direita e o piso aberto estendendo-se a partir dela."
banner_height: "1597"
banner_width: "2584"
...
date: "July 30, 2026"
description: "A revisão de abril de 2026 do risco de modelo deixou a IA generativa e agentic fora do escopo. Fora do escopo não é fora do risco, e o Reino Unido discorda."
format-detection: "telephone=no"
hreflang: "pt-br"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/pt-br/2026-07-30-model-risk-management-generative-ai-out-of-scope-2026"
image_alt: "Retrato em preto e branco de Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "gestão de risco de modelo, SR 26-2, SR 11-7, OCC Bulletin 2026-13, governança de IA generativa, agentic AI, PRA SS1/23, EU AI Act, validação de modelos, questionamento efetivo, risco de terceiros, consulta pública, supervisão bancária, divergência transatlântica, inventário de modelos"
language: "pt-br"
...
permalink: "https://sebastienrousseau.com/pt-br/2026-07-30-model-risk-management-generative-ai-out-of-scope-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "Fora do escopo não é fora do risco: SR 26-2 e IA generativa"
short_name: "sebastienrousseau"
subtitle: "Uma leitura de governança para diretores de risco e responsáveis por risco de modelo: as agências dos EUA reescreveram a gestão de risco de modelo em abril de 2026 e excluíram expressamente a IA generativa e a IA agentic, enquanto a declaração supervisória tecnologicamente neutra do Reino Unido continua a trazer os mesmos modelos para dentro — deixando bancos de grupo operando um mesmo modelo sob duas respostas."
tags: "risco de modelo, IA generativa, governança de IA, SR 26-2, PRA SS1/23, EU AI Act, supervisão bancária, conformidade regulatória, validação, risco de terceiros, bancos"
theme-color: "0, 83, 191"
title: "Fora do escopo não é fora do risco: a revisão de 2026 e IA generativa"
url: "https://sebastienrousseau.com/pt-br/2026-07-30-model-risk-management-generative-ai-out-of-scope-2026"
...
item_description: "A revisão de abril de 2026 do risco de modelo deixou a IA generativa e agentic fora do escopo. Fora do escopo não é fora do risco, e o Reino Unido discorda."
...
item_title: "Fora do escopo não é fora do risco: a revisão de 2026 e IA generativa"
...
apple-mobile-web-app-title: "Risco de Modelo 2026"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "As agências dos EUA excluíram expressamente a IA generativa e agentic da revisão de risco de modelo. Fora do escopo não é fora do risco, e o Reino Unido discorda."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo de Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Fora do escopo não é fora do risco: SR 26-2 e IA generativa"
twitter_url: "https://sebastienrousseau.com/2026-07-30-model-risk-management-generative-ai-out-of-scope-2026"
excerpt: "Quinze anos de doutrina de risco de modelo foram reescritos em abril, e o parágrafo que mais pesa em um comitê de risco em 2026 é o que diz o que a orientação não cobre."
...
<ul class="post-lead-takeaways">
  <li><strong>A exclusão é explícita, não um descuido.</strong> "Modelos de IA generativa e de IA agentic são novos e evoluem rapidamente. Como tal, não estão no escopo desta orientação supervisória." As agências então se comprometem com uma consulta pública que cobre exatamente esses modelos.</li>
  <li><strong>Fora do escopo não é fora do risco.</strong> Uma ferramenta de GenAI que redige pareceres de crédito ou faz a triagem de alertas de fraude continua caindo sob risco de terceiros, risco operacional, proteção ao consumidor e concessão equitativa de crédito. Nada na revisão de abril a retira desses perímetros.</li>
  <li><strong>O Reino Unido não seguiu.</strong> A SS1/23 é deliberadamente neutra quanto à tecnologia e traz IA e aprendizado de máquina para o escopo. Mesmo modelo, mesma instituição, duas respostas supervisórias dos dois lados do Atlântico.</li>
  <li><strong>O intervalo é o risco.</strong> A instituição que pausar seu trabalho de risco de modelo sobre GenAI até a consulta pública se resolver terá acumulado dois anos de implantação não documentada quando isso acontecer.</li>
</ul>
<p class="post-lead-related"><strong>Leitura relacionada:</strong> <a href="https://sebastienrousseau.com/2026-07-01-agentic-ai-index-banks-measuring-autonomy-2026">O índice de Agentic AI para bancos em 2026</a>, <a href="https://sebastienrousseau.com/2026-05-28-dora-ai-act-data-sovereignty-banking-compliance-stack-2026">DORA, o EU AI Act e a soberania de dados</a>.</p>
</aside>
<!-- lead-end -->
...
1. **Refaça a linha de base contra a orientação revisada agora.** Confirme quais dos seus modelos existentes se deslocam sob a linguagem explícita de proporcionalidade, nas duas direções. Alguns exigirão menos; outros exigirão mais.
2. **Não remova nada do inventário de modelos por causa da exclusão de IA.** A remoção é uma decisão que envelhecerá muito mal, e redescobrir custa mais do que reter.
3. **Marque todo sistema generativo e agentic no inventário como pendente de classificação.** Torne o intervalo visível no registro em vez de ausente dele.
4. **Mapeie cada um para os arcabouços aos quais ele de fato responde** — terceiros, operacional, proteção ao consumidor, concessão equitativa de crédito — e confirme que cada um tem um dono nomeado sob esses arcabouços.
5. **Adote o padrão transatlântico mais rigoroso como política do grupo.** Um inventário, uma régua de validação, um pacote de evidências.
6. **Prepare uma resposta à consulta pública.** É a influência mais barata disponível sobre o padrão contra o qual você será examinado.
...
* Conselho de Governadores do Sistema da Reserva Federal, 2026\. *SR 26-2: Revised Guidance on Model Risk Management*. Washington, DC: Federal Reserve. Disponível em: [Conselho de Governadores do Sistema da Reserva Federal, 2026\.](https://www.federalreserve.gov/supervisionreg/srletters/SR2602.htm "Conselho de Governadores do Sistema da Reserva Federal, 2026.").  
* Controladoria da Moeda dos EUA (OCC), 2026\. *OCC Bulletin 2026-13, Model Risk Management: Revised Guidance*. Washington, DC: OCC. Disponível em: [Controladoria da Moeda dos EUA (OCC), 2026\.](https://www.occ.gov/news-issuances/bulletins/2026/bulletin-2026-13.html "Controladoria da Moeda dos EUA (OCC), 2026.").  
* Autoridade de Regulação Prudencial (PRA), 2023\. *SS1/23, Model risk management principles for banks*. Londres: Banco da Inglaterra. Disponível em: [Autoridade de Regulação Prudencial (PRA), 2023\.](https://www.bankofengland.co.uk/prudential-regulation/publication/2023/may/model-risk-management-principles-for-banks-ss "Autoridade de Regulação Prudencial (PRA), 2023.").  
* Parlamento Europeu e Conselho da União Europeia, 2024\. *Regulation (EU) 2024/1689 laying down harmonised rules on artificial intelligence (Artificial Intelligence Act)*. Bruxelas: Jornal Oficial da União Europeia. Disponível em: [Parlamento Europeu e Conselho da União Europeia, 2024\.](https://eur-lex.europa.eu/eli/reg/2024/1689/oj "Parlamento Europeu e Conselho da União Europeia, 2024.").
