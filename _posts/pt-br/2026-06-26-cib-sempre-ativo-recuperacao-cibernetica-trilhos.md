...
**QKD** fornece distribuição de chaves com segurança informacional entre data centres que carregam cargas de trabalho sempre ativas. Não é um substituto para PQC. É uma camada complementar para os poucos enlaces em que a garantia físico-matemática da troca de chaves vale o custo. O texto anterior do autor — [QKD em wholesale banking: onde chaves de qualidade física realmente compensam](https://sebastienrousseau.com/2026-06-04-quantum-safe-banking-index-pqc-qkd-crypto-agility-2026) — estabelece o limite.

**PQC**, especificamente [FIPS 203](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.203.pdf "FIPS 203 — Module-Lattice-Based Key-Encapsulation Mechanism") e [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf "FIPS 204 — Module-Lattice-Based Digital Signature Standard"), agora assina os manifests dos trilhos de contingência, os snapshots dos cofres de recuperação cibernética e as cadeias de confiança entre domínios primário e de contingência. Um CIB em 2026 que assine artefatos de failover com RSA clássico está reportando uma não conformidade ao seu regulador. O texto [FHE em análises bancárias](https://sebastienrousseau.com/2024-03-25-fully-homomorphic-encryption-in-a-banking-quantum-era) defendeu o mesmo no domínio analítico — o argumento de resiliência o estende de forma limpa à recuperação.
