...
banner_alt: "Uma malha urbana densa fotografada de cima à noite, com milhares de prédios iluminados e ruas que se cruzam até as bordas do enquadramento."
banner_height: "1187"
banner_width: "1920"
...
date: "July 31, 2026"
description: "O FiDA não é a PSD2 com mais endpoints. Adesão a um esquema, acesso a dados com preço e escopo muito maior tornam o open finance um mercado obrigatório."
format-detection: "telephone=no"
hreflang: "pt-br"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/pt-br/2026-07-31-fida-open-finance-data-sharing-schemes-banks-2026"
image_alt: "Retrato em preto e branco de Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "FiDA, Financial Data Access, open finance, esquema de compartilhamento de dados financeiros, FDSS, PSD2, PSD3, open banking, detentor dos dados, usuário de dados, painel de permissões, remuneração de dados, estratégia de API, regulação da UE, dados do cliente, banco de atacado, banco de varejo"
language: "pt-br"
...
permalink: "https://sebastienrousseau.com/pt-br/2026-07-31-fida-open-finance-data-sharing-schemes-banks-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "FiDA: open finance é um mercado, não uma API"
short_name: "sebastienrousseau"
subtitle: "Uma leitura estratégica para líderes de open banking e monetização de dados: a proposta europeia de Acesso a Dados Financeiros substitui o modelo unilateral de conformidade da PSD2 por adesão a esquemas e acesso precificado, o que converte uma obrigação técnica em uma negociação comercial da qual os bancos hoje estão ausentes."
tags: "open finance, FiDA, PSD2, open banking, estratégia de dados, regulação da UE, APIs, bancos, monetização de dados, conformidade regulatória, dados do cliente"
theme-color: "0, 83, 191"
title: "A PSD2 exigiu uma API. O FiDA exige entrar num mercado."
url: "https://sebastienrousseau.com/pt-br/2026-07-31-fida-open-finance-data-sharing-schemes-banks-2026"
...
item_description: "O FiDA não é a PSD2 com mais endpoints. Adesão a um esquema, acesso a dados com preço e escopo muito maior tornam o open finance um mercado obrigatório."
...
item_title: "A PSD2 exigiu uma API. O FiDA exige entrar num mercado."
...
apple-mobile-web-app-title: "FiDA e open finance"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "O FiDA não é a PSD2 com mais endpoints. Adesão a esquemas, acesso precificado e escopo maior fazem do open finance um mercado obrigatório — e os termos estão sendo escritos agora."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logotipo de Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "FiDA: open finance é um mercado, não uma API"
twitter_url: "https://sebastienrousseau.com/2026-07-31-fida-open-finance-data-sharing-schemes-banks-2026"
excerpt: "Sob a PSD2, o banco cumpria sozinho: construir o endpoint, publicar a especificação, pronto. O FiDA não tem via unilateral. A conformidade passa por um esquema, desenhado agora."
...
# A PSD2 exigiu uma API. O FiDA exige entrar num mercado.
...
<p class="post-lead-tldr"><strong>Resumo.</strong> O FiDA não é a PSD2 com mais endpoints. Três rupturas estruturais mudam o significado de conformidade: o acesso é governado por um esquema ao qual você precisa aderir, e não por uma interface que você constrói sozinho; os detentores dos dados podem pleitear remuneração razoável, de modo que o acesso vira um produto precificado e não um dever gratuito; e o escopo alcança crédito imobiliário, poupança, investimentos, previdência e seguros não vida — os produtos com os quais os bancos realmente ganham dinheiro. O texto ainda está em trílogo, mas os esquemas que definirão os padrões estão sendo desenhados agora, e é aí que está a alavancagem.</p>
<p class="post-lead-heading"><strong>Pontos principais</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Não dá para cumprir a norma unilateralmente.</strong> Um Esquema de Compartilhamento de Dados Financeiros é um acordo-quadro multilateral que cobre padrões, requisitos de interface, alocação de responsabilidade e resolução de disputas. A adesão é a rota de conformidade.</li>
  <li><strong>O acesso a dados passa a ter preço.</strong> Diferentemente do acesso gratuito a contas de pagamento da PSD2, a proposta permite aos detentores dos dados uma remuneração razoável vinculada ao custo de disponibilizar os dados. Essa é uma capacidade de precificação que a maioria dos bancos não tem.</li>
  <li><strong>O escopo alcança os produtos rentáveis.</strong> Crédito imobiliário, empréstimos, poupança, investimentos, criptoativos, previdência e seguros não vida — não apenas a conta corrente.</li>
  <li><strong>O texto não é final, e é justamente esse o ponto.</strong> O FiDA quase foi retirado no início de 2025 e sobreviveu. Segue em trílogo, e os regulamentos dos esquemas estão sendo redigidos em paralelo por quem aparecer.</li>
</ul>
<p class="post-lead-related"><strong>Leitura relacionada:</strong> <a href="https://sebastienrousseau.com/2026-05-24-uk-payments-forward-plan-stablecoins-open-banking-tokenised-payments-2026">O plano de pagamentos do Reino Unido em 2026</a>, <a href="https://sebastienrousseau.com/2026-05-29-iso-20022-after-migration-payment-data-banking-products-2026">ISO 20022 depois da migração: transformar dados de pagamento em produtos bancários</a>.</p>
</aside>
<!-- lead-end -->
...
1. **Coloque alguém na conversa do esquema.** Não um arquiteto — um negociador comercial com mandato sobre responsabilidade e preço. Essa é a ação de maior alavancagem disponível e a mais frequentemente adiada.
2. **Custeie a provisão de dados agora.** Construa o modelo de atribuição enquanto a questão é interna. Uma metodologia de remuneração inventada sob pressão de negociação não resistirá ao escrutínio.
3. **Comece a resolução de identidade antes de o escopo ser definido.** Toda versão do FiDA exige saber que o seu cliente é um cliente só. Nada disso muda no trílogo.
4. **Construa o livro-razão de permissões, não o painel.** O artefato visível é uma semana de front-end. O registro por baixo dele é a parte com cauda de dois anos.
5. **Faça o inventário honesto dos silos.** Identifique quais produtos no escopo hoje não conseguem produzir dados estruturados e atuais. Essa lista é o verdadeiro plano do programa.
6. **Acompanhe o escopo, não as manchetes.** Os parâmetros com maior chance de se mover no trílogo — quais produtos, quais dados, que prazos — são exatamente os que o seu plano deve absorver sem redesenho.
...
* Comissão Europeia, 2023\. *Pacote de acesso a dados financeiros e pagamentos*. Bruxelas: Direção-Geral da Estabilidade Financeira, dos Serviços Financeiros e da União dos Mercados de Capitais. Disponível em: [Comissão Europeia, 2023\.](https://finance.ec.europa.eu/publications/financial-data-access-and-payments-package_en "Comissão Europeia, 2023.").  
* Comissão Europeia, 2023\. *Proposta de Regulamento relativo a um quadro para o Acesso a Dados Financeiros, COM(2023) 360*. Bruxelas: Comissão Europeia. Disponível em: [Comissão Europeia, 2023\.](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A52023PC0360 "Comissão Europeia, 2023.").  
* Parlamento Europeu, 2026\. *Legislative Train Schedule: um novo quadro de open finance*. Bruxelas: Parlamento Europeu. Disponível em: [Parlamento Europeu, 2026\.](https://www.europarl.europa.eu/legislative-train/spotlight-JD%2023-24/file-new-open-finance-frameworkb "Parlamento Europeu, 2026.").  
* Parlamento Europeu e Conselho da União Europeia, 2015\. *Directive (EU) 2015/2366 relativa aos serviços de pagamento no mercado interno (PSD2)*. Bruxelas: Jornal Oficial da União Europeia. Disponível em: [Parlamento Europeu e Conselho da União Europeia, 2015\.](https://eur-lex.europa.eu/eli/dir/2015/2366/oj "Parlamento Europeu e Conselho da União Europeia, 2015.").
