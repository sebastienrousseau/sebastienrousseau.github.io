...
tags: "агентный ИИ, ИИ в банках, управление ИИ, автономные рабочие процессы, модельный риск, аудируемость, ISO 20022, DORA, постквантовая криптография, AI, open source, облачно-нативный банкинг, инженерия платформы, суверенное облако"
...
Во-первых, регуляторы перестали относиться к LLM как к новинке. ФРС разъяснила, что [SR 11-7 ⧉](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "SR 11-7: руководство по управлению модельным риском") применим к принятию решений на основе LLM независимо от того, классифицируется ли LLM внутри банка как модель. [SS1/23 ⧉](https://www.bankofengland.co.uk/prudential-regulation/publication/2023/may/model-risk-management-principles-for-banks-ss "Надзорное заявление SS1/23") от PRA всегда был достаточно широким, чтобы их охватить. Классификация EU AI Act как «высокий риск» покрывает большинство сценариев использования LLM в финансовых услугах. Аргумента «мы не уверены, считается ли это» больше не осталось.
...
- Federal Reserve, (2011). [SR 11-7: руководство по управлению модельным риском ⧉](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "SR 11-7: руководство по управлению модельным риском").
