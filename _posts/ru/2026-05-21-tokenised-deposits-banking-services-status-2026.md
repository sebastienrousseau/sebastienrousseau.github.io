...
Помимо JPMorgan и HSBC, несколько программ материальны для сетевой картины, даже если их публичные раскрытия скуднее. SG-FORGE от Société Générale выпустила цифровые облигации в евро и регулируемый евростейблкоин наряду с работой над токенами-депозитами, что ставит Société Générale в необычное положение, когда оба направления функционируют под европейским регулированием. Standard Chartered активен в токенизированных депозитах и в токенизированных реальных активах через Zodia Custody и собственные сингапурские пилоты. Платформа GS DAP от Goldman Sachs выпустила цифровые облигации и поддерживает токенизированный залог. Более широкое следствие очевидно: способность к токенам-депозитам теперь является обязательной для любого глобального оптового банка, рассчитывающего оставаться конкурентоспособным в транзакционном банкинге, а более интересный вопрос — кто с кем совместим, а не кто построит первым.
