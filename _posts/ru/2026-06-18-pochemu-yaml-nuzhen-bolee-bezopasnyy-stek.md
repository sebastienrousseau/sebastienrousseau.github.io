...
| **Контроль доступа агента** | Ограниченные разрешения только на чтение для локальных ИИ-инструментов, работающих через MCP-конфигурации. | Управление модельным риском ([SR 11-7](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm)) | Границы серверов MCP, ограничивающие операции агента утверждёнными каталогами. |
