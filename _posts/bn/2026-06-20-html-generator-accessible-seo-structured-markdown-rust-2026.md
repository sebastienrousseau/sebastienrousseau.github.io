...
<p class="post-lead-tldr"><strong>TL;DR.</strong> HTML Generator হল একটি বিশুদ্ধ-Rust Markdown-থেকে-HTML কম্পাইলার যা বিল্ড টাইমে WCAG 2.1 AA প্রয়োগ করে, স্কিমা-সম্মত JSON-LD ইনজেক্ট করে, MathML ও Mermaid SVG নেটিভভাবে রেন্ডার করে, এবং একটি WebAssembly স্যান্ডবক্সের মধ্যে পার্সিং আইসোলেট করে — পাবলিশিংকে অ্যাক্সেসিবিলিটি, SEO এবং ICT নিরাপত্তার জন্য একটি কম্পাইল-গেটেড নিয়ন্ত্রণ কেন্দ্রে পরিণত করে।</p>
...
graph TD
    %% Ingest & Parse
    subgraph Ingest_AST[ইনজেস্ট ও AST পার্সিং]
        A1[কাঁচা Markdown এবং YAML ফ্রন্ট ম্যাটার] --> B(HTML Generator কম্পাইলার কোর)
        B --> C{WASM স্যান্ডবক্স সীমানা}
    end

    %% Build Gates
    subgraph Secure_Build_Gates[সুরক্ষিত বিল্ড গেট]
        C --> D{HTML AST পার্সার}
        D -->|WCAG নিয়ম লঙ্ঘিত: সমতল হেডার বা অনুপস্থিত alt টেক্সট| E[কম্পাইলার হল্ট করুন এবং বিল্ড ব্যর্থ করুন]
        D -->|WCAG 2.1 AA সম্মত| F[সমৃদ্ধ-কন্টেন্ট কম্পাইলার]
    end

    %% Hardening & Output
    subgraph Enrichment[সমৃদ্ধকরণ ও কম্পাইলেশন]
        F -->|গণিত MathML-এ কম্পাইল করুন| G[MathML জেনারেটর]
        F -->|ডায়াগ্রাম SVG-তে রেন্ডার করুন| H[Mermaid SVG জেনারেটর]
        F -->|মেটাডেটা নিষ্কাশন| I[JSON-LD স্কিমা ইনজেক্টর]
        G --> J[মিনিফাইড, শক্তিশালী HTML আউটপুট]
        H --> J
        I --> J
    end
