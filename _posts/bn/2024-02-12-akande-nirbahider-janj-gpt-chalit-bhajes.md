...
banner_alt: "একটি সাদা, গোলাকার আধুনিক ডিভাইস"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Feb 12, 2024"
description: "Àkàndé একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা OpenAI Whisper স্পিচ রিকগনিশন, GPT-4 চ্যাট কমপ্লিশন এবং স্থানীয় SQLite ক্যাশ একত্রিত করে PDF সারসংক্ষেপ তৈরি করে ও সব ডেটা স্থানীয়ভাবে সংরক্ষণ করে।"
format-detection: "telephone=no"
hreflang: "bn"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/bn/2024-02-12-akande-voice-assistant-revolutionising-personal-and-executive-assistance"
image_alt: "A black and white photo of Sebastien Rousseau"
image_height: "161"
image_width: "161"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "Àkàndé, OpenAI GPT-4, Whisper STT, SQLite ক্যাশিং, fpdf2, Python ভয়েস অ্যাসিস্ট্যান্ট, chat completions API, PDF সারসংক্ষেপ তৈরি, SHA-256 ক্যাশ, টেক্সট-টু-স্পিচ, এক্সিকিউটিভ AI অ্যাসিস্ট্যান্ট, ওপেন-সোর্স"
language: "bn"
layout: "report"
locale: "bn_BD"
...
permalink: "https://sebastienrousseau.com/bn/2024-02-12-akande-voice-assistant-revolutionising-personal-and-executive-assistance"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্টের আর্কিটেকচার: Whisper, GPT-4, SQLite ক্যাশ এবং fpdf2"
tags: "Àkàndé, GPT4, WhisperSTT, SQLiteCache, fpdf2, PythonVoiceAssistant, ChatCompletionsAPI, PDFসারসংক্ষেপ, open source, ExecutiveAI, ISO 20022, পোস্ট-কোয়ান্টাম ক্রিপ্টোগ্রাফি, AI, DORA, প্ল্যাটফর্ম ইঞ্জিনিয়ারিং, সার্বভৌম ক্লাউড, ক্লাউড নেটিভ ব্যাংকিং"
theme-color: "0, 67, 165"
title: "Àkàndé: নির্বাহীদের জন্য GPT-চালিত ভয়েস অ্যাসিস্ট্যান্ট"
url: "https://sebastienrousseau.com/bn/2024-02-12-akande-voice-assistant-revolutionising-personal-and-executive-assistance"
...
item_description: "Àkàndé একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা Whisper, GPT-4 ও SQLite ক্যাশ ব্যবহার করে PDF সারসংক্ষেপ তৈরি করে এবং সব ডেটা স্থানীয়ভাবে রাখে।"
...
item_title: "Àkàndé: এক্সিকিউটিভদের জন্য GPT-চালিত ভয়েস অ্যাসিস্ট্যান্ট"
...
twitter_description: "Àkàndé একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা Whisper, GPT-4 ও SQLite ক্যাশ ব্যবহার করে PDF সারসংক্ষেপ তৈরি করে এবং সব ডেটা স্থানীয়ভাবে রাখে।"
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Àkàndé: এক্সিকিউটিভদের GPT ভয়েস অ্যাসিস্ট্যান্ট"
...
excerpt: "Àkàndé একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা OpenAI Whisper স্পিচ রিকগনিশন, GPT-4 চ্যাট কমপ্লিশন এবং স্থানীয় SQLite ক্যাশ একত্রিত করে fpdf2-এর মাধ্যমে PDF সারসংক্ষেপ তৈরি করে এবং কোনো ক্লাউড স্টোরেজ ছাড়াই সমস্ত ডেটা স্থানীয়ভাবে সংরক্ষণ করে।"
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="নিবন্ধের সারসংক্ষেপ">
<p class="post-lead-tldr"><strong>সংক্ষেপে।</strong> <a href="https://akande.co">Àkàndé</a> হল একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা তিনটি উপাদানের উপর নির্মিত: স্পিচ-টু-টেক্সটের জন্য OpenAI Whisper, প্রাকৃতিক ভাষা বোঝার ও প্রতিক্রিয়া তৈরির জন্য GPT-4 Chat Completions API, এবং নরমালাইজড কোয়েরি স্ট্রিংয়ের SHA-256 হ্যাশের উপর ভিত্তি করে একটি স্থানীয় SQLite ক্যাশ। কথোপকথনের ইতিহাস fpdf2 এর মাধ্যমে ফর্ম্যাটেড PDF হিসেবে রপ্তানি করা হয়। OpenAI API কলের বাইরে কোনো দূরবর্তী পরিষেবায় কোনো কথোপকথনের ডেটা সংরক্ষিত হয় না।</p>
<p class="post-lead-heading"><strong>মূল বিষয়সমূহ</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>SQLite ক্যাশ অপ্রয়োজনীয় API কল দূর করে।</strong> কোয়েরি প্রতিক্রিয়াগুলি নরমালাইজড কোয়েরি স্ট্রিংয়ের SHA-256 হ্যাশের অধীনে সংরক্ষিত হয়; ক্যাশ হিট লাইভ GPT-4 API রাউন্ড-ট্রিপের ~600–900 ms এর তুলনায় 10 ms এর কম সময়ে ফিরে আসে এবং টোকেনে কিছুই খরচ হয় না।</li>
  <li><strong>Whisper স্থানীয় মডেল ছাড়াই বহুভাষিক ইনপুট পরিচালনা করে।</strong> অডিও <code>openai.audio.transcriptions.create()</code> এন্ডপয়েন্টে জমা দেওয়া হয়, যা 99টি ভাষা সমর্থন করে; ট্রান্সক্রিপশন সার্ভার-সাইডে চলে তাই হোস্ট মেশিনে কোনো বড় ASR মডেলের প্রয়োজন নেই।</li>
  <li><strong>মাল্টি-টার্ন প্রসঙ্গ ক্লায়েন্ট-সাইডে পরিচালিত হয়।</strong> Àkàndé সেশনের সময়কাল জুড়ে মেমরিতে একটি <code>messages</code> তালিকা রাখে, প্রতিটি টার্নে Chat Completions API-তে সম্পূর্ণ কথোপকথনের ইতিহাস পাস করে — GPT প্রসঙ্গ উইন্ডোর মধ্যে প্রসঙ্গ বজায় রাখার মানক প্যাটার্ন।</li>
  <li><strong>PDF রপ্তানি স্বয়ংক্রিয় পেজিনেশন সহ fpdf2 ব্যবহার করে।</strong> সম্পূর্ণ সেশন ট্রান্সক্রিপ্ট fpdf2 এর <code>multi_cell()</code> পদ্ধতি ব্যবহার করে পেজিনেটেড হয়, স্পিকার লেবেল, টাইমস্ট্যাম্প এবং কনফিগারযোগ্য ফন্ট সংরক্ষণ করে, তারপর ডিস্কে লেখা হয় — কোনো ক্লাউড আপলোড প্রয়োজন নেই।</li>
</ul>
<p class="post-lead-related"><strong>সম্পর্কিত পাঠ:</strong> <a href="https://sebastienrousseau.com/2024-03-12-revolutionising-real-time-speech-recognition-on-macos-with-openai-whisper/">macOS-এ রিয়েল-টাইম স্পিচ রিকগনিশন: OpenAI Whisper</a>, <a href="https://sebastienrousseau.com/2024-01-29-ai-powered-audio-insights-analysis-translations/">Audio Analyser: Azure Speech, NLP এবং অনুবাদ পাইপলাইন</a>, <a href="https://sebastienrousseau.com/2024-01-23-advancements-in-ai-prompt-engineering/">AI প্রম্পট ইঞ্জিনিয়ারিং 2024: কার্যকর কৌশল</a>।</p>
</aside>
<!-- lead-end -->

> **নির্বাহী সারসংক্ষেপ / মূল বিষয়সমূহ**
>
> - **[Àkàndé ⧉][00]** হল একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা OpenAI Whisper স্পিচ-টু-টেক্সট, GPT-4 চ্যাট কমপ্লিশন, একটি স্থানীয় SQLite রেসপন্স ক্যাশ এবং fpdf2 PDF রপ্তানিকে একক ভয়েস-চালিত ওয়ার্কফ্লোতে সংযুক্ত করে — কোনো ক্লাউড স্টোরেজ এবং কোনো স্থানীয় AI মডেল ওজন ছাড়াই।
...
[**Àkàndé ⧉**][00] হল একটি ওপেন-সোর্স Python ভয়েস অ্যাসিস্ট্যান্ট যা তিনটি সংযোজনযোগ্য উপাদানকে ঘিরে নির্মিত: স্পিচ রিকগনিশনের জন্য OpenAI Whisper, ভাষা বোঝার ও তৈরির জন্য GPT-4 Chat Completions API, এবং রেসপন্স ক্যাশিং ও সেশন ধারাবাহিকতার জন্য একটি স্থানীয় SQLite ডেটাবেস। ফলাফল হল একটি ভয়েস-চালিত ওয়ার্কফ্লো যা স্থানীয় মডেল ওজন, অফলাইন স্টোরেজ অবকাঠামো বা কন্টেইনার স্ট্যাক ছাড়াই ল্যাপটপে চালানো যায়।
...
PDF রপ্তানি [fpdf2](https://py-pdf.github.io/fpdf2/) ব্যবহার করে — কোনো বাইনারি নির্ভরতা ছাড়াই একটি রক্ষণাবেক্ষণকৃত Python PDF লাইব্রেরি:
...
**সেশন শেষ হওয়ার পরে Àkàndé কি কথোপকথনের ইতিহাস ধরে রাখে?**
ইন-মেমরি `messages` তালিকা প্রক্রিয়া প্রস্থান করলে বাতিল হয়। কথোপকথনের ইতিহাস কেবল তখনই ধরে রাখা হয় যদি ব্যবহারকারী একটি PDF রপ্তানি ট্রিগার করেন বা একটি কাস্টম পার্সিস্টেন্স লেয়ার যোগ করা হয়। SQLite ক্যাশ কোয়েরি হ্যাশ এবং রেসপন্স টেক্সট সংরক্ষণ করে, সম্পূর্ণ কথোপকথনের প্রসঙ্গ নয়।

**ক্যাশ কীভাবে অনুরূপ কিন্তু অভিন্ন নয় এমন কোয়েরি পরিচালনা করে?**
ক্যাশ নরমালাইজড কোয়েরি স্ট্রিংয়ে exact-match হ্যাশিং ব্যবহার করে। একটি শব্দে পার্থক্য থাকা দুটি কোয়েরি ভিন্ন হ্যাশ তৈরি করবে এবং পৃথক API কলে পরিণত হবে। সিমেন্টিক ক্যাশিং (প্রায় ডুপ্লিকেট কোয়েরি মেলানোর জন্য এমবেডিং সাদৃশ্য ব্যবহার করা) একটি অতিরিক্ত ভেক্টর লুকআপ পদক্ষেপের প্রয়োজন হবে এবং বেস ইমপ্লিমেন্টেশনের অংশ নয়।

**Àkàndé ডিফল্টরূপে কোন GPT মডেল ব্যবহার করে?**
ফেব্রুয়ারি 2024 অনুযায়ী ডিফল্ট হল `gpt-4-turbo-preview`। মডেলের নাম একটি কনফিগারেশন প্যারামিটার, তাই যেকোনো OpenAI চ্যাট কমপ্লিশন মডেল প্রতিস্থাপিত করা যায়। `gpt-3.5-turbo`-তে স্যুইচ করলে প্রতি টোকেনে API খরচ প্রায় 20× কমে যায় কিন্তু জটিল মাল্টি-স্টেপ কোয়েরির জন্য যুক্তির মান কমে যায়।

**PDF রপ্তানি ফর্ম্যাট কাস্টমাইজ করা যায়?**
হ্যাঁ। fpdf2 রপ্তানি ফাংশন `messages` তালিকাকে তার একমাত্র প্রয়োজনীয় ইনপুট হিসেবে গ্রহণ করে, তাই রপ্তানি ফাংশন সম্পাদনা করে ফন্ট, মার্জিন, পেজ সাইজ, হেডার কন্টেন্ট এবং লেবেলিং সব পরিবর্তন করা যায়। fpdf2 ছবি, টেবিল এবং Unicode ফন্ট যোগ করার সমর্থনও করে, নির্দিষ্ট ব্র্যান্ডিং প্রয়োজনীয়তা সহ সংগঠনগুলির জন্য সমৃদ্ধ ডকুমেন্ট লেআউট সম্ভব করে।
...
[00]: https://akande.co "Àkàndé ভয়েস অ্যাসিস্ট্যান্ট"
