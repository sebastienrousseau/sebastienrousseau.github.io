...
banner_alt: "Interlinked glowing blocks forming a chain across a dark field — connected ledger and network nodes, evoking the common, machine-readable API surface corporate banking rails still lack in the agentic era"
banner_height: "1280"
banner_width: "1920"
...
date: "July 7, 2026"
description: "Retail banking got its API standard a decade ago. Corporate banking never did — and now that AI agents and the Model Context Protocol have turned integration into a runtime decision, the gap has become a fault line."
format-detection: "telephone=no"
hreflang: "en"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/2026-07-07-corporate-banking-api-standard-agentic-mcp-2026"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "corporate banking APIs, ISO 20022, Model Context Protocol, MCP, agentic AI, OpenAPI, FAPI, open finance, Berlin Group, Swift CBPR+, DORA, SR 11-7, EU AI Act, CPMI, transaction banking, autonomous treasury, idempotency"
language: "en-GB"
...
permalink: "https://sebastienrousseau.com/2026-07-07-corporate-banking-api-standard-agentic-mcp-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "Corporate Banking's Missing API Standard in the Agentic Era"
short_name: "sebastienrousseau"
subtitle: "ISO 20022 gave corporate banking a common grammar but never a common, agent-ready surface. Why the missing API standard has become a fault line — the failure mode it creates, the strategic choice it forces, and what a corporate banking API standard has to mandate before autonomous treasury can scale."
...
url: "https://sebastienrousseau.com/2026-07-07-corporate-banking-api-standard-agentic-mcp-2026"
...
item_description: "Retail banking got its API standard a decade ago. Corporate banking never did — and now that AI agents and the Model Context Protocol have turned integration into a runtime decision, the gap has become a fault line."
...
item_title: "From Fragmentation to Fault Line: Corporate Banking's Missing API Standard in the Agentic Era"
...
apple-mobile-web-app-title: "Corporate Banking API 2026"
...
<p class="post-lead-tldr"><strong>TL;DR.</strong> ISO 20022 gave corporate banking a common grammar; it never gave it a common, agent-ready surface. That was survivable while a human integrator absorbed the ambiguity. Now the caller is a model discovering tools at runtime and moving money inside policy bands — and it cannot absorb it. This is what the missing direction costs, why agents make today's fragmentation unsafe rather than merely inefficient, and what a corporate banking API standard has to mandate before autonomous treasury can scale.</p>
<p class="post-lead-heading"><strong>Key takeaways</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>The grammar is standardised; the surface is not.</strong> ISO 20022 standardised the data. Nobody standardised the interface — the last unstandardised layer, and the one agents cannot work around.</li>
  <li><strong>The caller changed.</strong> The Model Context Protocol made tool discovery a runtime decision. An agent meant to abolish the M×N integration problem meets it again at the bank boundary, where every institution is a bespoke server with its own grammar for "balance", "status", auth and "error".</li>
  <li><strong>Fragmentation now moves money wrongly, at machine speed.</strong> One timeout, three banks, three contradictory truths — a duplicate, a stuck instruction, a silent failure. Idempotency and a deterministic error grammar stop being niceties.</li>
  <li><strong>Standardise your own surface, or become the commodity.</strong> Banks that publish an ISO 20022-native, agent-ready API become the default counterparties for autonomous treasury; the rest are reachable only through an aggregator's abstraction.</li>
</ul>
<p class="post-lead-related"><strong>Related reading:</strong> <a href="https://sebastienrousseau.com/2026-07-08-global-corporate-standard-iso-20022-swift-2026">From Messages to Map: Building a Global Corporate Standard on ISO 20022 and Swift</a>, <a href="https://sebastienrousseau.com/2026-05-12-iso-20022-pacs008-structured-address-deadline">ISO 20022, pacs.008 and the Structured-Address Deadline</a>.</p>
</aside>
<!-- lead-end -->
