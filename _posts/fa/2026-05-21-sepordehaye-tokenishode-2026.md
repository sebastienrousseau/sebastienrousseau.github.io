...
BIS طرح Project Agorá را به‌عنوان همکاری با بانک‌های مرکزی و بخش خصوصی برای کاوش توکنی‌سازی در پرداخت‌های فرامرزی قاب‌بندی می‌کند و جهت‌گیری گسترده‌تر را به چشم‌انداز دفتر کل یکپارچه پیوند می‌دهد ([BIS](https://www.bis.org/speeches/sp260420.htm "استیبل‌کوین‌ها: چارچوب‌بندی بحث")). Deutsche Bank نیز به Project Agorá و Partior به‌عنوان بخشی از زیرساخت تسویه و فرامرزی نسل بعد اشاره می‌کند ([Deutsche Bank flow](https://flow.db.com/publications/flow-white-papers-and-guides/digital-money-a-perspective-on-stablecoins-tokenised-deposits-and-cbdcs "پول دیجیتال")).
...
| **استیبل‌کوین‌ها** | ادعا بر ساختار ناشر/ذخیره | نقدینگی رمزارز، آزمایش فرامرزی، نقدینگی دلاری | بزرگ و رو به رشد، با برآورد BIS به میزان حدود ۳۱۵ میلیارد دلار ارزش بازار در اوایل آوریل 2026 ([BIS](https://www.bis.org/speeches/sp260420.htm "استیبل‌کوین‌ها: چارچوب‌بندی بحث")) | هجوم، یکپارچگی مالی، حاکمیت پولی |
...
- BIS, (2026). [Stablecoins: framing the debate ⧉](https://www.bis.org/speeches/sp260420.htm "استیبل‌کوین‌ها: چارچوب‌بندی بحث").
