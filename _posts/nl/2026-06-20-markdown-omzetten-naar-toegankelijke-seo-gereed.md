...
<p class="post-lead-related"><strong>Gerelateerde lectuur:</strong> <a href="https://sebastienrousseau.com/2026-06-18-noyalib-safe-yaml-rust-ai-mcp-financial-infrastructure-2026">Waarom YAML in 2026 een veiligere Rust-stack nodig heeft voor AI, MCP en financiële infrastructuur</a>, Een secure-by-default Static Site Generator voor publicatie in het AI-tijdperk van 2026, <a href="https://sebastienrousseau.com/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026">CloudCDN: Een open-source blauwdruk voor de AI-native edge in 2026</a>.</p>
</aside>
<!-- lead-end -->
...
**Gerelateerde lectuur:** [Waarom YAML in 2026 een veiligere Rust-stack nodig heeft voor AI, MCP en financiële infrastructuur](https://sebastienrousseau.com/2026-06-18-noyalib-safe-yaml-rust-ai-mcp-financial-infrastructure-2026/), Een secure-by-default Static Site Generator voor publicatie in het AI-tijdperk van 2026, [CloudCDN: Een open-source blauwdruk voor de AI-native edge in 2026](https://sebastienrousseau.com/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026/).
...
graph TD
    %% Ingest & Parse
    subgraph Ingest_AST[Inname en AST-parsing]
        A1[Ruwe Markdown plus YAML front matter] --> B(HTML Generator compiler-kern)
        B --> C{WASM sandbox-grens}
    end

    %% Build Gates
    subgraph Secure_Build_Gates[Veilige bouw-gates]
        C --> D{HTML AST-parser}
        D -->|WCAG-regel geschonden: platte koppen of ontbrekende alt-tekst| E[Compiler stoppen en bouw laten mislukken]
        D -->|WCAG 2.1 AA conform| F[Rich-content compiler]
    end

    %% Hardening & Output
    subgraph Enrichment[Verrijking en compilatie]
        F -->|Wiskunde compileren naar MathML| G[MathML-generator]
        F -->|Diagrammen renderen naar SVG| H[Mermaid SVG-generator]
        F -->|Metadata extraheren| I[JSON-LD schema-injector]
        G --> J[Geminificeerde, geharde HTML-uitvoer]
        H --> J
        I --> J
    end
