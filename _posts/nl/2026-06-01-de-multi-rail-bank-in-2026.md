...
banner_alt: "Langgesloten foto van kruisende lichtsporen bij een groot spoorwegknooppunt 's nachts — visuele sleutel voor het multi-rail bank stuk: kaarten, A2A, RTP, FedNow, ACH, stablecoins, Open Banking API's, ISO 20022, en de orkestratie-engine die ertussen routeert"
banner_height: "1597"
banner_width: "2584"
...
date: "June 1, 2026"
description: "FedNow vereist voorgefinancierde liquiditeit 24/7. ACH is goedkoop maar T+1. USDC wikkelt atomair af maar vergt wallet-infrastructuur. De multi-rail bank van 2026 routeert per kosten, finaliteit en liquiditeitskost via een orkestratie-engine die ISO 20022 pacs.008 leest."
format-detection: "telephone=no"
hreflang: "nl"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/nl/2026-06-01-multi-rail-bank-cards-a2a-stablecoins-rtp-fednow-open-banking-2026"
image_alt: "Zwart-witportret van Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "betalingsorkestratielaag, FedNow vs RTP, FedNow vs ACH, stablecoin-afwikkeling, USDC atomaire afwikkeling, ISO 20022 pacs.008, account-to-account A2A, Open Banking API's, voorgefinancierde liquiditeit, 24/7 liquiditeitsval, multi-rail bank 2026, betalings-routerings-engine, ERP-reconciliatie"
language: "nl"
...
permalink: "https://sebastienrousseau.com/nl/2026-06-01-multi-rail-bank-cards-a2a-stablecoins-rtp-fednow-open-banking-2026"
rating: "general"
...
subtitle: "Multi-rail-strategie is een routerings-engine, een liquiditeitsboek en een ISO 20022-vertaler bovenop de legacy-core. Architecten die het als productlancering behandelen, financieren drie rails en bedienen er geen enkele goed."
tags: "payments, FedNow, RTP, ACH, stablecoin-afwikkeling, USDC, ISO 20022, A2A-betalingen, Open Banking API's, voorgefinancierde liquiditeit, multi-rail bank, post-kwantumcryptografie, AI, stablecoins, getokeniseerde deposito's, platform engineering, grensoverschrijdende betalingen, DORA, cloud native banking"
excerpt: "FedNow vereist voorgefinancierde liquiditeit 24/7. ACH is goedkoop maar T+1. USDC wikkelt atomair af maar vergt wallet-infrastructuur. De multi-rail bank van 2026 routeert per kosten, finaliteit en liquiditeitskost via een orkestratie-engine die ISO 20022 pacs.008 leest."
theme-color: "0, 83, 191"
title: "De multi-rail bank in 2026: kaarten, A2A, stablecoins, RTP, FedNow en Open Banking in één strategie"
url: "https://sebastienrousseau.com/nl/2026-06-01-multi-rail-bank-cards-a2a-stablecoins-rtp-fednow-open-banking-2026"
...
item_description: "Een engineering-blauwdruk voor de multi-rail bank van 2026 — de routeringsmatrix tussen FedNow, RTP, ACH, kaarten en USDC; de voorgefinancierde liquiditeitsval 24/7; en de ISO 20022 pacs.008-brug van legacy-cores naar A2A en Open Banking API's."
...
item_title: "De multi-rail bank in 2026: kaarten, A2A, stablecoins, RTP, FedNow en Open Banking in één strategie"
...
twitter_description: "Multi-rail is geen productlancering — het is een routerings-engine, een liquiditeitsboek en een pacs.008-vertaler bovenop de legacy-core. FedNow vs RTP vs ACH vs USDC, op kosten en finaliteit."
...
<p class="post-lead-tldr"><strong>TL;DR.</strong> De multi-rail bank in 2026 stapelt drie zaken bovenop de legacy-core: een orkestratie-engine die de rail per transactie kiest, een liquiditeitsboek dat de voorgefinancierde saldi beheert die elke instant-rail vereist, en een ISO 20022 pacs.008-vertaler die core-data zonder verlies van gestructureerde betalingsinformatie doorgeeft aan A2A en Open Banking API's. Wie "FedNow" of "stablecoins" als losse productprogramma's financiert, geeft tweemaal uit en bedient beide slecht.</p>
<p class="post-lead-heading"><strong>Belangrijkste punten</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>De routeringsbeslissing is het product.</strong> Een B2B-betaling van USD 500 gaat via FedNow als liquiditeit goedkoop is en finaliteit telt, via ACH als de tegenpartij T+1 accepteert, via USDC als de corridor in dollars is en de ontvanger wallet-infrastructuur heeft. De orkestrator beslist op die feiten, niet op welke rail de bank prefereert.</li>
  <li><strong>Voorgefinancierde liquiditeit is de onuitgesproken kost van instant-rails.</strong> FedNow en RTP vereisen beide voorgefinancierde gemeenschappelijke rekening-saldi 24/7/365. Een bank die beide draait zonder netting-strategie parkeert twee pools ongebruikt saldo en verdient op geen van beide iets.</li>
  <li><strong>ISO 20022 pacs.008 is de brug, geen migratieproject.</strong> De gestructureerde XML-payload — debtor/creditor agent BICs, gestructureerde betalingsinformatie, regulatory reporting-blokken, doelcodes — maakt core-banking data verteerbaar voor A2A en Open Banking API's zonder verliesgevende vertaling.</li>
  <li><strong>Stablecoins zijn een afwikkelingsactief, geen rail.</strong> USDC en getokeniseerde deposito's wikkelen atomair af tegen on-chain liquiditeit. Ze verdringen correspondentbanking op dollarcorridors. Ze verdringen geen kaarten aan de kassa en geen ACH op loonbetalingen.</li>
  <li><strong>De orkestratielaag is per ontwerp agnostisch.</strong> Als de routerings-engine wordt vastgeknoopt aan de SDK van één rail-leverancier, erft de bank de prijszettingsmacht van die leverancier. Bouw de engine als een dunne abstractie boven rail-specifieke drivers, niet als een hernoemde leveranciers-API.</li>
</ul>
<p class="post-lead-related"><strong>Aanverwante artikelen:</strong> <a href="/2026-05-24-uk-payments-forward-plan-stablecoins-open-banking-tokenised-payments-2026/">Het UK Payments Forward Plan in 2026: stablecoins, Open Banking, getokeniseerde deposito's en agentic payments</a>, <a href="/2026-05-26-stablecoins-vs-tokenised-deposits-bank-strategy-2026/">Stablecoins versus getokeniseerde deposito's in 2026: wat banken werkelijk moeten verdedigen</a>, <a href="/2026-05-25-programmable-liquidity-ai-tokenised-deposits-real-time-treasury-2026/">Programmeerbare liquiditeit in 2026: AI, getokeniseerde deposito's en real-time treasury-orkestratie</a>.</p>
</aside>
<!-- lead-end -->

Amerikaanse wholesale-betalingen lopen nu over vijf live rails tegelijk. Kaarten rijden sinds de jaren zeventig over dezelfde interchange-sporen van Visa en Mastercard. ACH verplaatst nog steeds het leeuwendeel van loon en B2B tegen marginale kosten met T+1-afwikkeling. Het [RTP-netwerk ⧉](https://www.theclearinghouse.org/payment-systems/rtp "TCH RTP") is sinds 2017 instant, 24/7, en loopt via de gemeenschappelijke rekening van The Clearing House bij de Fed. [FedNow ⧉](https://www.frbservices.org/financial-services/fednow "FedNow Service") ging in juli 2023 live met een parallelle architectuur en een aparte liquiditeitspool. USDC en getokeniseerde bankdeposito's wikkelen atomair af op Ethereum, Solana en door banken beheerde permissioned chains.
...
1. **Rail-capaciteit van de tegenpartij.** De bank van de leverancier is TCH RTP-deelnemer. Ze is ook adresseerbaar op FedNow. Ze accepteert ACH-credits. Ze heeft geen USDC-wallet in dossier.
2. **Kosten per rail.** FedNow rekent een vlak verzendkostentarief van USD 0,045. RTP rekent USD 0,045 plus de interne liquiditeitskost van de bank op haar TCH-saldo op de gemeenschappelijke rekening. ACH kost USD 0,0029 per credit, afgewikkeld T+1. USDC: gas plus de interne kost van het aanhouden van stablecoin-voorraad, hier irrelevant omdat de ontvanger geen wallet heeft.
3. **Beschikbaarheid van voorgefinancierde liquiditeit.** Het is 23.00 uur Eastern Time. De FedNow-gemeenschappelijke rekening van de bank bij de Fed houdt momenteel USD 42 miljoen aan. De TCH-gemeenschappelijke rekening houdt USD 61 miljoen aan. Beide liggen boven elke aannemelijke drempel voor één betaling. De marginale kost van beide rails op dit moment is de gederfde overnight-opbrengst op de gebruikte USD 500 — gemeten in fracties van een cent.
4. **Waarde van het afwikkelingsvenster voor de betaler.** De pacs.008 verklaarde "volgende werkdag aanvaardbaar". Dat is het routeringssignaal dat de beslissing kantelt.
