...
banner_alt: "Espace de travail moderne d'un service finance la nuit — symbolisant l'intelligence transactionnelle unifiée que BankStatementParser construit à partir de CAMT, PAIN.001, MT940, OFX, CSV et PDF scannés"
banner_height: "1597"
banner_width: "2584"
...
date: "June 14, 2026"
description: "BankStatementParser transforme CAMT, PAIN.001, CSV, OFX/QFX, MT940 et PDF scannés en modèles de transaction unifiés pour la trésorerie et la finance."
format-detection: "telephone=no"
hreflang: "fr"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/fr/2026-06-14-bankstatementparser-transaction-intelligence-treasury-open-source-2026"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "BankStatementParser, analyseur de relevés bancaires, CAMT, PAIN.001, MT940, OFX, QFX, OCR PDF, intelligence transactionnelle trésorerie"
language: "fr"
...
permalink: "https://sebastienrousseau.com/fr/2026-06-14-bankstatementparser-transaction-intelligence-treasury-open-source-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "BankStatementParser et intelligence transactionnelle pour la trésorerie"
short_name: "sebastienrousseau"
subtitle: "L'analyse de relevés bancaires devient intelligence transactionnelle : analyse déterministe, repli LLM, OCR, vérification du solde, catégorisation et révision interactive."
tags: "BankStatementParser, trésorerie, relevés bancaires, CAMT, MT940, OCR, LLM, intelligence transactionnelle"
theme-color: "0, 83, 191"
title: "Des relevés bancaires à l'intelligence transactionnelle : un analyseur open source pour la trésorerie"
url: "https://sebastienrousseau.com/fr/2026-06-14-bankstatementparser-transaction-intelligence-treasury-open-source-2026"
...
item_description: "BankStatementParser transforme CAMT, PAIN.001, CSV, OFX/QFX, MT940 et PDF scannés en modèles de transaction unifiés pour la trésorerie et la finance."
...
item_title: "Des relevés bancaires à l'intelligence transactionnelle : un analyseur open source pour la trésorerie"
...
apple-mobile-web-app-title: "BankStatementParser et intelligence transactionnelle"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "BankStatementParser transforme CAMT, PAIN.001, CSV, OFX/QFX, MT940 et PDF scannés en modèles de transaction unifiés pour la trésorerie et la finance."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "BankStatementParser et intelligence transactionnelle pour la trésorerie"
...
excerpt: "BankStatementParser est une boîte à outils Python open source qui transforme CAMT, PAIN.001, MT940, OFX/QFX, CSV et PDF scannés en un modèle de transaction unifié que la trésorerie peut auditer — analyse déterministe, repli LLM, OCR, vérification du solde et révision."
...
# Des relevés bancaires à l'intelligence transactionnelle : un analyseur open source pour la trésorerie

<!-- lead-start -->
<aside class="lead" aria-label="En bref">

**En bref.** Les relevés bancaires sont une preuve opérationnelle — mais ils arrivent au format CAMT, PAIN.001, MT940, OFX/QFX, CSV, PDF natif ou PDF scanné, chacun avec ses particularités. BankStatementParser est la boîte à outils Python open source qui les ramène à un seul modèle de transaction auditable : analyseurs ISO 20022 déterministes, repli LLM pour les PDF désordonnés, OCR pour les scans, vérification du solde, catégorisation et un mode de révision interactive que la trésorerie peut réellement utiliser.

**Points clés à retenir :**

- **Le modèle de transaction unifié est le produit.** L'analyse est le moyen ; le rapprochement, la prévision et l'audit sont les finalités.
- **Le déterministe d'abord, l'IA ensuite.** Les formats structurés s'analysent de manière déterministe ; seuls les PDF désordonnés atteignent le repli LLM/OCR.
- **La vérification du solde est le verrou de confiance.** Solde d'ouverture + somme(mouvements) = solde de clôture — sinon le fichier est rejeté, pas importé silencieusement.
- **La catégorisation est un flux de travail, pas un modèle.** Règles, suggestions et révision humaine surpassent une classification end-to-end opaque.
- **L'open source, c'est la piste d'audit.** La trésorerie et le risque peuvent inspecter chaque règle d'analyse, chaque repli, chaque prompt.

**Lectures associées :** [pain.001 + Python open source](/2023-09-29-automating-iso-20022-compliant-payment-file-creation-with-pain001/) · [Échéance ISO 20022 pacs.008](/2026-05-12-iso-20022-pacs008-structured-address-deadline/) · [Économie des paiements de gros 2026](/2026-05-19-global-wholesale-payments-economics-2026/)
...
La référence open source pour cet article est [bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "bankstatementparser"). Le dépôt se positionne ainsi : un analyseur Python pour CAMT, PAIN.001, CSV, OFX/QFX, MT940 et PDF, incluant des analyseurs ISO 20022 déterministes, un repli LLM pour les PDF, la vision pour les scans, la vérification du solde, la catégorisation et un mode de révision interactive.
...
|---|---|---|
| **Analyse multi-formats** | Le dépôt cible les formats utilisés à travers les opérations trésorerie et finance | [bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "dépôt bankstatementparser") |
| **Analyseurs ISO 20022 déterministes** | Les messages structurés doivent être traités par des règles, pas par des suppositions | [bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "dépôt bankstatementparser") |
| **Repli LLM pour les PDF** | L'IA est utilisée là où la variabilité documentaire rend l'analyse déterministe plus difficile | [bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "dépôt bankstatementparser") |
| **Vérification du solde** | L'extraction financière exige des contrôles mathématiques | [bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "dépôt bankstatementparser") |
| **Révision interactive** | L'outil reconnaît que l'automatisation financière exige toujours une gestion des exceptions | [bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "dépôt bankstatementparser") |
...
- GitHub, (2026). [dépôt bankstatementparser ⧉](https://github.com/sebastienrousseau/bankstatementparser "dépôt bankstatementparser").
...
<p class="post-reviewed">Dernière révision <time datetime="2026-06-14">14 juin 2026</time>.</p>
<!-- enrich-end -->
