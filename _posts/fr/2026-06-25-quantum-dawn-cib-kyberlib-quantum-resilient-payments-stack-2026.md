...
banner_alt: "Vue aérienne d'un quartier financier mondial à l'aube — symbolisant l'aube post-quantique pour la banque de financement et d'investissement et le passage de KyberLib à une pile de paiements quantum-résiliente à l'échelle de l'entreprise"
banner_height: "1597"
banner_width: "2584"
...
date: "June 25, 2026"
description: "De KyberLib à un programme CIB d'entreprise — comment les banques passent des expérimentations FIPS 203 ML-KEM et FIPS 204 ML-DSA à une pile de paiements quantum-résiliente."
...
keywords: "cryptographie post-quantique, PQC, KyberLib, ML-KEM, ML-DSA, FIPS 203, FIPS 204, paiements quantum-résilients, CIB, BIS, G7 Cyber Expert Group, crypto-agilité, HNDL, CRQC, CBOM, harvest now decrypt later, échange de clés hybride, banque, paiements de gros, financement du commerce, conservation, DORA, Bâle III, SM&CR"
language: "fr-FR"
...
seo_title: "Aube quantique pour la CIB : de KyberLib à la PQC"
short_name: "sebastienrousseau"
subtitle: "Traduire BIS Quantum Dawn et la feuille de route PQC du G7 de janvier 2026 en un programme de transition de niveau conseil — des pilotes KyberLib à une pile de paiements crypto-agile en ML-KEM et ML-DSA."
tags: "cryptographie post-quantique, PQC, KyberLib, ML-KEM, ML-DSA, FIPS 203, FIPS 204, paiements quantum-résilients, CIB, BIS, G7 Cyber Expert Group, crypto-agilité, HNDL, CRQC, CBOM, banque, DORA, Bâle III, SM&CR"
theme-color: "0, 83, 191"
title: "Aube quantique pour la CIB : de KyberLib à une pile de paiements quantum-résiliente"
...
item_description: "De KyberLib à un programme CIB d'entreprise — comment les banques passent des expérimentations FIPS 203 ML-KEM et FIPS 204 ML-DSA à une pile de paiements quantum-résiliente."
...
item_title: "Aube quantique pour la CIB : de KyberLib à une pile de paiements quantum-résiliente"
...
apple-mobile-web-app-title: "Aube quantique CIB : KyberLib vers PQC"
...
twitter_description: "De KyberLib à un programme CIB d'entreprise — comment les banques passent des expérimentations FIPS 203 ML-KEM et FIPS 204 ML-DSA à une pile de paiements quantum-résiliente."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo de Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Aube quantique pour la CIB : de KyberLib à la PQC"
...
<p class="post-lead-tldr"><strong>En bref.</strong> BIS Quantum Dawn et la feuille de route PQC du G7 Cyber Expert Group de janvier 2026 ont sorti la cryptographie post-quantique du domaine de la recherche pour l'inscrire à l'agenda du conseil d'administration de la banque de financement et d'investissement (CIB). KyberLib donne aux banques un point de départ inspectable en ML-KEM et ML-DSA ; le reste est un programme de transition pluriannuel et crypto-agile sur les paiements, le financement du commerce, la conservation et la transparence réglementaire.</p>
<p class="post-lead-heading"><strong>Points clés à retenir</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>La fenêtre est ouverte maintenant.</strong> Un horizon de planification à cinq ans est l'hypothèse prudente pour un ordinateur quantique cryptographiquement pertinent, et le trafic harvest-now-decrypt-later est déjà capté.</li>
  <li><strong>KyberLib est une ligne de départ, pas d'arrivée.</strong> Une boîte à outils FIPS 203 et FIPS 204 est nécessaire mais pas suffisante ; la CIB exige des couches de crypto-agilité sur chaque frontière de paiement, de conservation et de règlement.</li>
  <li><strong>Les rails de gros montants passent en premier.</strong> Les paiements de gros, la pension livrée, la conservation et le financement du commerce portent les plus longues traînes de confidentialité et le plus gros risque par transaction — ils justifient les premières vagues de migration hybride.</li>
  <li><strong>La transparence est le nouvel audit.</strong> Conseils, régulateurs et agences de notation veulent un inventaire cryptographique (CBOM), un plan de migration daté et une responsabilité nommée au titre de SM&CR et de DORA.</li>
</ul>
<p class="post-lead-related"><strong>À lire également :</strong> <a href="https://sebastienrousseau.com/2026-06-12-kyberlib-post-quantum-banking-migration-standards-code-2026">KyberLib et la migration post-quantique bancaire en 2026 : des normes au code</a>, <a href="https://sebastienrousseau.com/2023-11-19-crystals-kyber-the-safeguarding-algorithm-in-a-quantum-age">CRYSTALS-Kyber : l'algorithme de protection à l'ère quantique</a>, <a href="https://sebastienrousseau.com/2023-12-11-quantum-key-distribution-revolutionising-security-in-banking">Distribution quantique de clés : redéfinir la sécurité bancaire</a>.</p>
</aside>
<!-- lead-end -->

Le [document *Quantum Dawn* de la BIS](https://www.bis.org/publ/bppdf/bispap158.htm "BIS Papers No 158 — Project Leap and the quantum dawn for central banks and the financial system") et la [feuille de route PQC du G7 Cyber Expert Group de janvier 2026](https://home.treasury.gov/news/press-releases/sb0355 "G7 Cyber Expert Group statement on post-quantum cryptography, January 2026") sont parus à quelques mois d'intervalle et disent la même chose dans deux registres. Le premier le formule comme un problème de coordination des banques centrales. Le second le formule comme une instruction de gouvernance au niveau du Trésor à destination des plus grandes banques. Dans les deux cas, la migration post-quantique est désormais un document de conseil, plus une note de recherche.

Il y a un an, une banque pouvait citer [FIPS 203](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.203.pdf "FIPS 203 Module-Lattice-Based Key-Encapsulation Mechanism Standard") et [FIPS 204](https://nvlpubs.nist.gov/nistpubs/FIPS/NIST.FIPS.204.pdf "FIPS 204 Module-Lattice-Based Digital Signature Standard") dans une revue de sécurité et appeler cela une stratégie cryptographique. La question de 2026 est plus tranchée : quels rails, à quelle échéance, avec quel repli, signé par qui au titre de SM&CR. KyberLib répond à une partie de cette question avec une implémentation ML-KEM et ML-DSA inspectable et mémoire-sûre. Le reste — transformer une boîte à outils en programme d'entreprise — est l'objet de ce texte.

## 01. La fenêtre est ouverte maintenant

L'hypothèse de planification dominante dans les banques Tier-1 à la mi-2026 est un horizon de cinq ans pour un ordinateur quantique cryptographiquement pertinent (CRQC), avec une masse de probabilité non triviale plus tôt. C'est le chiffre de travail que la BIS, le G7 Cyber Expert Group et la plupart des agences cyber nationales utilisent quand elles s'adressent aux établissements systémiques. La revue de préparation des services financiers d'EY reprend le même cadrage dans son [analyse de transition post-quantique](https://www.ey.com/en_nl/insights/financial-services/is-the-financial-sector-ready-for-the-transition-towards-post-quantum-cryptography "EY — Is the financial sector ready for the transition towards post-quantum cryptography").
