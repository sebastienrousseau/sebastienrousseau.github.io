...
banner_alt: "Motif de circuit imprimé se résolvant en une silhouette de ville — la grammaire visuelle du cloud-natif bancaire : les primitives d'ingénierie de plateforme tissées dans le tissu opérationnel de la banque."
banner_height: "571"
banner_width: "1425"
...
date: "June 5, 2026"
description: "Index 2026 de la banque cloud-natif : mesurer la préparation DORA, la maturité de l'ingénierie de plateforme, le risque de concentration, la preuve de sortie et la résilience opérationnelle."
format-detection: "telephone=no"
hreflang: "fr"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/fr/2026-06-05-cloud-native-banking-index-dora-resilience-platform-engineering-2026"
image_alt: "Portrait en noir et blanc de Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "banque cloud-natif 2026, DORA banques, risque de concentration cloud, ingénierie de plateforme banques, risque tiers TIC, stratégie de sortie cloud, cloud souverain, Kubernetes"
language: "fr-FR"
...
item_description: "Index 2026 de la banque cloud-natif : mesurer la préparation DORA, la maturité de l'ingénierie de plateforme, le risque de concentration, la preuve de sortie et la résilience opérationnelle."
...
item_title: "Index 2026 de la banque cloud-natif : DORA, ingénierie de plateforme, cloud souverain et résilience opérationnelle"
...
apple-mobile-web-app-title: "Index 2026 banque cloud-natif"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "Index 2026 de la banque cloud-natif : mesurer la préparation DORA, la maturité de l'ingénierie de plateforme, le risque de concentration, la preuve de sortie et la résilience opérationnelle."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo de Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Index 2026 banque cloud-natif"
...
<p class="post-lead-tldr"><strong>TL;DR.</strong> La banque cloud-natif en 2026 est en phase d'audit DORA, pas en phase de préparation. Le régime est en vigueur depuis le 17 janvier 2025 ; le régime de désignation CTPP au titre des Articles 28-44 s'ouvre tout au long de 2025-2026 ; AWS, Microsoft (Azure), Google (GCP) et Salesforce se trouvent tous à l'intérieur ou à proximité du périmètre de désignation ; les [priorités prudentielles 2026-28 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Priorités de supervision bancaire de la BCE 2026-28") de la BCE comportent des programmes explicites sur la préparation aux ruptures cloud et les tests d'intrusion pilotés par la menace. Le travail d'ingénierie qui compte tient aux primitives d'ingénierie de plateforme — voies pavées sur Kubernetes, plus Backstage, plus OPA, plus OpenTelemetry — qui produisent la preuve du registre Article 8 DORA à la vitesse du pipeline de déploiement, ainsi que la preuve d'exécution de sortie testée qui distingue une substituabilité crédible d'un théâtre documentaire.</p>
<p class="post-lead-heading"><strong>Points clés</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>La résilience cloud DORA est en application active.</strong> Article 6 (cadre de gestion des risques TIC), Article 8 (registre d'informations + ITS), Article 18 (notification d'incident sous 4 heures), Article 26 (TLPT aligné TIBER-EU), Articles 28-44 (régime CTPP) — tous en vigueur depuis le 17 janvier 2025. La rhétorique du « préparer DORA » accuse deux cycles réglementaires de retard.</li>
  <li><strong>Le régime de désignation CTPP s'ouvre.</strong> AWS, Microsoft (Azure), Google (GCP) et Salesforce se trouvent à l'intérieur ou à proximité du périmètre de désignation. La désignation confère aux Autorités européennes de surveillance un pouvoir de surveillance directe : demandes d'informations, inspections sur site, recommandations prudentielles. La concentration sur les fournisseurs cloud devient une métrique prudentielle régulée.</li>
  <li><strong>L'ingénierie de plateforme est le livrable du modèle opérationnel.</strong> Cinq primitives runtime nommées : voies pavées Kubernetes, portail développeur Backstage (ou équivalent), GitOps via ArgoCD ou Flux, Open Policy Agent à l'admission, OpenTelemetry de bout en bout. La preuve à la vitesse du pipeline l'emporte sur les dossiers documentaires assemblés le jour de l'examen.</li>
  <li><strong>Le cloud souverain s'ingénie, il ne se brande pas.</strong> AWS European Sovereign Cloud, Microsoft EU Data Boundary, partenariats souverains Google Cloud (Bleu, Thales / S3NS), Oracle EU Sovereign Cloud et les options alignées Gaia-X répondent chacun à une dimension spécifique Schrems II + DORA Article 28 + externalisation EBA/GL/2019/02. Aucun n'est une réponse clé en main.</li>
  <li><strong>La preuve de sortie testée est le facteur différenciant.</strong> Les paragraphes 81 et 113-117 d'EBA/GL/2019/02 exigent une évaluation de substituabilité et une preuve d'exécution de la stratégie de sortie — pas seulement un PDF de plan de sortie. Un tabletop trimestriel ne suffit pas ; les superviseurs attendent au moins un test annuel d'exécution de sortie de bout en bout pour toute fonction critique ou importante.</li>
  <li><strong>Les RTO et RPO viennent de l'inventaire FCI, pas du confort d'ingénierie.</strong> Chaque fonction critique ou importante (FCI) obtient une cible RTO / RPO basée sur son palier — typiquement 2 h / 15 min pour le Palier 1, 4 h / 1 h pour le Palier 2, 24 h / 4 h pour le Palier 3 — dérivée de l'analyse d'impact métier de l'institution, pas de ce que l'équipe plateforme peut livrer.</li>
</ul>
</aside>
<!-- lead-end -->

La banque cloud-natif en 2026 est en phase d'audit DORA. Le [Règlement (UE) 2022/2554 ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA — Digital Operational Resilience Act") est en vigueur depuis le 17 janvier 2025. Le régime de désignation des prestataires tiers critiques (CTPP) au titre des Articles 28-44 s'ouvre tout au long de 2025-2026, AWS, Microsoft (Azure), Google (GCP) et Salesforce se trouvant à l'intérieur ou à proximité du périmètre de désignation. Les Autorités européennes de surveillance (EBA, EIOPA, ESMA) ont publié les RTS et ITS définitifs sur le [Registre d'informations ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "ITS des AES sur le Registre d'informations") en 2024. L'équipe Supervision bancaire de la BCE inscrit des programmes explicites sur la préparation aux ruptures cloud et les tests d'intrusion pilotés par la menace dans les [priorités prudentielles 2026-28 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Priorités de supervision 2026-28"). La question institutionnelle n'est plus de savoir s'il faut aligner la stratégie cloud sur DORA — c'est tranché — mais de savoir si les primitives d'ingénierie de plateforme de l'institution produisent la preuve à la vitesse du pipeline de déploiement plutôt que dans des PDF assemblés la semaine précédant l'examen.
...
|---|---|---|
| **DORA en application active depuis le 17 janv. 2025** | Constats prudentiels de la première vague tombés au T4 2025 ; deuxième vague attendue pour le S2 2026 | [EUR-Lex ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA") |
| **Désignation CTPP en ouverture sur 2025-2026** | AWS, Microsoft, Google, Salesforce à l'intérieur ou à proximité du périmètre ; la désignation confère aux AES des pouvoirs de surveillance directe | [EBA ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "EBA — supervision et surveillance directes DORA") |
| **Les priorités prudentielles 2026-28 de la BCE nomment explicitement la rupture cloud** | Les scénarios prudentiels modélisés testent la capacité à absorber une panne CTPP désignée prolongée | [Supervision bancaire BCE ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Priorités prudentielles 2026-28") |
| **TIBER-EU aligné sur l'Article 26 DORA** | Le périmètre TLPT couvre les fonctions critiques / importantes, y compris les services hébergés sur cloud | [BCE TIBER-EU ⧉](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "TIBER-EU") |
| **Les orientations d'externalisation EBA (EBA/GL/2019/02) s'imbriquent avec l'Article 28 DORA** | Présence substantielle (¶64), évaluation de substituabilité (¶81), stratégie de sortie (¶113-117) — les paragraphes que les superviseurs testent réellement | [EBA ⧉](https://www.eba.europa.eu/regulation-and-policy/internal-governance/guidelines-on-outsourcing-arrangements "Orientations EBA sur l'externalisation") |
| **Avancement du projet de schéma européen des services cloud (EUCS)** | Futur schéma de certification cloud souverain au titre de l'Acte européen sur la cybersécurité ; projet publié par l'ENISA | [ENISA EUCS ⧉](https://www.enisa.europa.eu/publications/eucs-cloud-service-scheme "EUCS — Schéma de cybersécurité pour les services cloud") |
...
- **AWS European Sovereign Cloud** (annoncé en 2023, GA attendu au S2 2026) : région physique exploitée par une filiale AWS résidente UE ; exploitation et support assurés par du personnel résident UE ; clés contrôlées par le client via le patron KMS-XKS. Alignement du contenu contractuel DORA Article 28 attendu en 2026.
- **Microsoft EU Data Boundary** (GA 2024) + **Bleu** (Capgemini + Orange + Microsoft, France uniquement) : le Data Boundary maintient les données clients UE dans les régions UE ; Bleu est le cloud souverain français aligné SecNumCloud qui fait tourner la pile Microsoft Azure sous contrôle opérationnel français.
- **Partenariats souverains Google Cloud** : Thales / S3NS en France (équivalent de Bleu) ; T-Systems en Allemagne.
- **Oracle EU Sovereign Cloud** (GA 2023) : patron à double région (Francfort + Madrid) avec exploitation résidente UE ; conformité Schrems II nette.
- **Fournisseurs alignés Gaia-X** (OVHcloud, Scaleway, Stackit, Aruba Cloud, IONOS) : prestataires natifs UE avec labellisation Gaia-X ; échelle et écosystème plus modestes que les hyperscalers mais aucune exposition au Foreign Intelligence Surveillance Act.
...
- **Mesure du temps de restauration** : temps réel écoulé entre la déclaration de sortie et la restauration de la charge de travail sur le prestataire alternatif, face à la cible RTO issue de la BIA.
- **Preuve de portabilité des données** : export de données testé depuis le prestataire principal, validé contre le chemin d'import du prestataire de destination, avec preuve de réconciliation.
- **Équivalence fonctionnelle** : charge de travail testée sur le prestataire alternatif avec des SLO équivalents.
- **Preuve de coût** : coût d'exécution de sortie documenté face à l'hypothèse de coût de restauration dans la planification de contingence de l'institution.
...
- Union européenne, (2022). [Règlement (UE) 2022/2554 — Digital Operational Resilience Act (DORA) ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA").
- Autorité bancaire européenne, (2019). [EBA/GL/2019/02 — Orientations sur les accords d'externalisation ⧉](https://www.eba.europa.eu/regulation-and-policy/internal-governance/guidelines-on-outsourcing-arrangements "Orientations EBA sur l'externalisation").
- Autorité bancaire européenne, (2026). [Digital Operational Resilience Act ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "EBA — Supervision et surveillance directes DORA").
- Autorités européennes de surveillance, (2024). [Rapport final sur l'ITS relatif au Registre d'informations au titre de DORA ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "ITS des AES").
- Supervision bancaire BCE, (2025). [Priorités prudentielles 2026-28 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Priorités BCE 2026-28").
- Banque centrale européenne, (2024). [Cadre TIBER-EU ⧉](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "TIBER-EU").
- ENISA, (2024). [Schéma européen de cybersécurité pour les services cloud (EUCS) ⧉](https://www.enisa.europa.eu/publications/eucs-cloud-service-scheme "EUCS").
- Spotify, (2020-2024). [Portail développeur Backstage ⧉](https://backstage.io/ "Backstage").
...
<!-- enrich-start -->
<aside class="author-card" aria-label="À propos de l'auteur"><img alt="Portrait de Sebastien Rousseau" src="https://cloudcdn.pro/stocks/images/sebastienrousseau.webp" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">Technologue bancaire senior, écrivant sur l'IA appliquée, les infrastructures de paiement, la monnaie tokenisée, ISO 20022, la sécurité post-quantique, les services financiers cloud-natifs et les marchés numériques régulés.</span><span class="author-credentials">Plus de 20 ans à HSBC Commercial &amp; Investment Bank, PayPal, Barclays, Shazam, AKQA, Virgin Group. <a href="/about/index.html">Profil complet</a> &middot; <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
<p class="post-reviewed">Dernière revue <time datetime="2026-06-05">2026-06-05</time>.</p>
<!-- enrich-end -->
