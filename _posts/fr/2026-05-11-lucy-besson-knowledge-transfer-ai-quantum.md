---
title: "La clé USB de Lucy, revisitée : ce que Besson voyait de la migration du savoir vers les machines"
subtitle: "Douze ans après sa sortie, Lucy de Luc Besson se lit moins comme de la pseudo-science que comme une expérience de pensée sur la migration du savoir humain vers des supports non biologiques."
description: "Douze ans après sa sortie, Lucy de Luc Besson se lit moins comme de la pseudo-science que comme une expérience de pensée sur ce qui se produit lorsque le savoir humain migre vers des supports non biologiques. À l'ère des grands modèles de langage, des qubits à atomes neutres et de l'émulation cérébrale complète, la métaphore centrale du film vieillit remarquablement bien."
date: "May 11, 2026"
language: "fr"
locale: "fr_FR"
...
## La clé USB de Lucy, revisitée : ce que Besson voyait de la migration du savoir vers les machines
...
Douze ans plus tard, cette question philosophique n'est plus hypothétique. Les systèmes d'IA frontières détiennent désormais des représentations compressées d'une fraction substantielle du savoir humain écrit. Neuralink a achevé [son premier implant d'interface cerveau-ordinateur sur un humain en 2024 ⧉](https://en.wikipedia.org/wiki/Mind_uploading "Mind uploading - Wikipedia"). En mars 2026, Eon Systems a émulé le cerveau complet d'une drosophile (139 255 neurones et 50 millions de synapses) dans un ordinateur. La question que posait *Lucy* est la question que le domaine essaie aujourd'hui de résoudre.
