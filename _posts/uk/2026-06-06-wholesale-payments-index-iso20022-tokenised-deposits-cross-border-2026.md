...
|---|---|---|
| **65% платіжних повідомлень містять неструктуровані адреси** | Завдання з ремедіації лишається масштабним | [SWIFT ⧉](https://www.swift.com/news-events/news/iso-20022-milestone-november-2026-unstructured-addresses-be-removed "ISO 20022 November 2026 structured address milestone") |
| **Неструктуровані адреси прибираються після листопада 2026** | Готовність платіжних даних стає невідкладною | [SWIFT ⧉](https://www.swift.com/news-events/news/iso-20022-milestone-november-2026-unstructured-addresses-be-removed "ISO 20022 November 2026 structured address milestone") |
| **Фаза прототипування Project Agorá** | Токенізований розрахунок випробовується у зв'язці центрального та комерційних банків | [BIS ⧉](https://www.bis.org/about/bisih/topics/fmis/agora.htm "Project Agorá") |
| **Фаза впровадження FSB** | Удосконалення транскордонних платежів залишається глобальним політичним пріоритетом | [FSB ⧉](https://www.fsb.org/2026/03/fsb-kicks-off-new-implementation-phase-to-enhance-cross-border-payments-through-public-private-partnership/ "Cross-border payments implementation phase") |
| **Рамка цифрових грошей Deutsche Bank** | Стейблкоїни, токенізовані депозити та CBDC стають практичною темою архітектури корпоративного банку | [Deutsche Bank ⧉](https://flow.db.com/publications/flow-white-papers-and-guides/digital-money-a-perspective-on-stablecoins-tokenised-deposits-and-cbdcs "Digital Money: stablecoins, tokenised deposits and CBDCs") |
