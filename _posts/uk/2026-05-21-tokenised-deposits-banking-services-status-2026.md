...
Окрім JPMorgan і HSBC, кілька програм є матеріальними для мережевої картини, навіть якщо їхні публічні розкриття скупіші. SG-FORGE від Société Générale випустила цифрові облігації в євро та регульований євро-стейблкоїн поряд з роботою над токенами-депозитами, що ставить Société Générale в незвичну позицію, коли обидва напрями функціонують під європейським регулюванням. Standard Chartered активний у токенізованих депозитах і в токенізованих реальних активах через Zodia Custody та власні сінгапурські пілоти. Платформа GS DAP від Goldman Sachs випустила цифрові облігації та підтримує токенізовану заставу. Ширший наслідок очевидний: здатність до токенів-депозитів тепер є обов’язковою для будь-якого глобального оптового банку, що розраховує залишатися конкурентоспроможним у транзакційному банкінгу, а цікавіше питання — хто з ким сумісний, а не хто збудує першим.
...
HSBC. Сервіс HSBC Tokenised Deposit Service діє у Гонконгу, Сінгапурі, Великій Британії, Люксембурзі та США у валютах USD, GBP, EUR, HKD та SGD; HSBC Orion призначена як інфраструктура для британського пілоту Digital Gilt Instrument (DIGIT); HSBC Gold Token токенізує виділене фізичне золото; а HSBC провів випробування міжмережевого атомарного розрахунку (Canton, Project Ensemble) та постквантового криптографічного захисту разом з Quantinuum ([HSBC](https://www.business.hsbc.com/en-gb/products/tokenised-deposit-service "HSBC Tokenised Deposit Service")).
