...
<ul class="post-lead-takeaways">
  ...
  <li><strong>Постійно ввімкнена ліквідність тепер є операційним і регуляторним базовим рівнем.</strong> Цілодобові казначейські API та віртуальні рахунки мінімізують заморожені кошти та піднімають планку стійкості. Для системно важливих API казначейства в реальному часі доступність «п'ять дев'яток» (99,999 %) стає внутрішньою інженерною ціллю, яку банки встановлюють самостійно для демонстрації стійкості рівня DORA перед наглядовими органами. Сама DORA не приписує універсального порогу «п'ять дев'яток»; вона охоплює управління ризиками ІКТ, звітування про інциденти, тестування стійкості, ризик третіх сторін та нагляд за критичними ІКТ-провайдерами.</li>
  ...
  <li><strong>Перехід на структуровану адресу 14/15 листопада 2026 року має жорстку дату.</strong> Swift CBPR+ видаляє неструктурований блок `<AdrLine>` з 14 листопада 2026 року; правила EPC SEPA дозволяють неструктуровану адресу лише до 15 листопада 2026 року. Потрібне чисте управління даними у командах продукту, технологій і комплаєнсу.</li>
</ul>
...
## Драбина впевненості — що датоване, що регулюється, що є прогнозом

Не кожен пункт у цьому звіті несе однаковий рівень впевненості. Питання рівня ради директорів — які з дельт є дедлайнами, які — наглядовими очікуваннями, а які — досі ринковими проєкціями, бо відповідь змінює бюджетну розмову.

| Категорія | Приклади |
| --- | --- |
| **Жорсткі дедлайни** | Перехід Swift CBPR+ на структуровану адресу (14 листопада 2026 року); правила EPC SEPA (15 листопада 2026 року) |
| **Регуляторні зобов'язання** | Управління ризиками ІКТ DORA + тестування стійкості + нагляд за третіми сторонами (ЄС); делегування SCA згідно з PSD3/PSR; MRM згідно з SR 11-7 + PRA SS1/23 |
| **Високоймовірні ринкові зрушення** | API казначейства в реальному часі, AI-захист від шахрайства, ліквідність на основі API, біометричне шахрайство, кероване діпфейками |
| **Стратегічні опції** | Токенізовані депозити, єдині реєстри у межах Project Agorá, коридори агентської комерції, безперервний FX (Wire 365) |
| **Прогнози** | $3-$5 trillion річних потоків агентської комерції до 2030 року (базовий сценарій McKinsey) |

Поставтеся до двох верхніх рядків як до фактів комплаєнсу, що визначають бюджетну статтю незалежно від того, чи банк зловить будь-який потенційний дохід. Поставтеся до двох нижніх рядків як до стратегічних опцій — з високим переконанням у напрямку, але де час виконання — це вибір ради, а не запис у календарі регулятора.
...
Пропозиція постійно ввімкненої ліквідності трансформує ризиковий профіль банку. Для системно важливих API казначейства в реальному часі доступність «п'ять дев'яток» (99,999 %) стає внутрішньою інженерною ціллю, яку банки встановлюють самостійно для демонстрації стійкості рівня DORA перед наглядовими органами. Сама DORA не приписує універсального порогу «п'ять дев'яток»; вона охоплює управління ризиками ІКТ, звітування про інциденти, тестування стійкості, ризик третіх сторін та нагляд за критичними ІКТ-провайдерами.
...
Інфраструктурний комплаєнс у 2026 році домінує **перехід на структуровану адресу 14/15 листопада 2026 року**, встановлений у межах [SWIFT Standards Release (SR) 2026](https://www.swift.com/standards/iso-20022/removal-unstructured-address "SWIFT — Removal of unstructured address, November 2026"). Swift CBPR+ видаляє неструктурований блок `<AdrLine>` з 14 листопада 2026 року; правила EPC SEPA дозволяють неструктуровану адресу лише до 15 листопада 2026 року. Від цих дат платіжні мережі CBPR+ і SEPA припиняють приймати повністю неструктуровані, текстові блоки поштової адреси (`<AdrLine>`) у платіжних повідомленнях. Будь-яке транскордонне або внутрішнє повідомлення з неструктурованою адресою там, де очікуються структуровані елементи, буде затримане або відхилене мережею.
...
Оскільки швидкості транзакцій прискорюються до реального часу, техніки шахрайства масштабувалися. [Звіт Entrust про шахрайство з ідентифікацією 2026](https://www.entrust.com/resources/reports/identity-fraud-report "Entrust 2026 Identity Fraud Report") оцінює діпфейки як **одну з п'яти спроб біометричного шахрайства**; раніший аналіз Entrust розміщував діпфейки на рівні **40 % спроб відеобіометричного шахрайства** зокрема. Синтетичні медіа дедалі частіше використовуються для обходу контролю розпізнавання голосу та обличчя в потоках онбордингу та платежів.
...
- **Показник успіху (KPI).** Нуль відмов через неструктуровану адресу в SWIFT і SEPA після переходу 14/15 листопада 2026 року.
...
## Що робити в понеділок зранку — шестипунктовий список для банків

Триетапна дорожня карта — це план циклу. Контрольний список нижче — це те, що CIO, COO або голова транзакційного банкінгу можуть мати на столі до кінця наступного робочого тижня, незалежно від того, наскільки зрілою є решта програми.

1. **Інвентаризуйте експозицію до неструктурованої адреси** за каналом і типом повідомлення. Кожен застарілий файловий маршрут, кожна застаріла кінцева точка API, кожна корпоративна ERP, що досі видає `<AdrLine>` як вільний текст. Результат: підрахунок, власник і дата усунення для кожного джерела.
2. **Встановіть таксономію ризиків агентських платежів.** Класифікуйте не-людиноорієнтовані потоки за методом ініціації (споживчий агент, агент продавця, корпоративний закупівельний агент), типом контрагента та рейкою. Результат: одностороння таксономія і тікет двигуна маршрутизації.
3. **Визначте ліміти політики делегованих повноважень для платежів, ініційованих AI.** Багаторівневі ліміти за розміром тікета, категорією продавця, географією. Результат: чернетка специфікації політика-як-код, яку двигун OPA може застосовувати.
4. **Зіставте критичні для DORA казначейські API та залежності третіх сторін.** Які API сидять в інвентарі серйозних, але правдоподібних сценаріїв; від яких третіх сторін вони залежать; які контракти вже відповідають DORA Article 28. Результат: рядок у реєстрі критичних ІКТ-провайдерів на кожен API.
5. **Ідентифікуйте два кейси використання токенізованих депозитів з вимірюваною казначейською цінністю.** Внутрішній неттинг між філіями та один коридор, суміжний з Project Agorá — реалістичні перші два. Результат: розмірений бізнес-кейс для кожного з власником і 90-денною датою рішення.
6. **Створіть рамку контролю модельного ризику для шахрайства та агентського ухвалення рішень.** Зіставте кожну ML-модель у шляхах шахрайства та агентських платежів з очікуваннями SR 11-7 / PRA SS1/23: задокументована мета, походження даних, інтерпретованість, моніторинг, шлях перевизначення. Результат: одностороння матриця контролю MRM на кожну модель.

Сенс списку не в тому, що щось у ньому новаторське. Сенс у тому, що він достатньо малий, щоб почати цього тижня, достатньо спостережуваний, щоб відстежувати на наступному виконавчому комітеті, і структурно узгоджений з чотирма стовпами, щоб рання робота живила програму, а не конкурувала з нею.
...
**Чи поширюється перехід SWIFT 14/15 листопада 2026 року також на внутрішні потоки SEPA?**
