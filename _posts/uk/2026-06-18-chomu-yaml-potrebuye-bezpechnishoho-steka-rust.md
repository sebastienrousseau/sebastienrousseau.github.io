...
| **Контроль доступу агента** | Обмежені дозволи лише для читання для локальних інструментів AI, що працюють через конфігурації MCP. | Управління модельним ризиком ([SR 11-7](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm)) | Межі сервера MCP обмежують операції агента схваленими каталогами. |
