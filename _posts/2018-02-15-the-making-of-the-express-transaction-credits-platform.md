...
<p class="post-lead-tldr"><strong>TL;DR.</strong> This article documents the technical construction of the Express Transaction Credits (EXTC) platform in early 2018 — specifically the token contract architecture built on ERC-223, the multi-signature disbursement logic, time-locked standing order primitives, and the collateral-backed instant loan mechanism. It is a record of what the design required, what ERC-223 solved that ERC-20 could not, and where on-chain payment networks ran into the hard constraints of public Ethereum in 2018.</p>
<p class="post-lead-heading"><strong>Key takeaways</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Why ERC-223 specifically.</strong> ERC-20's silent-loss flaw — tokens sent to contracts without a <code>tokenFallback</code> function were permanently destroyed — made it unsuitable for a production payment platform. ERC-223 made transfers atomic and reversible on failure.</li>
  <li><strong>The five contract primitives.</strong> EXTC's Solidity contract implemented name/symbol/decimals identity, fixed total supply, ERC-223 compliant balance-and-transfer, multi-signature authorisation for corporate disbursements, and block-height–based time locks for standing orders.</li>
  <li><strong>The scaling constraint.</strong> Ethereum mainnet in Q1 2018 averaged 15 transactions per second at a block gas limit of ~8 million. Payment volume at any material scale would have saturated the network.</li>
  <li><strong>What the design anticipated.</strong> The compliance-embedded token model, atomic settlement, and programmable transfer rules in EXTC prefigured design decisions later adopted in DeFi lending protocols, ERC-1400 security tokens, and CBDC pilot architectures.</li>
</ul>
<p class="post-lead-related"><strong>Related reading:</strong> <a href="https://sebastienrousseau.com/2018-02-04-unveiling-a-new-cryptocurrency-and-offering-future-faster-payment-solution">Unveiling a New Cryptocurrency and Faster Payment Solution</a>, <a href="https://sebastienrousseau.com/2018-01-24-the-erc-20-token-standard">ERC-20: The Ethereum Token Interface That Changed the World</a>, <a href="https://sebastienrousseau.com/2026-05-21-tokenised-deposits-banking-services-status-2026">Tokenised Deposits in 2026</a>.</p>
</aside>
<!-- lead-end -->
