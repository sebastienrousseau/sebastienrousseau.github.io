...
<p class="post-lead-tldr"><strong>TL;DR.</strong> Přeshraniční korporátní treasury v roce 2026 funguje na čtyřech railech paralelně — SWIFT CBPR+, instantní A2A pod PSD3/FiDA, tokenizované depozity a stablecoinové raily — sešité dohromady ISO 20022 jako společnou gramatikou. Práce pro týmy CIB a korporátní treasury spočívá v orchestraci, nikoli ve volbě railu.</p>
...
<p class="post-lead-related"><strong>Doporučené čtení:</strong> <a href="https://sebastienrousseau.com/2026-06-07-autonomous-treasury-index-programmable-liquidity-tokenised-deposits-2026">Index autonomní treasury 2026: programovatelná likvidita a tokenizované depozity</a>, <a href="https://sebastienrousseau.com/2026-06-15-pacs008-automation-iso-20022-interbank-payments-2026">Automatizace pacs.008: ISO 20022 mezibankovní platby v roce 2026</a>.</p>
</aside>
<!-- lead-end -->

> **Manažerské shrnutí.** Přeshraniční korporátní treasury v roce 2026 je multi-railovým inženýrským problémem dříve, než je problémem řízení vztahů. PSD3 a nařízení o přístupu k finančním datům (FiDA) rozšiřují perimetr open bankingu do dat korporátní treasury; přechod SWIFT MT/MX v listopadu 2026 činí z pacs.008 v souladu s CBPR+ jediný životaschopný formát pro přeshraniční mezibankovní komunikaci; tokenizované depozity a regulované stablecoinové raily obstarávají velkoobchodní zúčtovací nohu téměř v T+0 uvnitř povolovaných sítí. CIB, která v tomto cyklu vyhraje, není ta, která si vybere jediný rail; je to ta, která navrhne vrstvu orchestrace, která je svazuje dohromady. Tento článek prochází architekturou čtyř railů (A2A pod PSD3, SWIFT CBPR+, bankou vydávané tokenizované depozity, regulované stablecoiny) — co každý rail dělá dobře, kde leží hranice úvěrové expozice a co musí vrstva orchestrace policy-as-code nad nimi vynucovat, aby korporát viděl jednu platbu a dohled jednu auditovatelnou stopu.
...
**Je „open finance" jen přejmenovaný open banking?**
Není. Open banking pod PSD2 pokrýval platební účty. PSD3 a nařízení o přístupu k finančním datům (FiDA) rozšiřují povinnost sdílení dat do penzí, hypoték, spoření, pojištění a dat korporátní treasury. Důsledek pro korporátní treasury je přímý: relationship manager CIB nyní může konzumovat kompletní obrázek likvidity korporátu napříč více bankami přes jeden API kontrakt, na základě instrukce korporátu — nikoli pouze historii jeho platebního účtu.

**Proč je architektonickým ohniskem vrstva orchestrace, nikoli rail?**
Protože raily se nyní komoditizují. SWIFT CBPR+ pacs.008, A2A pod PSD3, tokenizované depozity i regulované stablecoiny nesou na úrovni zprávy stejnou gramatiku ISO 20022. To, co odlišuje CIB roku 2026, je engine policy-as-code, který vybírá rail podle platby na základě koridoru, velikosti transakce, požadavku na finalitu zúčtování a vztahu protistrany — a který zaznamenává volbu do auditní telemetrie, na kterou se zeptá dohled. Bez tohoto enginu je multi-rail jen volitelností bez řízení.

**Kde leží hranice úvěrové expozice na noze tokenizovaného depozita?**
Bankou vydávané tokenizované depozity na povolovaném ledgeru jsou přímou pohledávkou vůči vydávající bance — úvěrová expozice končí při burn. Regulované stablecoinové raily (pod dohledem MiCA v EU, režim diskusního dokumentu Bank of England ve Velké Británii, analogie jinde) jsou pohledávkou vůči rezervě, přičemž expoziční okno podléhá auditnímu cyklu a podmínkám záruky výplaty. Treasury tým, který nedokumentuje odpověď podle railu a podle koridoru, nese na své rozvaze neměřené úvěrové riziko.

**Co se stane se SWIFT v této architektuře?**
SWIFT nemizí — ukotvuje dlouhý chvost. Koridory, kam bankou vydávané tokenizované depozity zatím nedosáhnou (většina vztahů se subdodavateli v rozvíjejících se trzích, většina nízkofrekvenčních / nízkoobjemových přeshraničních toků), a koridory, kde korporát nebo banka vyžaduje auditní stopu CBPR+ korespondenčního bankovnictví, pokračují na SWIFT pacs.008. Architektura roku 2026 je „SWIFT + nové raily", nikoli „nové raily místo SWIFT".

**Co korporát kupuje, když kupuje tento stack?**
Volitelnost napříč raily, s jedním standardem zpráv (ISO 20022), jednou vrstvou politik (orchestrační engine) a jedním rekonciliačním feedem (stav pacs.002 + potvrzení camt.054 + strukturované výpisy camt.053). Korporát neplatí za čtyři samostatná railová připojení. Platí za vrstvu orchestrace, která činí ze čtyř railů jeden provozní celek — a za auditní stopu, která mu umožní odpovědět na otázku „kterou kolejí jela ta platba 4,2 mil. EUR a proč?" ráno po další dohledové žádosti.
...
Bank for International Settlements, Committee on Payments and Market Infrastructures (2023). *Harmonised ISO 20022 data requirements for enhancing cross-border payments* (CPMI Papers No. 230). Dostupné na: [https://www.bis.org/cpmi/publ/d230.htm](https://www.bis.org/cpmi/publ/d230.htm "BIS CPMI 230 — Harmonised ISO 20022 data requirements")

Bank for International Settlements (2024). *Project Agorá: cross-border payments with tokenised commercial bank deposits and central bank money*. BIS Innovation Hub. Dostupné na: [https://www.bis.org/about/bisih/topics/fmis/agora.htm](https://www.bis.org/about/bisih/topics/fmis/agora.htm "BIS Project Agorá")

Bank of England (2023). *Regulatory regime for systemic payment systems using stablecoins and related service providers — Discussion Paper*. Dostupné na: [https://www.bankofengland.co.uk/paper/2023/dp/regulatory-regime-for-systemic-payment-systems-using-stablecoins-and-related-service-providers](https://www.bankofengland.co.uk/paper/2023/dp/regulatory-regime-for-systemic-payment-systems-using-stablecoins-and-related-service-providers "Bank of England — Regulatory regime for stablecoins discussion paper")

European Commission (2023). *Proposal for a Directive on payment services and electronic money services (PSD3)*. Dostupné na: [https://finance.ec.europa.eu/regulation-and-supervision/financial-services-legislation/implementing-and-delegated-acts/payment-services-directive_en](https://finance.ec.europa.eu/regulation-and-supervision/financial-services-legislation/implementing-and-delegated-acts/payment-services-directive_en "European Commission — Payment Services Directive proposal")

European Parliament and Council (2023). *Regulation (EU) 2023/1114 on markets in crypto-assets (MiCA)*. Dostupné na: [https://eur-lex.europa.eu/eli/reg/2023/1114/oj](https://eur-lex.europa.eu/eli/reg/2023/1114/oj "Regulation (EU) 2023/1114 — Markets in Crypto-Assets (MiCA)")

Financial Action Task Force (2023). *International standards on combating money laundering and the financing of terrorism — Recommendation 16 on wire transfers*. Dostupné na: [https://www.fatf-gafi.org/en/publications/Fatfrecommendations/Fatf-recommendations.html](https://www.fatf-gafi.org/en/publications/Fatfrecommendations/Fatf-recommendations.html "FATF Recommendations")

International Organization for Standardization (2020). *ISO 17442 Financial services — Legal entity identifier (LEI)*. Dostupné na: [https://www.gleif.org/en/about-lei/iso-17442-the-lei-code-structure](https://www.gleif.org/en/about-lei/iso-17442-the-lei-code-structure "ISO 17442 — Legal Entity Identifier")

SWIFT (2024). *Cross-Border Payments and Reporting Plus (CBPR+) usage guidelines*. Dostupné na: [https://www.swift.com/standards/iso-20022/iso-20022-programme](https://www.swift.com/standards/iso-20022/iso-20022-programme "SWIFT CBPR+ usage guidelines")

<!-- enrich-start -->
<aside class="author-card" aria-label="O autorovi"><img alt="Portrét Sebastiena Rousseaua" src="https://cloudcdn.pro/stocks/images/sebastienrousseau.webp" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">Vrcholový bankovní technolog píšící o aplikované AI, migraci ISO 20022, postkvantové kryptografii pro finanční služby a strukturální transformaci velkoobchodních plateb.</span><span class="author-credentials">20+ let napříč HSBC Commercial &amp; Investment Bank, PayPal, Barclays, Shazam, AKQA, Virgin Group. <a href="/about/index.html">Úplný profil</a> &middot; <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
<p class="post-reviewed">Naposledy revidováno <time datetime="2026-06-24">2026-06-24</time>.</p>
<!-- enrich-end -->
