...
banner_alt: "Eine fluchtende Reihe von Pendelleuchten entlang einer dunklen Fensterwand, die vorderste scharf und erleuchtet, jede weitere dahinter tiefer im Schatten verschwindend."
banner_height: "1597"
banner_width: "2584"
...
date: "July 28, 2026"
description: "Die NCSC-Frist zur Bestandsaufnahme 2028 liegt vor jeder Migrationsfrist. Banken können sie nicht halten: Das DORA-Asset-Register erfasst keine Kryptografie."
format-detection: "telephone=no"
hreflang: "de"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/de/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
image_alt: "Schwarzweiß-Porträt von Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "Cryptographic Bill of Materials, CBOM, CycloneDX, ECMA-424, kryptografisches Inventar, Krypto-Agilität, Post-Quanten-Migration, NCSC Migrationsfristen, NIST IR 8547, FIPS 203, ML-KEM, DORA Article 8, IKT-Asset-Register, SBOM, Zertifikatslebenszyklus, HSM, Schlüsselmanagement, Wholesale-Banking"
language: "de"
...
permalink: "https://sebastienrousseau.com/de/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "Das CBOM, das Banken fehlt: Krypto-Bestandsaufnahme 2028"
short_name: "sebastienrousseau"
subtitle: "Eine ingenieurtechnische Lesart für Bank-CTOs und Leiter der Sicherheitsarchitektur: Die erste Post-Quanten-Frist ist keine Migrationsfrist, sondern eine Frist zur Bestandsaufnahme — und das IKT-Asset-Register, das DORA ohnehin verlangt, erfasst alles über ein Asset außer der Kryptografie darin."
tags: "Post-Quanten, Kryptografie, CBOM, CycloneDX, DORA, Krypto-Agilität, Sicherheitsarchitektur, Banking, SBOM, NIST, NCSC, Regulatorik"
theme-color: "0, 83, 191"
title: "Nicht erfassbar, nicht migrierbar: Das fehlende CBOM der Banken"
url: "https://sebastienrousseau.com/de/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
...
item_description: "Die NCSC-Frist zur Bestandsaufnahme 2028 liegt vor jeder Migrationsfrist. Banken können sie nicht halten: Das DORA-Asset-Register erfasst keine Kryptografie."
...
item_title: "Nicht erfassbar, nicht migrierbar: Das fehlende CBOM der Banken"
...
apple-mobile-web-app-title: "Kryptografisches BOM"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "Die erste Post-Quanten-Frist gilt der Bestandsaufnahme, nicht der Migration. Das von DORA verlangte IKT-Asset-Register erfasst alles außer der Kryptografie."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo von Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Das CBOM, das Banken fehlt: Krypto-Bestandsaufnahme 2028"
twitter_url: "https://sebastienrousseau.com/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
excerpt: "Jede Post-Quanten-Roadmap setzt ein Inventar voraus, das es nicht gibt. Das Asset-Register kennt den Server, den Eigentümer und die Kritikalität; es kennt nicht den Algorithmus, die Schlüssellänge, die Bibliothek oder das Ablaufdatum."
...
<ul class="post-lead-takeaways">
  <li><strong>Die Bestandsaufnahme ist die bindende Restriktion.</strong> Die NCSC-Leitlinie setzt ein vollständiges Bild der kryptografischen Abhängigkeiten auf 2028, die Migration höchster Priorität auf 2031 und den Abschluss auf 2035. NIST IR 8547 stuft RSA und ECC nach 2030 als veraltet ein und untersagt sie nach 2035. Der ingenieurtechnische Vorlauf ist kürzer, als die Schlagzeilenfrist vermuten lässt.</li>
  <li><strong>Ihr DORA-Register hat die falsche Form.</strong> Article 8 verlangt Identifikation, Klassifizierung und Abhängigkeitskartierung von IKT-Assets. Nichts davon erfordert die Erfassung eines einzigen Algorithmus, einer Schlüssellänge oder einer Cipher Suite. Zwei Register, eine Lücke.</li>
  <li><strong>CBOM ist ein Datenmodell, kein Werkzeug.</strong> Die Unterstützung kryptografischer Assets wurde in CycloneDX überführt und als ECMA-424 verabschiedet. Ein CBOM ist damit ein BOM-Dokument, das durch das SBOM-Tooling läuft, das eine Bank bereits betreibt.</li>
  <li><strong>Die Bestandsaufnahme sind vier Probleme, nicht eines.</strong> Quellcode, Binaries und Container, live ausgehandelte Netzwerkverbindungen sowie der Bestand an Anbieter- und Hardwaresystemen. Die ersten drei sind scanbar. Das vierte ist ein vertragliches Nachweisproblem — und dort liegt das reale Exposure des Wholesale-Banking.</li>
</ul>
<p class="post-lead-related"><strong>Weiterführende Lektüre:</strong> <a href="https://sebastienrousseau.com/2026-06-29-post-quantum-security-scorecard-board-level-fiduciary-agility-2026">Die Post-Quanten-Sicherheits-Scorecard 2026</a>, <a href="https://sebastienrousseau.com/2026-06-12-kyberlib-post-quantum-banking-migration-standards-code-2026">KyberLib und die Post-Quanten-Migration im Bankwesen</a>.</p>
</aside>
<!-- lead-end -->
...
1. **Denken Sie den Meilenstein 2028 als Fähigkeit, nicht als Bericht.** Das Ergebnis ist ein gepflegtes, maschinenlesbares Inventar, das sich selbst neu erzeugt — kein Dokument, das einmal für einen Aufseher entsteht.
2. **Geben Sie CBOMs ab sofort aus dem Build aus, zuerst für neue Dienste.** Versuchen Sie nicht, den Bestand in einem Durchgang zu erfassen. Verdrahten Sie es in der Pipeline für alles, was in diesem Jahr gebaut oder wesentlich verändert wird, damit die Abdeckung wächst, statt eine Kampagne zu erfordern.
3. **Nehmen Sie die Vertragsklausel noch in diesem Quartal in die Verlängerungsvorlage auf.** Kryptografische Offenlegung und eine Zusage zur Krypto-Agilität. Das hat die längste Vorlaufzeit von allem auf der Liste und hängt von keiner Werkzeugentscheidung ab.
4. **Führen Sie die Netzwerkbeobachtung zuerst auf den Zahlungs- und Settlement-Pfaden durch.** Dort richtet die Lücke zwischen Konfiguration und Realität den größten Schaden an, und dort konzentrieren sich Legacy-Gegenparteien.
5. **Verknüpfen Sie das CBOM mit dem Article 8-Register und priorisieren Sie auf der Verknüpfung.** Veröffentlichen Sie die Rangliste. Sie ist das Artefakt, das ein Ingenieurinventar in ein Vorstandsgespräch über Reihenfolge und Geld übersetzt.
6. **Diffen Sie jede Neuerzeugung und alarmieren Sie auf neuen quantenanfälligen Abhängigkeiten.** Ein Inventar ohne Diff ist ein Archiv.
...
* Europäisches Parlament und Rat der Europäischen Union, 2022\. *Regulation (EU) 2022/2554 über die digitale operationale Resilienz im Finanzsektor (DORA)*. Brüssel: Amtsblatt der Europäischen Union. Verfügbar unter: [Europäisches Parlament und Rat der Europäischen Union, 2022\.](https://eur-lex.europa.eu/eli/reg/2022/2554/oj "Europäisches Parlament und Rat der Europäischen Union, 2022.").  
* National Cyber Security Centre, 2025\. *Timelines for migration to post-quantum cryptography*. London: NCSC. Verfügbar unter: [National Cyber Security Centre, 2025\.](https://www.ncsc.gov.uk/guidance/pqc-migration-timelines "National Cyber Security Centre, 2025.").  
* National Institute of Standards and Technology, 2024\. *NIST IR 8547 (Initial Public Draft), Transition to Post-Quantum Cryptography Standards*. Gaithersburg: U.S. Department of Commerce. Verfügbar unter: [National Institute of Standards and Technology, 2024\.](https://csrc.nist.gov/pubs/ir/8547/ipd "National Institute of Standards and Technology, 2024.").  
* National Institute of Standards and Technology, 2024\. *FIPS 203, Module-Lattice-Based Key-Encapsulation Mechanism Standard*. Gaithersburg: U.S. Department of Commerce. Verfügbar unter: [National Institute of Standards and Technology, 2024\.](https://csrc.nist.gov/pubs/fips/203/final "National Institute of Standards and Technology, 2024.").  
* OWASP Foundation, 2026\. *CycloneDX Bill of Materials Specification (ECMA-424)*. Wakefield: OWASP Foundation. Verfügbar unter: [OWASP Foundation, 2026\.](https://owasp.org/www-project-cyclonedx/ "OWASP Foundation, 2026.").  
* OWASP CycloneDX, 2026\. *Cryptography Bill of Materials (CBOM)*. Wakefield: OWASP Foundation. Verfügbar unter: [OWASP CycloneDX, 2026\.](https://cyclonedx.org/capabilities/cbom/ "OWASP CycloneDX, 2026.").  
* IBM Research, 2026\. *CBOM: Cryptography Bill of Materials*. Armonk: IBM. Verfügbar unter: [IBM Research, 2026\.](https://github.com/IBM/CBOM "IBM Research, 2026.").
