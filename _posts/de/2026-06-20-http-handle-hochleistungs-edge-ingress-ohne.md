...
<p class="post-lead-tldr"><strong>Kurzfassung.</strong> http-handle ist ein quelloffenes, statisch gelinktes Rust-Binary, das am Banking-Edge Nginx und Envoy ersetzt. Es liefert auf ARM64-Knoten 180.000 Anfragen pro Sekunde über Linux-<code>sendfile(2)</code>-Zero-Copy-Transfers, erzwingt mTLS- und JWT-Validierung auf der Netzwerk-Socket-Schicht bevor jeglicher Anwendungscode ausgeführt wird, handelt HTTP/2 und HTTP/3 automatisch per ALPN aus und emittiert nativ OpenTelemetry-Metriken – alles ohne Runtime-Abhängigkeiten jenseits von <code>libc</code>.</p>
