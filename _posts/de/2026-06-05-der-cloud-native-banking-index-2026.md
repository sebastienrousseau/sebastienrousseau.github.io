...
date: "June 5, 2026"
description: "Ein Cloud-Native-Banking-Index 2026 zur Messung der DORA-Reife, des Plattform-Engineering-Niveaus, der Cloud-Konzentrationsrisiken, der Exit-Nachweise und der operativen Resilienz."
format-detection: "telephone=no"
hreflang: "de"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/de/2026-06-05-cloud-native-banking-index-dora-resilience-platform-engineering-2026"
...
item_description: "Ein Cloud-Native-Banking-Index 2026 zur Messung der DORA-Reife, des Plattform-Engineering-Niveaus, der Cloud-Konzentrationsrisiken, der Exit-Nachweise und der operativen Resilienz."
...
item_title: "Der Cloud-Native-Banking-Index 2026: DORA, Plattform-Engineering und Resilienz"
...
twitter_description: "Ein Cloud-Native-Banking-Index 2026 zur Messung der DORA-Reife, des Plattform-Engineering-Niveaus, der Cloud-Konzentrationsrisiken, der Exit-Nachweise und der operativen Resilienz."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo von Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Der Cloud-Native-Banking-Index 2026"
...
<p class="post-lead-tldr"><strong>Kurzfassung.</strong> Cloud-natives Banking befindet sich 2026 in der DORA-Prüfungsphase, nicht in der Vorbereitungsphase. Das Regime gilt seit dem 17. Januar 2025; das CTPP-Designationsregime nach Artikeln 28-44 öffnet sich im Zeitraum 2025-2026; AWS, Microsoft (Azure), Google (GCP) und Salesforce sitzen sämtlich innerhalb oder am Rand des Designationsperimeters; die [Aufsichtsprioritäten der EZB für 2026-28 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Aufsichtsprioritäten der EZB-Bankenaufsicht 2026-28") enthalten explizite Programme zur Vorbereitung auf Cloud-Ausfälle und zu bedrohungsgesteuerten Penetrationstests. Die relevante Engineering-Arbeit besteht aus Plattform-Engineering-Primitiven — Paved Roads auf Kubernetes plus Backstage plus OPA plus OpenTelemetry —, die DORA-Artikel-8-Registernachweise im Takt der Deployment-Pipeline produzieren, ergänzt um getestete Exit-Ausführungsnachweise, die belastbare Substituierbarkeit von Dokumentationstheater trennen.</p>
<p class="post-lead-heading"><strong>Wesentliche Erkenntnisse</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>DORA-Cloud-Resilienz ist in aktiver Durchsetzung.</strong> Artikel 6 (IKT-Risikomanagementrahmen), Artikel 8 (Informationsregister + ITS), Artikel 18 (Vier-Stunden-Meldepflicht), Artikel 26 (TIBER-EU-konformer TLPT), Artikel 28-44 (CTPP-Regime) — alle in Kraft seit 17. Januar 2025. Der Rahmen „Vorbereitung auf DORA" ist zwei Regulierungszyklen veraltet.</li>
  <li><strong>Das CTPP-Designationsregime öffnet sich.</strong> AWS, Microsoft (Azure), Google (GCP) und Salesforce sitzen innerhalb oder am Rand des Designationsperimeters. Die Designation gibt den Europäischen Aufsichtsbehörden direkte Aufsichtsrechte: Auskunftsersuchen, Vor-Ort-Inspektionen, aufsichtliche Empfehlungen. Cloud-Anbieter-Konzentration ist nun eine regulierte Aufsichtsmetrik.</li>
  <li><strong>Plattform-Engineering ist das Betriebsmodell-Ergebnis.</strong> Fünf konkret benannte Laufzeit-Primitive: Kubernetes-basierte Paved Roads, Backstage-Entwicklerportal (oder Äquivalent), GitOps via ArgoCD oder Flux, Open Policy Agent am Admission, OpenTelemetry End-to-End. Nachweise im Takt der Pipeline schlagen Dokumentationspakete zum Prüfungstermin.</li>
  <li><strong>Souveräne Cloud ist konstruiert, nicht gebrandet.</strong> AWS European Sovereign Cloud, Microsoft EU Data Boundary, sovereign-cloud-Partnerschaften von Google Cloud (Bleu, Thales / S3NS), Oracle EU Sovereign Cloud und die Gaia-X-konformen Optionen adressieren jeweils eine spezifische Dimension von Schrems II plus DORA-Artikel 28 plus EBA/GL/2019/02-Auslagerung. Keine davon ist eine schlüsselfertige Antwort.</li>
  <li><strong>Getestete Exit-Nachweise sind der Unterscheider.</strong> EBA/GL/2019/02 Randnummern 81 und 113-117 verlangen Substituierbarkeitsanalyse und Nachweise der Exit-Strategie-Ausführung — nicht nur ein Exit-Plan-PDF. Vierteljährliches Tabletop reicht nicht; die Aufsicht erwartet mindestens einen jährlichen End-to-End-Exit-Ausführungstest für jede kritische oder wichtige Funktion.</li>
  <li><strong>RTO- und RPO-Zahlen kommen aus dem CIF-Inventar, nicht aus Engineering-Bequemlichkeit.</strong> Jede kritische oder wichtige Funktion (CIF) erhält ein stufenbasiertes RTO/RPO-Ziel — typischerweise 2 h / 15 min für Tier 1, 4 h / 1 h für Tier 2, 24 h / 4 h für Tier 3 — abgeleitet aus der Business-Impact-Analyse des Instituts, nicht aus dem, was das Plattformteam liefern kann.</li>
</ul>
</aside>
<!-- lead-end -->

Cloud-natives Banking befindet sich 2026 in der DORA-Prüfungsphase. Die [Verordnung (EU) 2022/2554 ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA — Digital Operational Resilience Act") gilt seit dem 17. Januar 2025. Das Designationsregime für kritische IKT-Drittdienstleister (CTPP) nach Artikeln 28-44 öffnet sich im Zeitraum 2025-2026, wobei AWS, Microsoft (Azure), Google (GCP) und Salesforce innerhalb oder am Rand des Designationsperimeters liegen. Die Europäischen Aufsichtsbehörden (EBA, EIOPA, ESMA) haben die finalen RTS und ITS zum [Informationsregister ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "ESAs ITS zum Informationsregister") im Jahr 2024 veröffentlicht. Die EZB-Bankenaufsicht führt in ihren [Aufsichtsprioritäten 2026-28 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Aufsichtsprioritäten 2026-28") explizite Programme zur Vorbereitung auf Cloud-Ausfälle und zu bedrohungsgesteuerten Penetrationstests. Die institutionelle Frage lautet nicht mehr, ob die Cloud-Strategie an DORA auszurichten ist — das ist entschieden —, sondern ob die Plattform-Engineering-Primitive des Instituts Nachweise im Takt der Deployment-Pipeline produzieren statt in PDFs, die in der Woche vor der Prüfung zusammengestellt werden.
...
|---|---|---|
| **DORA seit 17. Januar 2025 in aktiver Durchsetzung** | Erste Welle aufsichtlicher Feststellungen in Q4 2025 eingegangen; zweite Welle erwartet im H2 2026 | [EUR-Lex ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA") |
| **CTPP-Designation öffnet sich im Zeitraum 2025-2026** | AWS, Microsoft, Google, Salesforce innerhalb oder am Rand des Perimeters; die Designation gibt den ESAs direkte Aufsichtsrechte | [EBA ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "EBA — DORA Direct Supervision and Oversight") |
| **EZB-Aufsichtsprioritäten 2026-28 nennen Cloud-Störung explizit** | Modellierte Aufsichtsszenarien testen die Fähigkeit, einen anhaltenden Ausfall eines designierten CTPP zu absorbieren | [EZB-Bankenaufsicht ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "Aufsichtsprioritäten 2026-28") |
| **TIBER-EU an DORA-Artikel 26 ausgerichtet** | TLPT-Scope deckt kritische / wichtige Funktionen einschließlich Cloud-gehosteter Dienste ab | [EZB TIBER-EU ⧉](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "TIBER-EU") |
| **EBA-Auslagerungsleitlinien (EBA/GL/2019/02) greifen mit DORA-Artikel 28 ineinander** | Substanzielle Präsenz (¶64), Substituierbarkeitsanalyse (¶81), Exit-Strategie (¶113-117) — genau die Randnummern, auf die die Aufsicht prüft | [EBA ⧉](https://www.eba.europa.eu/regulation-and-policy/internal-governance/guidelines-on-outsourcing-arrangements "EBA-Auslagerungsleitlinien") |
| **EU Cloud Services Scheme (EUCS) — Entwurf macht Fortschritte** | Künftiges Zertifizierungsschema für souveräne Cloud unter dem EU-Cybersicherheitsakt; ENISA-veröffentlichter Entwurf | [ENISA EUCS ⧉](https://www.enisa.europa.eu/publications/eucs-cloud-service-scheme "EUCS — Cybersecurity Scheme for Cloud Services") |
...
- Europäische Union, (2022). [Verordnung (EU) 2022/2554 — Digital Operational Resilience Act (DORA) ⧉](https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX%3A32022R2554 "DORA").
- European Banking Authority, (2019). [EBA/GL/2019/02 — Leitlinien zu Auslagerungsvereinbarungen ⧉](https://www.eba.europa.eu/regulation-and-policy/internal-governance/guidelines-on-outsourcing-arrangements "EBA-Auslagerungsleitlinien").
...
- Europäische Aufsichtsbehörden, (2024). [Final Report on the ITS on the Register of Information under DORA ⧉](https://www.eba.europa.eu/activities/direct-supervision-and-oversight/digital-operational-resilience-act "ESAs ITS").
- EZB-Bankenaufsicht, (2025). [Aufsichtsprioritäten 2026-28 ⧉](https://www.bankingsupervision.europa.eu/framework/priorities/html/ssm.supervisory_priorities202511.en.html "EZB-Prioritäten 2026-28").
- Europäische Zentralbank, (2024). [TIBER-EU-Rahmenwerk ⧉](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "TIBER-EU").
