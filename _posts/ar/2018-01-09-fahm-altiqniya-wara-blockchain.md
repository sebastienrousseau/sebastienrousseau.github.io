...
banner_alt: "كتل سجل رقمي مجردة مترابطة بخطوط ضوئية على خلفية مظلمة"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Jan 09, 2018"
description: "مقدمة تقنية لآلية عمل blockchain: سلاسل التجزئة التشفيرية، وأشجار Merkle، والتوافق الموزع، وكيف حوّلت طبقة Ethereum القابلة للبرمجة سجل المدفوعات إلى منصة للعقود الذكية والأصول المُرمَّزة."
format-detection: "telephone=no"
hreflang: "ar"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/ar/2018-01-09-understanding-the-technology-behind-blockchain"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "تقنية blockchain، تجزئة تشفيرية، شجرة Merkle، توافق موزع، إثبات العمل، Ethereum، عقود ذكية، EVM، Solidity، ERC-20، سجل موزع، تمويل لا مركزي"
language: "ar"
layout: "report"
locale: "ar_AR"
...
permalink: "https://sebastienrousseau.com/ar/2018-01-09-understanding-the-technology-behind-blockchain"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "من سلاسل التجزئة التشفيرية إلى العقود الذكية القابلة للبرمجة: الآليات التي جعلت blockchain منصةً لا مجرد سجل."
tags: "blockchain، Ethereum، عقود ذكية، تجزئة تشفيرية، شجرة Merkle، آلية توافق، إثبات العمل، EVM، Solidity، ERC-20، سجل موزع، تمويل لا مركزي, Ethereum, smart contracts, cryptography, Merkle tree, consensus mechanism, proof of work, EVM, Solidity, ERC-20, decentralised finance, ISO 20022, التشفير ما بعد الكمي, AI, stablecoins, الودائع المرمَّزة"
theme-color: "0, 67, 165"
title: "فهم التقنية وراء Blockchain"
url: "https://sebastienrousseau.com/ar/2018-01-09-understanding-the-technology-behind-blockchain"
...
item_description: "مقدمة تقنية لـ blockchain: سلاسل التجزئة التشفيرية، وأشجار Merkle، والتوافق الموزع، وكيف وسّعت Ethereum سجل المدفوعات إلى منصة قابلة للبرمجة."
...
item_title: "فهم التقنية وراء Blockchain"
...
apple-mobile-web-app-title: "تقنية Blockchain"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 67, 165"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "كيف تعمل blockchain: سلاسل التجزئة التشفيرية، وأشجار Merkle، وآليات التوافق، وكيف حوّلت Ethereum السجل إلى منصة قابلة للبرمجة."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "فهم التقنية وراء Blockchain"
...
excerpt: "blockchain هو سجل إلحاقي فقط مؤمَّن بسلاسل التجزئة التشفيرية والتوافق الموزع — تصميم يجعل التلاعب مكلفاً حسابياً وقابلاً للتدقيق من قِبل الجميع. وسّعت Ethereum هذه الأسس بطبقة تنفيذ قابلة للبرمجة، محوِّلةً سجل المدفوعات البسيط إلى منصة للعقود الذكية والرموز والتمويل اللامركزي."
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="ملخص المقال">
<p class="post-lead-tldr"><strong>خلاصة القول.</strong> البلوك تشين هو دفتر أستاذ موزع تُربط فيه كل سجلاتٍ (كتلة) بالسجل السابق لها ارتباطاً تشفيرياً. إن تعديل أي سجل تاريخي يُبطل كل كتلة لاحقة — وهي خاصية لا يُنفّذها سلطة مركزية بل شبكة من المُدققين المستقلين الذين يتبعون القواعد ذاتها. وسّعت Ethereum هذا التصميم بطبقة تنفيذ كاملة ورينغ، مما جعل دفتر الأستاذ قابلاً للبرمجة وفتح الباب أمام العقود الذكية والرموز الرقمية والتمويل اللامركزي.</p>
<p class="post-lead-heading"><strong>أبرز النقاط</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>المشكلة الجوهرية التي حُلّت.</strong> عالجت سلسلة كتل Bitcoin مشكلة الإنفاق المزدوج دون الحاجة إلى طرف ثالث موثوق، وذلك بجعل تاريخ المعاملات مقاوماً للتلاعب ومُصاناً بشكل جماعي. واعتمد الحلّ على ثلاثين عاماً من البحث السابق في دوال التجزئة التشفيرية والأنظمة الموزعة.</li>
  <li><strong>كيف تترابط الكتل.</strong> تحتوي كل كتلة على تجزئة SHA-256 لرأس الكتلة السابقة. تعديل كتلة واحدة يكسر كل تجزئة لاحقة، مما يستلزم من المهاجم إعادة تنفيذ proof-of-work اللاحق بأكمله — وهو أمر غير ممكن حسابياً بعد الكتل الأولى في سلسلة ناضجة.</li>
  <li><strong>الطبقة القابلة للبرمجة في Ethereum.</strong> أضافت Ethereum الآلة الافتراضية لـ Ethereum (EVM)، وهي بيئة تنفيذ حتمية تُشغّل شيفرة Solidity على كل عقدة كاملة في آنٍ واحد. تُنفَّذ العقود الذكية — الشيفرة المنشورة على السلسلة — بصورة ذرية: إما تكتمل كلياً أو تُعاد، دون أي حالة جزئية.</li>
  <li><strong>من دفتر الأستاذ إلى منصة.</strong> أظهر معيار الرمز ERC-20، المُحدَّد عام 2015، كيف يمكن لـ EVM استضافة رموز قابلة للاستبدال دون تعديل البروتوكول الأساسي. بُني عليه مئات من رموز الدفع وعملات الاستقرار ورموز الحوكمة بين عامَي 2017 و2020 — بما فيها رمز EXTC الموصوف في المقالات المرافقة لهذا الموقع.</li>
</ul>
<p class="post-lead-related"><strong>قراءة ذات صلة:</strong> <a href="https://sebastienrousseau.com/2018-01-24-the-erc-20-token-standard">ERC-20: The Ethereum Token Interface That Changed the World</a>، <a href="https://sebastienrousseau.com/2018-02-04-unveiling-a-new-cryptocurrency-and-offering-future-faster-payment-solution">Unveiling a New Cryptocurrency and Faster Payment Solution</a>، <a href="https://sebastienrousseau.com/2018-02-15-the-making-of-the-express-transaction-credits-platform">The Making of the Express Transaction Credits Platform</a>.</p>
</aside>
<!-- lead-end -->
...
>
> - **المشكلة.** تستلزم النقود الرقمية حل مشكلة الإنفاق المزدوج: منع إنفاق الوحدة ذاتها مرتين دون مقاصة موثوقة. حلّ الورقة البيضاء لـ Bitcoin عام 2008 هذه المعضلة باستبدال الوسطاء الموثوقين بالدليل التشفيري والإجماع الموزع ([Nakamoto, 2008](https://bitcoin.org/bitcoin.pdf "Bitcoin: A Peer-to-Peer Electronic Cash System")).
...
> - **امتداد Ethereum.** قدّمت الورقة الصفراء لـ Ethereum (2014) الـ EVM — آلة مكدس حتمية تعمل على كل عقدة كاملة. العقود الذكية هي شيفرة منشورة على السلسلة؛ تُنفَّذ بالتطابق على جميع العقد وتُسوَّى ذرياً، مستبدلةً الوسطاء الموثوقين بشيفرة تُنفّذ نفسها ([Wood, 2014](https://ethereum.github.io/yellowpaper/paper.pdf "Ethereum Yellow Paper")).
...
1. **الربط التشفيري.** تحتوي كل كتلة معاملات على تجزئة الكتلة السابقة. دالة التجزئة هي تعيين حتمي أحادي الاتجاه: لأي مدخل، تنتج الدالة مخرجاً بطول ثابت، وتغيير بتّة واحدة من المدخل ينتج مخرجاً مختلفاً كلياً. يعني هذا أن أي تعديل على كتلة تاريخية يُبطل كل كتلة بعدها.

2. **إجماع proof-of-work.** يستلزم إضافة كتلة جديدة إيجاد قيمة nonce تجعل تجزئة الكتلة تقع دون عتبة مستهدفة — مكلفة حسابياً في إيجادها، رخيصة للغاية في التحقق منها. يجعل هذا إعادة كتابة التاريخ مكلفةً بما يتناسب مع عمق الكتلة المعدَّلة، إذ يجب على المهاجم إعادة تنفيذ proof-of-work بأسره من تلك الكتلة حتى طرف السلسلة.
...
وضع معيار ERC-20 واجهةً مشتركة للرموز القابلة للاستبدال — `transfer`، و`transferFrom`، و`approve`، و`allowance`، و`balanceOf`، و`totalSupply` — مما يتيح لأي رمز متوافق مع ERC-20 العمل مع أي بورصة أو محفظة تدعم ERC-20 دون تكامل مخصص.
