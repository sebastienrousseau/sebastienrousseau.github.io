...
tags: "الذكاء الاصطناعي الوكيل، الذكاء الاصطناعي المصرفي، حوكمة الذكاء الاصطناعي، سير العمل المستقل، مخاطر النماذج، قابلية التدقيق, banking AI, حوكمة الذكاء الاصطناعي, autonomous workflows, model risk, auditability, ISO 20022, DORA, التشفير ما بعد الكمي, AI, open source, البنوك السحابية الأصيلة، Kubernetes، DORA، المؤسسات المالية، OpenShift، Portworx، سيادة السحابة، المرونة التشغيلية، التعافي من الكوارث، التعايش بين الأجهزة الافتراضية والحاويات، أعباء عمل الذكاء الاصطناعي، مخاطر الطرف الثالث، الاعتماد على السحابة, هندسة المنصة, السحابة السيادية"
...
- Federal Reserve, (2011). [SR 11-7: إرشادات إدارة مخاطر النماذج ⧉](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "SR 11-7: إرشادات إدارة مخاطر النماذج").
