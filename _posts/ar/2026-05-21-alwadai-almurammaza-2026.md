...
> - **الضغط التنافسي.** العملات المستقرة كبيرة ومتنامية (يُقدّر BIS قيمتها السوقية بنحو 315 مليار دولار، ونحو 98% منها مقوَّم بالدولار الأمريكي في مطلع أبريل 2026) وهي تفرض جدولاً زمنياً لإصدار رموز الإيداع. تتفوّق العملات المستقرة في الوصول إلى النظام البيئي المفتوح، والسيولة الأصلية للعملات المشفّرة، والتجزئة العالمية؛ بينما تتفوّق الودائع المرمَّزة في الراحة التنظيمية، والتأمين على الودائع، وتدفقات أعمال الخزينة ([BIS](https://www.bis.org/speeches/sp260420.htm "Stablecoins: framing the debate")).
...
يُؤطّر BIS مشروع Project Agorá بوصفه عملاً مع البنوك المركزية والقطاع الخاص لاستكشاف الترميز للمدفوعات عبر الحدود، ويربط الاتجاه الأشمل برؤية السجل الموحَّد ([BIS](https://www.bis.org/speeches/sp260420.htm "Stablecoins: framing the debate")). كذلك يُشير Deutsche Bank إلى Project Agorá وPartior بوصفهما جزءاً من بنية التسوية والبنية التحتية للمدفوعات عبر الحدود من الجيل القادم ([Deutsche Bank flow](https://flow.db.com/publications/flow-white-papers-and-guides/digital-money-a-perspective-on-stablecoins-tokenised-deposits-and-cbdcs "Digital Money")).
...
لا. تُقدّم كلتاهما نقوداً رقمية قابلة للبرمجة على مدار 24/7، غير أنهما تستخدمان هياكل قانونية ومطالبات مختلفة تماماً. فالعملة المستقرة مطالبة على أصل احتياطي خاص بمُصدِر أو على هيكل شركة، وتعمل خارج الميزانية العمومية للبنك المركزي ([BIS](https://www.bis.org/speeches/sp260420.htm "Stablecoins: framing the debate")). أما الوديعة المرمَّزة فهي التزام مباشر على بنك تجاري يرث التنظيم المصرفي القائم، وضوابط مكافحة غسل الأموال والعقوبات، ومحيط التأمين على الودائع ([FDIC](https://www.fdic.gov/board/federal-register-notice-genius-act-requirements-and-standards-fdic-supervised-permitted "FDIC proposed rule")).
...
- BIS، (2026). [العملات المستقرة: تأطير النقاش ⧉](https://www.bis.org/speeches/sp260420.htm "Stablecoins: framing the debate").
