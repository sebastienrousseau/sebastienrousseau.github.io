...
<p class="post-lead-tldr"><strong>TL;DR.</strong> The Express Transaction Credits (EXTC) platform, designed in early 2018, was an Ethereum-based experiment in programmable payment tokens. Built on the ERC-223 token standard, it aimed to eliminate intermediaries in cross-border transfers, enable atomic payments, and make financial services accessible to the unbanked — ideas that decentralised finance later formalised at scale.</p>
<p class="post-lead-heading"><strong>Key takeaways</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>The problem EXTC targeted.</strong> Cross-border bank transfers in 2018 took two to five business days and carried fees of 3–7%. Blockchain tokens offered a technically credible path to sub-second settlement.</li>
  <li><strong>Why ERC-223 rather than ERC-20.</strong> ERC-20 had a known flaw: tokens sent directly to smart contracts were silently lost. ERC-223 added a transfer-and-notify mechanism so the receiving contract could reject or handle the tokens atomically.</li>
  <li><strong>What EXTC was designed to do.</strong> Single atomic payments, time-based standing orders, corporate mass disbursements, and instant micro-loans — all denominated in EXTC tokens and settled on-chain without a clearing house.</li>
  <li><strong>The broader context.</strong> Early-2018 was the peak of the ICO era. EXTC was part of a wave of payment-focused Ethereum projects that tested the limits of what smart contract–based finance could deliver before scalability constraints, regulatory pressure, and market correction reshaped the landscape.</li>
</ul>
<p class="post-lead-related"><strong>Related reading:</strong> <a href="https://sebastienrousseau.com/2018-01-24-the-erc-20-token-standard">ERC-20: The Ethereum Token Interface That Changed the World</a>, <a href="https://sebastienrousseau.com/2018-02-15-the-making-of-the-express-transaction-credits-platform">The Making of the Express Transaction Credits Platform</a>, <a href="https://sebastienrousseau.com/2023-09-29-automating-iso-20022-compliant-payment-file-creation-with-pain001">Automating ISO 20022 Payment Files Creation with Pain001</a>.</p>
</aside>
<!-- lead-end -->
