...
banner_alt: "夜のデータセンターで光り輝くラックスタック — CloudCDN が依って立つ、検査可能・エージェント制御可能・オープンソースのエッジを象徴"
banner_height: "1597"
banner_width: "2584"
...
date: "June 11, 2026"
description: "CloudCDN は CDN を暗号学的に保護されたエージェント制御可能なエッジ・コントロールプレーンへ転換します。ゼロトラスト MCP ゲートウェイ、Durable Objects によるアトミックなレート制限、SLSA Level 3 の来歴、DORA 対応エビデンスを解説します。"
format-detection: "telephone=no"
hreflang: "ja"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/ja/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
image_alt: "Sebastien Rousseau のモノクロ・ポートレート"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastien-rousseau.png"
keywords: "CloudCDN, AIネイティブ・エッジ, オープンソース CDN, MCP サーバー, Cloudflare Workers, Durable Objects, ゼロトラスト, WebAuthn, 署名付きURL, SLSA Level 3, DORA, エッジ・コントロールプレーン"
language: "ja"
...
permalink: "https://sebastienrousseau.com/ja/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "CloudCDN:オープンソース AIネイティブ・エッジ・ブループリント"
short_name: "sebastienrousseau"
subtitle: "グローバル CDN を静的コンテンツのキャッシュから、暗号学的に保護されたエージェント制御可能なエッジ・コントロールプレーンへと移行させます。"
tags: "CloudCDN, オープンソース, CDN, エッジ, AI エージェント, MCP, Cloudflare Workers, Durable Objects, レート制限, ゼロトラスト, WebAuthn, SLSA, DORA, BCBS 239, Basel III, クラウドネイティブ・バンキング"
theme-color: "0, 83, 191"
title: "CloudCDN:2026 年 AIネイティブ・エッジのオープンソース・ブループリント"
url: "https://sebastienrousseau.com/ja/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
...
item_description: "CloudCDN は CDN を暗号学的に保護されたエージェント制御可能なエッジ・コントロールプレーンへ転換します。ゼロトラスト MCP ゲートウェイ、Durable Objects によるアトミックなレート制限、SLSA Level 3 の来歴、DORA 対応エビデンスを解説します。"
...
item_title: "CloudCDN:2026 年 AIネイティブ・エッジのオープンソース・ブループリント"
...
apple-mobile-web-app-title: "CloudCDN AIエッジ"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "CloudCDN は CDN を暗号学的に保護されたエージェント制御可能なエッジ・コントロールプレーンへ転換します。ゼロトラスト MCP ゲートウェイ、Durable Objects によるアトミックなレート制限、SLSA Level 3 の来歴、DORA 対応エビデンスを解説します。"
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Sebastien Rousseau のロゴ"
twitter_site: "@wwdseb"
twitter_title: "CloudCDN:オープンソース AIネイティブ・エッジ・ブループリント"
twitter_url: "https://sebastienrousseau.com/2026-06-11-cloudcdn-open-source-blueprint-ai-native-edge-2026"
excerpt: "CloudCDN は AIネイティブ・エッジのオープンソース・ブループリントです。42 個の MCP ツール、Durable Objects のアトミックなレート制限、WebAuthn パスキー、署名付きURL、SLSA Level 3、3,185 件のテストを備え、DORA と BCBS 239 に対応します。"
...
<p class="post-lead-tldr"><strong>要点。</strong>2026 年のエンタープライズ・テクノロジーは、グローバルに分散したサーバーレス実行とエージェント型 AI の収斂によって定義されます。静的ファイルのキャッシュと基本的なトラフィック・ルーティングのために構築された標準的な CDN は、アクティブでリアルタイムなデータ・オーケストレーションの時代において構造的に時代遅れです。CloudCDN は、エッジをアクティブなコントロールプレーンへと転用するオープンソースのブループリントです。サーバーレス・ランタイム、Cloudflare Durable Objects によるステートフルな協調、そして自律型 AI エージェントが境界づけられ暗号学的に保護された運用エンベロープの内側で Web インフラを操作できるようにする、ゼロトラストの Model Context Protocol(MCP)ゲートウェイで構成されます。</p>
...
sequenceDiagram
    autonumber
    participant Agent as AI エージェント / LLM クライアント
    participant MCP as ゼロトラスト MCP ゲートウェイ
    participant DO as Durable Objects (ステートルーム)
    participant Worker as Cloudflare Workers ランタイム
    participant Edge as エッジ CDN / WAF 状態
    Agent->>MCP: 署名付きペイロードによるツール呼び出し (ルート変更)
    activate MCP
    Note over MCP: WebAuthn パスキーと<br/>暗号署名付き URL を検証
    MCP->>MCP: OPA ルールに対するポリシー照合
    alt ポリシー照合に失敗
        MCP-->>Agent: アクセス拒否 (403 Unauthorized)
    else ポリシー照合に成功
        MCP->>DO: 状態とアクティブなクォータを照会
        activate DO
        Note over DO: アトミックなレート制限を検証し<br/>競合状態を防止
        DO-->>MCP: クォータ確認と減算
        deactivate DO
        MCP->>Worker: 境界づけられた実行をディスパッチ
        activate Worker
        Worker->>Edge: WAF ルール / ルーティングテーブルを更新
        Worker->>Worker: 暗号ログを追記 (SLSA 署名済み)
        Worker-->>Agent: アクション完了 (200 OK + 監査ハッシュ)
        deactivate Worker
    end
    deactivate MCP
```
...
<p class="post-reviewed">最終確認 <time datetime="2026-06-11">2026-06-11</time>。</p>
<!-- enrich-end -->
