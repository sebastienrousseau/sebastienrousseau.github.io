...
<p class="post-lead-tldr"><strong>สรุปโดยย่อ.</strong> HTML Generator คือคอมไพเลอร์ Markdown-to-HTML แบบ pure-Rust ที่บังคับใช้ WCAG 2.1 AA ในขั้นตอน build บรรจุข้อมูล JSON-LD ที่สอดคล้องกับ schema เรนเดอร์ MathML และ Mermaid SVG แบบ native และแยกการประมวลผลภายใน WebAssembly sandbox — เปลี่ยนการเผยแพร่เนื้อหาให้กลายเป็น control plane แบบ compile-gated เพื่อการเข้าถึง SEO และความปลอดภัย ICT</p>
...
graph TD
    %% Ingest & Parse
    subgraph Ingest_AST[การรับข้อมูลและการประมวลผล AST]
        A1[Raw Markdown พร้อม YAML front matter] --> B(HTML Generator compiler core)
    ...
    subgraph Secure_Build_Gates[Secure build gates]
        C --> D{HTML AST parser}
        D -->|ละเมิด WCAG rule: flat headers หรือ missing alt text| E[หยุดคอมไพเลอร์และ fail build]
        D -->|สอดคล้อง WCAG 2.1 AA| F[Rich-content compiler]
    end

    %% Hardening & Output
    subgraph Enrichment[การเสริมข้อมูลและการ compile]
        F -->|คอมไพล์ math เป็น MathML| G[MathML generator]
        F -->|เรนเดอร์ diagrams เป็น SVG| H[Mermaid SVG generator]
        F -->|ดึง metadata| I[JSON-LD schema injector]
        G --> J[เอาต์พุต HTML ที่ minified และผ่านการเสริมความแข็งแกร่ง]
        H --> J
        I --> J
    end
...
<!-- enrich-start -->
<aside class="author-card" aria-label="เกี่ยวกับผู้เขียน"><img alt="ภาพของ Sebastien Rousseau" src="https://cloudcdn.pro/stocks/images/sebastien-rousseau.png" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">นักเทคโนโลยีธนาคารระดับสูงที่เขียนเกี่ยวกับ AI ประยุกต์ โครงสร้างพื้นฐานการชำระเงิน เงินที่แปลงเป็น token, ISO 20022 ความปลอดภัย post-quantum บริการทางการเงิน cloud-native โครงสร้างพื้นฐาน open-source และตลาดดิจิทัลที่อยู่ภายใต้กฎระเบียบ</span><span class="author-credentials">ประสบการณ์กว่า 20 ปีที่ HSBC Commercial &amp; Investment Bank, PayPal, Barclays, Shazam, AKQA, Virgin Group. <a href="/about/index.html">โปรไฟล์เต็ม</a> &middot; <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
<p class="post-reviewed">ตรวจสอบล่าสุด <time datetime="2026-06-20">2026-06-20</time>.</p>
<!-- enrich-end -->
