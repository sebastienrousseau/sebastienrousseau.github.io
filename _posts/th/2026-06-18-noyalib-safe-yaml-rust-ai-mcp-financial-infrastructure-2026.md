...
| **การควบคุมการเข้าถึงของเอเจนต์** | สิทธิ์แบบอ่านอย่างเดียวที่จำกัดขอบเขต สำหรับเครื่องมือ AI ภายในเครื่องที่ทำงานผ่านการกำหนดค่า MCP | การจัดการความเสี่ยงของแบบจำลอง ([SR 11-7](https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm)) | ขอบเขตเซิร์ฟเวอร์ MCP ที่จำกัดการปฏิบัติงานของเอเจนต์ให้อยู่ในไดเรกทอรีที่ได้รับอนุมัติ |
