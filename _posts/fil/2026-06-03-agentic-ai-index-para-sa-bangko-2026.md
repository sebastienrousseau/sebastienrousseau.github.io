...
banner_alt: "Diagram ng The Agentic AI Index for Banks 2026 para sa mga bangko at institusyong pinansyal sa 2026"
banner_height: "571"
banner_width: "1425"
...
copyright: "© Copyright 2025 - 2026 - Sebastien Rousseau. Lahat ng karapatan ay nakalaan."
date: "June 3, 2026"
description: "Isang index-style framework para sa pagsukat ng agentic AI readiness sa mga bangko, sumasaklaw sa autonomy, pamamahala, auditability, pagiging maaasahan, mga kontrol, at halaga sa negosyo."
format-detection: "telephone=no"
hreflang: "fil"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/fil/2026-06-03-agentic-ai-index-banks-autonomy-governance-auditability-2026"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "agentic AI banking 2026, mga AI agent sa bangko, AI governance sa financial services, autonomous banking workflows, model risk management, AI auditability"
language: "fil"
...
permalink: "https://sebastienrousseau.com/fil/2026-06-03-agentic-ai-index-banks-autonomy-governance-auditability-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "Ang Agentic AI Index para sa mga Bangko sa 2026"
short_name: "sebastienrousseau"
subtitle: "Ang agentic AI sa banking ay isang problemang pang-engineering na nagkukunwaring problemang AI. Mapapalitan ang modelo; ang OAuth-scoped service accounts, ang deterministic semantic router, ang Open Policy Agent gates, ang WORM audit log, at ang nasubok na kill switch ay hindi."
excerpt: "Isang engineering blueprint para sa agentic AI sa tier-1 na mga bangko: uriin ayon sa pahintulot hindi sa katalinuhan, ituring ang bawat production agent bilang SR 11-7 / SS1/23 model mula unang araw, at buuin ang limang-bahaging control plane — OAuth-scoped service accounts, deterministic semantic routing, OPA policy gates, immutable WORM audit logs, at nasubok na kill switch — na nagpapalit ng autonomous workflows tungo sa auditable na ebidensya."
tags: "agentic AI, AI sa banking, AI governance, autonomous workflows, model risk, auditability, ISO 20022, DORA, post-quantum cryptography, AI, open source, cloud native banking, platform engineering, sovereign cloud"
theme-color: "0, 83, 191"
title: "Ang Agentic AI Index para sa mga Bangko sa 2026: Pagsukat ng Autonomy, Pamamahala, Auditability, at Epekto sa Negosyo"
url: "https://sebastienrousseau.com/fil/2026-06-03-agentic-ai-index-banks-autonomy-governance-auditability-2026"
...
item_description: "Isang index-style framework para sa pagsukat ng agentic AI readiness sa mga bangko, sumasaklaw sa autonomy, pamamahala, auditability, pagiging maaasahan, mga kontrol, at halaga sa negosyo."
...
item_title: "Ang Agentic AI Index para sa mga Bangko sa 2026: Pagsukat ng Autonomy, Pamamahala, Auditability, at Epekto sa Negosyo"
...
apple-mobile-web-app-title: "Ang Agentic AI Index para sa mga Bangko 2026"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "Isang index-style framework para sa pagsukat ng agentic AI readiness sa mga bangko, sumasaklaw sa autonomy, pamamahala, auditability, pagiging maaasahan, mga kontrol, at halaga sa negosyo."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo ni Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Ang Agentic AI Index para sa mga Bangko 2026"
...
<p class="post-lead-tldr"><strong>TL;DR.</strong> Isang blueprint para sa pagsukat ng agentic AI readiness sa tier-1 na mga bangko sa anim na dimensyon: autonomy tier, API permissioning, deterministic na mga guardrail, saklaw ng human-in-the-loop, kabuuan ng audit, at unit economics. Uriin ang mga ahente ayon sa pinapayagan silang gawin, hindi sa kung gaano katalino ang nasa likod na modelo. Ituring ang bawat production agent bilang SR 11-7 / SS1/23 model mula unang araw.</p>
<p class="post-lead-heading"><strong>Mga pangunahing punto</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Tigilan ang pagtawag sa kanila bilang chatbot.</strong> Ang production unit ay isang bounded workflow na may mahigpit na tool-call na pahintulot. Ang trabaho ay nangyayari sa loob ng workflow, hindi sa loob ng LLM.</li>
  <li><strong>Ang OSWorld sa 66.3% ang reliability ceiling.</strong> Ang pinakamalapit na benchmark ng Stanford HAI sa enterprise tool-use ay nabibigo pa rin sa isa sa tatlong nakaayos na gawain. Posible ang agresibong human-in-the-loop deployment; hindi posible ang walang-bantay na pag-execute laban sa mga customer-funds API.</li>
  <li><strong>Ang Autonomy Ladder ay tumatakbo mula Level 0 hanggang Level 4.</strong> Ang Level 5 — self-orchestration nang walang checkpoint — ay hindi dapat umiral sa production banking sa 2026. Pinipigilan ito ng compound failure rate sa magkakaugnay na tool-call.</li>
  <li><strong>Ang Agent Control Plane ay limang in-engineer na bahagi.</strong> OAuth-scoped service accounts, deterministic semantic routing (NeMo Guardrails o katumbas), Open Policy Agent gating, WORM audit logging, at nasubok na kill switch. Anumang nawawala ay audit finding.</li>
  <li><strong>Saklaw na ng SR 11-7 at PRA SS1/23.</strong> Natalo na ng mga bangkong nangangatwirang hindi modelo ang LLM ang regulatoryong argumento bago pa nila ito sinabi.</li>
</ul>
</aside>
<!-- lead-end -->
...
Ang paglipat mula chat tungo sa bounded workflows ang tanging bagay na mahalaga sa agentic AI para sa mga bangko ngayong taon. Ang chatbot na nagsusulat ng customer email ay maaring repasuhin. Ang ahente na tumatawag ng `POST /accounts/{id}/freeze` laban sa iyong production card platform ay auditable na ebidensya. Naabot na ng produksyon ang konsepto: iniulat ng 2026 survey ng Cambridge CCAF ang 52% aktibong agentic adoption at 23% sa scaling o transforming na yugto ng pagiging mature ([Cambridge CCAF ⧉](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/publications/2026-global-ai-in-financial-services-report/ "2026 Global AI in Financial Services Report")). Ang "isolated pilot" threshold ay nalampasan na noong huling bahagi ng 2025.

May dalawang bagay na nagbago kasabay ng adoption.

Una, tumigil na ang mga regulator sa pagturing sa mga LLM bilang nobela. Nilinaw ng Federal Reserve na ang [SR 11-7 ⧉](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "SR 11-7: Patnubay sa Model Risk Management") ay saklaw ang LLM-based na decisioning kahit hindi internal na klasipikadong modelo ang LLM. Ang [SS1/23 ⧉](https://www.bankofengland.co.uk/prudential-regulation/publication/2023/may/model-risk-management-principles-for-banks-ss "Supervisory Statement SS1/23") ng PRA ay palaging sapat na malawak para sakupin ang mga ito. Sinasaklaw ng high-risk classification ng EU AI Act ang karamihan ng paggamit ng LLM sa financial services. Wala nang argumentong "hindi kami sigurado kung saklaw ito".

Pangalawa, naabutan na ng katotohanan ng benchmark. Iniulat ng 2026 AI Index ng Stanford HAI ang OSWorld — ang pinakamalapit na benchmark sa totoong enterprise tool-use — sa 66.3% katumpakan ([Stanford HAI ⧉](https://hai.stanford.edu/ai-index/2026-ai-index-report/technical-performance "Kabanata ng Technical Performance")). Isa sa tatlong nakaayos na gawain ay nabibigo pa rin. Itinakda ng numerong iyon ang technical ceiling sa autonomy sa 2026. Sapat para bigyang-katwiran ang bounded Level-3 deployments sa ilalim ng HITL oversight; hindi sapat para bigyang-katwiran ang walang-bantay na pag-execute laban sa anumang API na humahawak ng pera ng customer.
...
|---|---|---|
| **52% aktibong pag-adopt** | Ang agentic AI ay lampas na sa pilot stage; matagal nang dapat na ang institution-wide governance | [Cambridge CCAF ⧉](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/publications/2026-global-ai-in-financial-services-report/ "2026 Global AI in Financial Services Report") |
| **23% nasa scaling o transforming** | Isang makabuluhang minorya ang lumampas na sa proof-of-concept theatre | [Cambridge CCAF ⧉](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/publications/2026-global-ai-in-financial-services-report/ "2026 Global AI in Financial Services Report") |
| **OSWorld sa 66.3%** | One-in-three failure rate sa structured tool-use. Hindi suportado ang walang-bantay na pag-execute laban sa customer-funds APIs sa reliability level na ito | [Stanford HAI ⧉](https://hai.stanford.edu/ai-index/2026-ai-index-report/technical-performance "Kabanata ng Technical Performance") |
| **55% nagbabanggit ng pagkawala ng human oversight bilang pangunahing panganib** | Ang disenyo ng kontrol ang pangunahing engineering concern, hindi downstream compliance | [Cambridge CCAF ⧉](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/publications/2026-global-ai-in-financial-services-report/ "2026 Global AI in Financial Services Report") |
| **76% ng malalaking FIs ay nahihirapang sukatin ang halaga** | Hindi nakaliligtas ang generic na claim ng produktibidad sa pag-uusap sa CFO. Sukatin bawat workflow, hindi bawat programa | [Cambridge CCAF ⧉](https://www.jbs.cam.ac.uk/faculty-research/centres/alternative-finance/publications/2026-global-ai-in-financial-services-report/ "2026 Global AI in Financial Services Report") |
...
- **Level 0 — Pagmamasid.** Read-only access sa logs, traces, o transaksyon. Inilalantad ng ahente ang mga pattern o anomalya; walang isinusulat kahit saan. Halimbawa: pagtukoy sa drift sa `pacs.008` rejection rates ayon sa corridor at pag-alerto sa operations team.
- **Level 1 — Read-only retrieval.** Nagbabasa mula sa operational systems; naglalabas ng nakaayos na output para sa pagkain ng tao. Halimbawa: pag-extract ng CSA clause variations mula sa ISDA Master Agreement ng counterparty at pag-flag ng mga paglihis mula sa standard template ng bangko. Hindi kailanman sumusulat ang ahente pabalik sa contract store.
- **Level 2 — Pag-draft para sa pagsumite ng tao.** Bumubuo ng nilalaman na rinerepaso at isinasampa ng tao. Halimbawa: pag-draft ng Suspicious Activity Report mula sa fraud-system alert kasama ng KYC record at transaction trace; binabasa ito ng BSA officer, ine-edit kung kinakailangan, at isinasampa. Ang system of record ay nakakakita lamang ng human-approved na bersyon.
- **Level 3 — Bounded execution.** Tumatawag ng production API na may matibay, deterministic na mga limitasyong ipinatutupad ng wrapper. Halimbawa: card-freeze API call na may `max-amount-at-risk: 5000 USD` na ipinatupad ng allow-list policy; hindi mai-freeze ng ahente ang card na nakaugnay sa balanseng mas mataas sa threshold na iyon nang walang Level-2 na escalation. Ang limitasyon ay nakatira sa policy-as-code, hindi sa prompt — ang mga prompt ay hindi security boundary.
- **Level 4 — Multi-tool orchestration na may mandatoryong checkpoint.** Nagpapatakbo ng pagkakasunud-sunod sa mga sistema; bawat state transition ay nakatala; kailangan ng human approval ang mga checkpoint bago ang susunod na tool-call. Halimbawa: payment-repair workflow — i-extract ang nabigong `pacs.008` mula sa dead-letter queue → tingnan ang tamang beneficiary sa pamamagitan ng SWIFT KYC Registry → bumuo ng naitamang mensahe → isulat sa outbound queue → inaaprubahan ng tao ang re-send. Kung ang anumang hakbang ay nabigo sa schema validator, hihinto ang workflow at lilikha ng exception case.
- **Level 5 — Self-orchestration.** Nagpaplano at nag-e-execute ang ahente nang walang checkpoint approval. **Walang production banking workflow ang dapat nasa Level 5 sa 2026.** Hindi ito pahayag ng pagiging mature; pahayag ito ng pagiging maaasahan. Nag-c-compound ang OSWorld sa 66.3% sa magkakaugnay na API calls. Tatlong tool-calls sa 66% bawat isa ay 29% end-to-end success. Lima ay 13%. Huwag.
...
- **Unang linya (may-ari ng modelo).** Idinodokumento ang nilalayong gamit ng ahente, lineage ng training at eval data, system prompt schema, tool-call allow-list, resulta ng kill-switch test. May-ari ng drift monitoring sa produksyon.
- **Pangalawang linya (MRM team).** Pinag-vavalidate ang ahente bago ang produksyon. Saklaw ng validation report ang vendor-released eval scores (kapaki-pakinabang ngunit hindi sapat ang MMLU, HumanEval, HellaSwag), bank-specific eval scores (sariling held-out evaluation set na binuo mula sa mga operational example — ito ang trabahong kulang sa pamumuhunan ang karamihan sa mga bangko), resulta ng prompt-injection red-team, pagsusuri ng bias at fairness kung saan may epekto sa customer ang workflow, at quantified residual-risk statement.
- **Pangatlong linya (internal audit).** Sinusubok ang mga gates ng control-plane at kabuuan ng audit-log laban sa sample ng mga production decision. Ang 2027 audit cycle ay magiging ibang-iba sa 2025; magtabi ng badyet ngayon.
...
- **Gastos kada nakumpletong desisyon**, kasama ang reversal at repair cost ng mga nabigong desisyon. Ang SAR-drafting agent na nagbawas sa oras ng BSA-officer ng 40% ngunit bumubuo ng 12% false-positive filings ay nagsisira ng halaga, hindi lumilikha.
- **Mga manual touches na naiwasan**, binilang net ng bagong touches na nilikha ng oversight ng control-plane at exception handling. Ang punto ay hindi para mabawasan ang atensyon ng tao; ito ay para iduon ito sa mas mataas na leverage na mga desisyon.
- **Reversal rate** — porsyento ng mga aksyon na isinagawa ng ahente na ibinalik sa loob ng 24 oras. Ang reversal rate na higit sa 2% sa Level-3 workflow ay isang reliability problem. Higit sa 5% ay isang control-plane problem.
- **Audit-trace completeness** — porsyento ng mga desisyon na may buong provenance na muling mabubuo mula sa WORM log. Dapat ay 100% sa Level-3 at Level-4 workflows. Anumang mas mababa ay isang policy failure na lalabas sa audit.
...
- Stanford HAI, (2026). [Ang 2026 AI Index Report ⧉](https://hai.stanford.edu/ai-index/2026-ai-index-report "Ang 2026 AI Index Report").
- Stanford HAI, (2026). [Kabanata ng Technical Performance ⧉](https://hai.stanford.edu/ai-index/2026-ai-index-report/technical-performance "Kabanata ng Technical Performance").
...
- Federal Reserve, (2011). [SR 11-7: Patnubay sa Model Risk Management ⧉](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "SR 11-7: Patnubay sa Model Risk Management").
- Prudential Regulation Authority, (2023). [Supervisory Statement SS1/23: Mga prinsipyo ng model risk management para sa mga bangko ⧉](https://www.bankofengland.co.uk/prudential-regulation/publication/2023/may/model-risk-management-principles-for-banks-ss "SS1/23: Mga prinsipyo ng model risk management para sa mga bangko").
- European Commission, (2024). [Regulation (EU) 2024/1689 — AI Act ⧉](https://eur-lex.europa.eu/eli/reg/2024/1689/oj "Regulation (EU) 2024/1689 — ang EU AI Act").
- NVIDIA, (2024). [NeMo Guardrails framework ⧉](https://github.com/NVIDIA/NeMo-Guardrails "NeMo Guardrails — open-source toolkit para sa pagdaragdag ng programmable guardrails sa LLM-based conversational systems").
- Cloud Native Computing Foundation, (2018). [Open Policy Agent (OPA) ⧉](https://www.openpolicyagent.org/ "Open Policy Agent — policy-based na kontrol para sa cloud native environments").

<!-- enrich-start -->
<aside class="author-card" aria-label="Tungkol sa may-akda"><img alt="Portrait of Sebastien Rousseau" src="https://cloudcdn.pro/stocks/images/sebastienrousseau.webp" width="64" height="64" loading="lazy" decoding="async" /><span class="author-card-body"><strong class="author-card-name"><a href="/about/index.html">Sebastien Rousseau</a></strong><span class="author-card-bio">Senior banking technologist na sumusulat tungkol sa applied AI, payments infrastructure, tokenised money, ISO 20022, post-quantum security, cloud-native financial services, at regulated digital markets.</span><span class="author-credentials">20+ taon sa HSBC Commercial &amp; Investment Bank, PayPal, Barclays, Shazam, AKQA, Virgin Group. <a href="/about/index.html">Buong profile</a> &middot; <a href="https://www.linkedin.com/in/sebastienrousseau/" rel="external noopener">LinkedIn</a> &middot; <a href="https://github.com/sebastienrousseau" rel="external noopener">GitHub</a></span></span></aside>
<p class="post-reviewed">Huling sinuri <time datetime="2026-06-03">2026-06-03</time>.</p>
<!-- enrich-end -->
