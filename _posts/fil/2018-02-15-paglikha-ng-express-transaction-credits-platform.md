...
banner_alt: "Malalaking puting haligi"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Feb 15, 2018"
description: "Teknikal na pagsusuri ng EXTC platform na itinayo sa Ethereum ERC-223 noong 2018: arkitektura ng token, multi-sig disbursements, time-locked transfers, at collateral-backed instant loans."
format-detection: "telephone=no"
hreflang: "fil"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/fil/2018-02-15-the-making-of-the-express-transaction-credits-platform"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "EXTC platform, ERC-223, Ethereum smart contracts, arkitektura ng token, multi-signature, time-locked transfer, blockchain payments, collateral-backed loans, desentralisadong pananalapi, 2018 crypto"
language: "fil"
layout: "report"
locale: "fil_PH"
...
permalink: "https://sebastienrousseau.com/fil/2018-02-15-the-making-of-the-express-transaction-credits-platform"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "Arkitektura ng token, multi-signature disbursements, at time-locked transfers sa Ethereum noong 2018."
tags: "EXTC platform, ERC-223, Ethereum, smart contracts, arkitektura ng token, multi-signature, time-locked transfer, blockchain, decentralised finance, collateral-backed loans, ISO 20022, post-quantum cryptography, AI, stablecoins"
theme-color: "0, 67, 165"
title: "Ang Paglikha ng Express Transaction Credits Platform"
url: "https://sebastienrousseau.com/fil/2018-02-15-the-making-of-the-express-transaction-credits-platform"
...
item_description: "Teknikal na pagsusuri ng EXTC platform sa Ethereum ERC-223 noong 2018: arkitektura ng token, multi-sig disbursements, time-locked transfers, at collateral-backed instant loans."
...
item_title: "Ang Paglikha ng Express Transaction Credits Platform"
...
twitter_description: "Teknikal na pagsusuri ng EXTC platform sa Ethereum ERC-223 noong 2018: arkitektura ng token, multi-sig disbursements, at collateral-backed instant loans."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Ang Paglikha ng EXTC Platform"
...
excerpt: "Isang hands-on na salaysay ng pagbuo ng EXTC platform sa Ethereum ERC-223 noong unang bahagi ng 2018: kung paano nakastruktura ang token contract, ano ang layunin ng multi-signature at time-lock primitives, at kung ano ang natuklasan ng eksperimento tungkol sa mga praktikal na limitasyon ng blockchain para sa mga payment network."
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="Article summary">
<p class="post-lead-tldr"><strong>TL;DR.</strong> Idinetalye ng artikulong ito ang teknikal na pagtatayo ng Express Transaction Credits (EXTC) na plataporma sa unang bahagi ng 2018 — partikular ang arkitektura ng kontrata ng token na itinayo sa ERC-223, ang lohika ng multi-signature na disbursement, mga primitibo ng time-locked na standing order, at ang mekanismo ng instant na pautang na siniguradong may collateral. Ito ay isang talaan ng kinailangan ng disenyo, kung ano ang nalutas ng ERC-223 na hindi nagawa ng ERC-20, at kung saan ang mga on-chain na network ng pagbabayad ay natuklasan ang mga mahirap na limitasyon ng pampublikong Ethereum noong 2018.</p>
<p class="post-lead-heading"><strong>Mga pangunahing aral</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Bakit partikular ang ERC-223.</strong> Ang silent-loss na depekto ng ERC-20 — ang mga token na ipinadala sa mga kontrata nang walang function na <code>tokenFallback</code> ay permanenteng nawasak — ay nagpahiwatig na hindi ito angkop para sa isang plataporma ng pagbabayad sa produksyon. Ginawa ng ERC-223 ang mga paglipat na atomic at nababaligtad sa kabiguan.</li>
  <li><strong>Ang limang primitibo ng kontrata.</strong> Ang kontrata ng Solidity ng EXTC ay nagpatupad ng pagkakakilanlan ng pangalan/simbolo/decimal, nakapirming kabuuang supply, ERC-223 na katugmang balanse at paglipat, multi-signature na pahintulot para sa mga corporate disbursement, at mga time lock batay sa taas ng bloke para sa mga standing order.</li>
  <li><strong>Ang limitasyon ng scaling.</strong> Ang Ethereum mainnet sa Q1 2018 ay nag-average ng 15 transaksyon bawat segundo sa isang bloke gas limit na ~8 milyon. Ang dami ng pagbabayad sa anumang materyal na sukat ay magbubusog sa network.</li>
  <li><strong>Kung ano ang inaasahan ng disenyo.</strong> Ang modelong token na naka-embed ang compliance, atomic na settlement, at mga maprogramang panuntunan ng paglipat sa EXTC ay nauna sa mga desisyon sa disenyo na kalaunan ay pinagtibay sa mga DeFi lending protocol, ERC-1400 security token, at mga CBDC pilot na arkitektura.</li>
</ul>
<p class="post-lead-related"><strong>Kaugnay na pagbabasa:</strong> <a href="https://sebastienrousseau.com/2018-02-04-unveiling-a-new-cryptocurrency-and-offering-future-faster-payment-solution">Unveiling a New Cryptocurrency and Faster Payment Solution</a>, <a href="https://sebastienrousseau.com/2018-01-24-the-erc-20-token-standard">ERC-20: The Ethereum Token Interface That Changed the World</a>, <a href="https://sebastienrousseau.com/2026-05-21-tokenised-deposits-banking-services-status-2026">Tokenised Deposits in 2026</a>.</p>
</aside>
<!-- lead-end -->
...
- **Pinagana ng field na `_data` ang mayamang metadata ng pagbabayad.** Ang bytes payload ay maaaring magdala ng mga sanggunian sa invoice, mga routing code, o mga testimonya ng compliance — impormasyon na hindi maaaring iparating ng simpleng paglipat ng ERC-20.
- **Ang mga gastos ng gas ay bahagyang mas mataas.** Ang pagtawag ng `tokenFallback` ay nagdagdag ng halos 2,000–5,000 gas bawat paglipat, isang maliit na overhead sa mga presyo ng gas noong 2018.
...
1. Isang itinalagang initiator ang nagmungkahi ng paglipat, na tinutukoy ang tatanggap, halaga, at isang nonce.
2. Isang co-signer ang nagkumpirma ng nonce.
3. Pagkatapos lamang na maitatala ang parehong lagda sa on-chain ay isinagawa ang paglipat.
...
1. **Nag-lock ng collateral ang nanghihiram.** Tinawag ng nanghihiram ang `lockCollateral(uint256 _collateralAmount)`, na naglilipat ng mga token ng EXTC sa lending contract escrow sa pamamagitan ng ERC-223 `tokenFallback`.
2. **Pagsusuri ng loan-to-value ratio.** Binasa ng kontrata ang isang pre-configured na LTV ratio (hal. 50%) at kinakalkula ang pinakamataas na halaga ng pautang laban sa naka-lock na collateral.
3. **Atomic na loan disbursement.** Kung natugunan ng collateral ang minimum na threshold, agad na inilipat ng kontrata ang halaga ng pautang sa address ng nanghihiram. Walang underwriting queue, walang credit committee, walang pagkaantala ng settlement.
4. **Pagbabayad at pagpapalaya.** Sa pagbabayad — punong-utang kasama ang isang nakapirming rate ng interes — inilabas ng kontrata ang collateral pabalik sa nanghihiram. Ang kabiguan na bayaran ng `releaseBlock` ay nag-trigger ng awtomatikong liquidasyon: inilipat ng kontrata ang collateral sa itinalagang address ng nagpapautang.
