...
- **Pengurusan risiko model ([US Fed SR 11-7 ⧉](https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "Supervisory Guidance on Model Risk Management") / UK PRA SS1/23).** Model autonomi yang menjalankan tugas operasi termasuk dalam tadbir urus risiko model. Get MCP CloudCDN memperlakukan alat agentik sebagai model kuantitatif: had dasar yang ketat, pengelogan masa nyata, dan penggantian manusia-dalam-gelung yang wajib untuk tindakan berimpak tinggi.
