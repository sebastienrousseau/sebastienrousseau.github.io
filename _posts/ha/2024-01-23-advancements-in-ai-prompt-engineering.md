...
banner_alt: "Wani mutum yana nazarin bayanai a allon kwamfuta"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Jan 23, 2024"
description: "Injiniyan prompt yana sarrafa ɗabi'ar LLM a lokacin inference. Labarin yana rufe zero-shot, few-shot, chain-of-thought, ReAct, self-consistency, haɗarin prompt injection, da ƙirar RAG daga ayyukan kuɗi."
format-detection: "telephone=no"
hreflang: "ha"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/ha/2024-01-23-advancements-in-ai-prompt-engineering"
...
permalink: "https://sebastienrousseau.com/ha/2024-01-23-advancements-in-ai-prompt-engineering"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "Zero-shot, chain-of-thought, ReAct, da tsaron prompt — dabarun da suka fi muhimmanci a 2024"
...
title: "AI Prompt Engineering 2024: Dabarun da Suke Aiki"
url: "https://sebastienrousseau.com/ha/2024-01-23-advancements-in-ai-prompt-engineering"
...
item_description: "Injiniyan prompt yana sarrafa ɗabi'ar LLM a inference time. Labarin yana rufe zero-shot, chain-of-thought, ReAct, da haɗarin prompt injection a ayyukan kuɗi."
...
item_title: "AI Prompt Engineering 2024: Dabarun da Suke Aiki"
...
apple-mobile-web-app-title: "Injiniyan Prompt"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 67, 165"
twitter_card: "summary"
twitter_creator: "@wwdseb"
twitter_description: "Injiniyan prompt yana sarrafa ɗabi'ar LLM a inference time. Rufe zero-shot, chain-of-thought, ReAct, da haɗarin prompt injection daga ayyukan kuɗi."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "AI Prompt Engineering 2024: Dabarun da Suke Aiki"
...
excerpt: "Injiniyan prompt yana tsara shigar LLM a lokacin inference — ba tare da sabunta nauyi ba. Labarin yana rufe dabarun da aka tabbatar suna da inganci a 2024: zero-shot task framing (Brown et al., 2020), chain-of-thought reasoning (Wei et al., 2022), self-consistency sampling (Wang et al., 2022), ReAct agent loops (Yao et al., 2022), haɗarin indirect prompt injection (Greshake et al., 2023), da ƙirar RAG daga ayyukan kuɗi."
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="Article summary">
<p class="post-lead-tldr"><strong>TL;DR.</strong> Prompt engineering yana sarrafa ɗabi'ar LLM a lokacin inference ta hanyar tsarawa rubutun shigarwa — babu sabuntawar nauyi, babu sake horarwa. Dabarun da suka tabbatar da amincewa a 2024 sune: tsarawa aikin zero-shot, tunani chain-of-thought, ɗaukaka specimen self-consistency, da zoben wakili ReAct; babban sabon haɗarin shine indirect prompt injection ta hanyar pipelines na RAG.</p>
<p class="post-lead-heading"><strong>Muhimman darasi</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Zero-shot yana girma tare da girman samfuri.</strong> Brown et al. (2020) sun nuna cewa GPT-3 na iya daidaita baseline ɗin da aka inganta sosai akan benchmark ɗin NLP da yawa ba tare da misalai a cikin mahallin ba — amma ingantaccen aikin zero-shot na buƙatar samfura sama da ~100B parameters don ayyuka masu rikitarwa.</li>
  <li><strong>Chain-of-thought yana buƙatar kalimomi huɗu kawai.</strong> Ƙara "Let's think step by step" (Kojima et al., 2022) ya isa don zero-shot CoT; yana samar da ribar kawai don ayyukan da ke buƙatar ≥2 matakai na tunani da samfura sama da ~100B parameters (Wei et al., 2022).</li>
  <li><strong>Self-consistency yana musaya ƙididdiga don daidaito.</strong> Ɗaukan samfuran CoT 40 masu zaman kansu da kuri'a ta mafi rinjaye ya ɗaga maki benchmark na GSM8K na GPT-3 daga 56% zuwa 74% (Wang et al., 2022).</li>
  <li><strong>Indirect prompt injection shine barazanar zamanin wakili.</strong> Umarnin maƙiyi da aka saka a cikin takardun da aka dawo da su na iya ƙetare ƙuntatawa na system-prompt a cikin pipelines na RAG — nau'in hari wanda aka tabbatar wanda Greshake et al. (2023) suka tsara a hukumance wanda ke shafar turawa na aiyukan kuɗi kai tsaye.</li>
</ul>
<p class="post-lead-related"><strong>Karantawa mai alaƙa:</strong> <a href="https://sebastienrousseau.com/2024-01-01-ai-trends-2024-insights-and-predictions-for-the-future/">AI Trends 2024: Insights and Predictions for the Future</a>, <a href="https://sebastienrousseau.com/2023-12-25-revolutionising-finance-with-ai-enhanced-quantum-algorithms/">Revolutionising Finance with AI-Enhanced Quantum Algorithms</a>, <a href="https://sebastienrousseau.com/2024-02-13-eus-ai-act-shaping-the-future-of-global-ai-regulation/">EU's AI Act: Pioneering Ethical AI Regulation Worldwide</a>.</p>
</aside>
<!-- lead-end -->
...
- **System** — yana saita ɗabi'ar samfuri, sirira, da ƙuntatawa; ba a iya gani ga mai amfani na ƙarshe
- **User** — shigarwar mai amfani na ƙarshe
- **Assistant** — juyawa samfurin da suka gabata (ana amfani da su don kula da mahallin tattaunawa)
