...
banner_alt: "Manyan ginshiƙan fari"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Feb 15, 2018"
description: "Bincike mai zurfi na fasaha game da yadda aka gina dandalin EXTC a kan Ethereum ERC-223 a 2018: ginin token, multi-sig disbursements, time-locked transfers, da lamuni na instant masu goyan bayan collateral."
format-detection: "telephone=no"
hreflang: "ha"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/ha/2018-02-15-the-making-of-the-express-transaction-credits-platform"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "EXTC platform, ERC-223, Ethereum smart contracts, ginin token, multi-signature, time-locked transfer, blockchain payments, collateral-backed loans, kuɗin da ba na tsakiya ba, 2018 crypto"
language: "ha"
layout: "report"
locale: "ha_NG"
...
permalink: "https://sebastienrousseau.com/ha/2018-02-15-the-making-of-the-express-transaction-credits-platform"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "Ginin token, multi-signature disbursements, da time-locked transfers a kan Ethereum a 2018."
tags: "EXTC platform, ERC-223, Ethereum, smart contracts, ginin token, multi-signature, time-locked transfer, blockchain, decentralised finance, collateral-backed loans, ISO 20022, post-quantum cryptography, AI, stablecoins"
theme-color: "0, 67, 165"
title: "Yadda Aka Gina Dandalin Express Transaction Credits"
url: "https://sebastienrousseau.com/ha/2018-02-15-the-making-of-the-express-transaction-credits-platform"
...
item_description: "Bincike mai zurfi na fasaha game da dandalin EXTC a Ethereum ERC-223 a 2018: ginin token, multi-sig disbursements, time-locked transfers, da lamuni masu goyan bayan collateral."
...
item_title: "Ƙirƙirar Express Transaction Credits Platform"
...
twitter_description: "Bincike mai zurfi na fasaha game da dandalin EXTC a Ethereum ERC-223 a 2018: ginin token, multi-sig disbursements, da lamuni masu goyan bayan collateral."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Ƙirƙirar EXTC Platform"
...
excerpt: "Labari na ainihi game da gina dandalin EXTC a Ethereum ERC-223 a farkon 2018: yadda aka tsara token contract, abin da aka ƙera multi-signature da time-lock primitives su yi, da abin da gwajin ya bayyana game da iyakokin aiki na blockchain don hanyoyin biyan kuɗi."
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="Article summary">
<p class="post-lead-tldr"><strong>TL;DR.</strong> Wannan makala ta rubuta ginin fasaha na dandalin Express Transaction Credits (EXTC) a farkon shekara ta 2018 — musamman tsarin kwangilar token da aka gina a kan ERC-223, dabaru na biyan kuɗi da sa hannu da yawa, abubuwan tsufa na tsayi-tsayi, da kuma hanyar bashi na nan take tare da tabbacin kawaici. Shi ne rikodin abin da ƙira ta bukata, abin da ERC-223 ta warware wanda ERC-20 ba ta iya, da kuma inda hanyoyin biyan kuɗi a kan sarkar suka ci karo da ƙayyadaddun taƙaddama na Ethereum na jama'a a shekarar 2018.</p>
<p class="post-lead-heading"><strong>Manyan abubuwan da aka koya</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Me ya sa musamman ERC-223.</strong> Lahani na asarar shiru ta ERC-20 — alamun da aka aika zuwa kwangiloli ba tare da aiki na <code>tokenFallback</code> ba sun halaka har abada — ya sa ta zama ba ta dace da dandalin biyan kuɗi na samarwa ba. ERC-223 ta sanya canjin kuɗi su zama na atomiki kuma za a iya juyawa idan an kasa.</li>
  <li><strong>Abubuwan farko biyar na kwangilar.</strong> Kwangilar Solidity ta EXTC ta aiwatar da asalin suna/alamar/ƙididdigewa, samar da jimlar da aka tsayar, daidaitaccen daidaitaccen ERC-223 na ma'aunin saura da canjin kuɗi, izini da sa hannu da yawa don biyan kuɗin kamfanoni, da kuma kulle lokaci bisa tsayin katako don umarni na tsayawa.</li>
  <li><strong>Iyakar girma.</strong> Ethereum mainnet a Q1 2018 ya yi matsakaicin ma'amaloli 15 a sakan daya a iyakar gas na katako na ~8 miliyan. Yawan biyan kuɗi a kowane ma'auni mai muhimmanci zai cika hanyar sadarwa.</li>
  <li><strong>Abin da ƙira ta yi tsammanin a gaba.</strong> Ƙirar alama mai ɗauke da daidaituwa, sulhuntawa na atomiki, da ƙa'idodin canjin kuɗi masu shirye-shirye a cikin EXTC sun yi hasashen yanke shawara na ƙira da daga baya aka karɓa a cikin yarjejeniyoyin lamuni na DeFi, alamun tsaro na ERC-1400, da tsarin gwajin CBDC.</li>
</ul>
<p class="post-lead-related"><strong>Ƙarin karatu:</strong> <a href="https://sebastienrousseau.com/2018-02-04-unveiling-a-new-cryptocurrency-and-offering-future-faster-payment-solution">Unveiling a New Cryptocurrency and Faster Payment Solution</a>, <a href="https://sebastienrousseau.com/2018-01-24-the-erc-20-token-standard">ERC-20: The Ethereum Token Interface That Changed the World</a>, <a href="https://sebastienrousseau.com/2026-05-21-tokenised-deposits-banking-services-status-2026">Tokenised Deposits in 2026</a>.</p>
</aside>
<!-- lead-end -->
...
>
> - **Matsalar asali.** ERC-20, ma'aunin alama na Ethereum mafi mamaye a cikin 2018, yana da lahanin tsari: alamun da aka kai tsaye zuwa adreshin kwangilar mai hankali an hallaka su a shiru idan kwangilar ta rasa mai kula. Kowane dandalin biyan kuɗi da aka gina a kan ERC-20 ya gaji wannan haɗarin ([Ethereum EIPs](https://eips.ethereum.org/EIPS/eip-20 "EIP-20: Token Standard")).
> - **ERC-223 a matsayin gyara.** ERC-223 ta buƙata cewa kwangilolin masu karɓa su aiwatar da aikin `tokenFallback(address, uint, bytes)`. Idan babu shi, canjin kuɗi ya koma baya ba tare da wani lokaci ba. Babu wata alama da za a rasa a shiru ([Ethereum EIPs GitHub](https://github.com/ethereum/EIPs/issues/223 "ERC-223 Token Standard Proposal")).
> - **Abubuwan farko biyar na kwangilar EXTC.** Asalin alama (suna, alamar, daidaiton ƙididdigewa 18), samar da tsayataccen kuɗi, canjin kuɗi na daidaici da ERC-223, biyan kuɗi na kamfanoni da sa hannu da yawa, da kuma umarni na tsayawa da aka kulle bisa tsayin katako.
...
- **Filin `_data` ya ba da damar bayanai mai arziki na biyan kuɗi.** Nauyin bytes na iya ɗauke da nassoshi na lissafin, lambobin hanyar, ko tabbacin daidaituwa — bayanai da sauƙaƙen canjin kuɗi na ERC-20 ba zai iya isar da su ba.
- **Farashi na gas ya yi kaɗan mafi girma.** Kiran `tokenFallback` ya ƙara kusan 2,000–5,000 gas a kowane canjin kuɗi, ƙaramin ƙari a farashi na gas na 2018.
...
1. Wani mai fara da aka zaba ya gabatar da canjin kuɗi, yana bayyana mai karɓa, adadi, da nonce.
2. Wani mai sa hannu tare ya tabbatar da nonce.
3. Bayan an rubuta sa hannun biyu a kan sarkar ne kawai canjin kuɗi ya aiwata.
...
1. **Mai aro ya kulle kawaici.** Mai aro ya kira `lockCollateral(uint256 _collateralAmount)`, yana canja alamun EXTC zuwa escrow na kwangilar lamuni ta ERC-223 `tokenFallback`.
2. **Duba rabo na lamuni zuwa ƙima.** Kwangilar ta karanta wani LTV ratio da aka tsara tun da farko (misali 50%) kuma ta lissafta adadin bashi mafi girma a kan kawaicin da aka kulle.
3. **Rarraba bashi na atomiki.** Idan kawaici ya cika ƙarancin iyaka, kwangilar ta nan da nan ta canja adadin bashi zuwa adreshin mai aro. Babu jerin ba da tabbaci, babu kwamitin bashi, babu jinkirin sulhuntawa.
4. **Biyan bashi da sakin.** A biyan bashi — babban kuɗi da kari da adadin riba da aka tsayar — kwangilar ta sake kawaici zuwa mai aro. Gazawar biyan bashi kafin `releaseBlock` ta kunna rugujewar atomatik: kwangilar ta canja kawaici zuwa adreshin da mai ba da bashi ya zaba.
