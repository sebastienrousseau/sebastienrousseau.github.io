...
|---|---|---|
| **65% of payment messages contain unstructured addresses** | The remediation challenge is still large | [SWIFT ⧉](https://www.swift.com/news-events/news/iso-20022-milestone-november-2026-unstructured-addresses-be-removed "ISO 20022 November 2026 structured address milestone") |
| **Unstructured addresses removed after November 2026** | Payment-data readiness becomes urgent | [SWIFT ⧉](https://www.swift.com/news-events/news/iso-20022-milestone-november-2026-unstructured-addresses-be-removed "ISO 20022 November 2026 structured address milestone") |
| **Project Agorá prototype phase** | Tokenised settlement is being tested in a central-bank and commercial-bank setting | [BIS ⧉](https://www.bis.org/about/bisih/topics/fmis/agora.htm "Project Agorá") |
| **FSB implementation phase** | Cross-border payment enhancement remains a global policy priority | [FSB ⧉](https://www.fsb.org/2026/03/fsb-kicks-off-new-implementation-phase-to-enhance-cross-border-payments-through-public-private-partnership/ "Cross-border payments implementation phase") |
| **Deutsche Bank digital money framework** | Stablecoins, tokenised deposits, and CBDCs are becoming a practical corporate-bank architecture topic | [Deutsche Bank ⧉](https://flow.db.com/publications/flow-white-papers-and-guides/digital-money-a-perspective-on-stablecoins-tokenised-deposits-and-cbdcs "Digital Money: stablecoins, tokenised deposits and CBDCs") |
