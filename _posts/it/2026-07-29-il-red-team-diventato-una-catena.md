...
banner_alt: "L'angolo di un edificio rivestito da uno schermo bianco finemente perforato, fotografato dal basso contro un cielo luminoso."
banner_height: "1597"
banner_width: "2584"
...
date: "July 29, 2026"
description: "Il regime TLPT di DORA trasforma il red teaming in un obbligo vigilato. I vincoli reali sono il mercato dei fornitori, la cadenza e le terze parti."
format-detection: "telephone=no"
hreflang: "it"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/it/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
image_alt: "Ritratto in bianco e nero di Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "threat-led penetration testing, TLPT, test di penetrazione guidati dalla minaccia, DORA Article 26, DORA Article 27, Commission Delegated Regulation 2025/1190, TIBER-EU, red teaming, threat intelligence, intelligence sulle minacce, purple teaming, rischio terze parti ICT, resilienza operativa, entità finanziarie, autorità competente, wholesale banking, detection engineering"
language: "it"
...
permalink: "https://sebastienrousseau.com/it/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "DORA TLPT: il red team come catena di fornitura vigilata"
short_name: "sebastienrousseau"
subtitle: "Una lettura operativa per CISO bancari e responsabili di resilienza: le norme tecniche di regolamentazione dell'Articolo 26 di DORA hanno reso la simulazione dell'avversario un obbligo vigilato che produce evidenze, e i vincoli che stringono non sono tecnici ma il mercato dei fornitori di test accreditati, una cadenza triennale e le terze parti su cui girano le vostre funzioni critiche."
tags: "DORA, threat-led penetration testing, TLPT, TIBER-EU, red teaming, resilienza operativa, rischio terze parti, architettura di sicurezza, banche, conformità normativa, detection engineering"
theme-color: "0, 83, 191"
title: "Il red team è diventato una catena di fornitura vigilata: cosa impone davvero il regime TLPT di DORA"
url: "https://sebastienrousseau.com/it/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
...
item_description: "Il regime TLPT di DORA trasforma il red teaming in un obbligo vigilato. I vincoli reali sono il mercato dei fornitori, la cadenza e le terze parti."
...
item_title: "Il red team è diventato una catena di fornitura vigilata: cosa impone davvero il regime TLPT di DORA"
...
twitter_description: "Il regime TLPT di DORA trasforma il red teaming in un obbligo vigilato su cadenza triennale. I vincoli reali sono il mercato dei fornitori di test accreditati, l'intelligence sulle minacce esterna e le terze parti."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo di Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "DORA TLPT: il red team come catena di fornitura vigilata"
twitter_url: "https://sebastienrousseau.com/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
excerpt: "Quasi tutte le banche hanno messo a budget il test. Poche hanno messo a budget la catena di fornitura da cui ora dipende: un mercato di fornitori di test accreditati su un orologio triennale sincronizzato e intelligence sulle minacce che deve arrivare dall'esterno ogni singola volta."
...
# Il red team è diventato una catena di fornitura vigilata: cosa impone davvero il regime TLPT di DORA
...
<p class="post-lead-tldr"><strong>TL;DR.</strong> Il regime TLPT di DORA converte il red teaming da esercizio di sicurezza discrezionale a obbligo vigilato che produce evidenze, su cadenza triennale, per le entità designate da un'autorità competente. I vincoli che stringono non sono tecnici. Stanno dal lato dell'offerta: l'Articolo 27 richiede fornitori di test accreditati o vincolati a un codice di condotta, dotati di assurance indipendente e di assicurazione di responsabilità civile professionale, ammette i red team interni al massimo per due cicli su tre e impone che il fornitore di intelligence sulle minacce sia esterno ogni singola volta. Le funzioni critiche che girano su fornitori terzi trascinano quei fornitori dentro il test.</p>
<p class="post-lead-heading"><strong>Punti chiave</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>Designazione, non autovalutazione.</strong> Sono le autorità competenti a individuare quali entità devono eseguire il TLPT, in base a rilevanza sistemica, dimensione e profilo di rischio ICT. Le microimprese restano fuori. Non ci si iscrive e non ci si sfila in silenzio.</li>
  <li><strong>Il mercato dell'offerta è il vincolo.</strong> L'Articolo 27 fissa requisiti di accreditamento o di adesione formale a codici di condotta, una relazione di assurance indipendente e una copertura di responsabilità civile professionale che includa dolo e negligenza. È un bacino ristretto, e ogni entità designata dell'Unione corre sullo stesso orologio triennale.</li>
  <li><strong>I red team interni non possono reggere il programma.</strong> Sono ammessi per un massimo di due test su tre, previa approvazione dell'autorità di vigilanza e controllo dei conflitti di interesse, e l'intelligence sulle minacce deve comunque arrivare dall'esterno dell'istituzione.</li>
  <li><strong>Le vostre funzioni critiche esternalizzate rientrano nel perimetro.</strong> Quando una funzione critica o importante dipende da un fornitore terzo di servizi ICT, quel fornitore può essere trascinato dentro il test. Il contratto deve consentirlo prima della conversazione sul perimetro, non dopo.</li>
</ul>
<p class="post-lead-related"><strong>Letture correlate:</strong> <a href="https://sebastienrousseau.com/2026-06-08-banking-resilience-index-ai-cloud-quantum-payments-third-party-risk-2026">L'indice di resilienza bancaria nel 2026</a>, <a href="https://sebastienrousseau.com/2026-05-28-dora-ai-act-data-sovereignty-banking-compliance-stack-2026">DORA, l'AI Act europeo e la sovranità dei dati</a>.</p>
</aside>
<!-- lead-end -->
...
1. **Il contratto lo consente?** Le clausole di right-to-test scritte per una valutazione convenzionale spesso non contemplano un red team guidato dall'intelligence che opera contro la produzione senza che il personale operativo del fornitore sia stato avvisato.
2. **Chi porta il rischio se il test causa un incidente?** Fra banca, fornitore di test e fornitore terzo, la questione va risolta per iscritto prima della definizione del perimetro, non negoziata sotto pressione una volta prenotata la finestra di test.
3. **Il fornitore può servire tutti nello stesso momento?** Un fornitore concentrato che serve molte entità designate affronta la stessa domanda sincronizzata del mercato dei fornitori di test, e non ha alcun obbligo di darvi priorità.
...
1. **Stabilite se vi aspettate la designazione, e pianificate come se fosse certa.** Il tempo di approvvigionamento è abbastanza lungo da rendere costosa l'attesa della notifica formale.
2. **Mettete l'approvvigionamento dei fornitori di test su un piano triennale, non su un calendario di progetto.** Qualificate un panel rispetto alle condizioni dell'Articolo 27 — accreditamento o adesione a un codice, relazione di assurance, copertura assicurativa — ben prima che serva una finestra.
3. **Contrattualizzate l'intelligence sulle minacce esterna come accordo permanente.** È richiesta in ogni ciclo a prescindere da chi esegue il test, quindi non è un costo variabile.
4. **Sistemate le clausole con le terze parti in questo trimestre.** Diritto di test, obblighi di partecipazione, allocazione del rischio di incidente. È l'elemento con il tempo di attraversamento più lungo fra quelli elencati qui, e non è un compito di ingegneria.
5. **Alzate la fedeltà della telemetria di rilevamento prima del primo esercizio.** Il dossier di evidenze vale quanto ciò che è stato registrato mentre il red team operava.
6. **Riportate i tempi, non il verdetto.** Tempo per rilevare, attribuire e contenere, tracciato lungo i cicli, è la metrica che mostra a un supervisore una capacità invece di un adempimento.
...
* European Commission, 2025\. *Commission Delegated Regulation (EU) 2025/1190 supplementing Regulation (EU) 2022/2554 with regard to regulatory technical standards on threat-led penetration testing*. Bruxelles: Gazzetta ufficiale dell'Unione europea. Disponibile su: [European Commission, 2025\.](https://eur-lex.europa.eu/eli/reg_del/2025/1190/oj "European Commission, 2025.").  
* European Central Bank, 2026\. *TIBER-EU: European framework for threat intelligence-based ethical red-teaming*. Francoforte sul Meno: European Central Bank. Disponibile su: [European Central Bank, 2026\.](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "European Central Bank, 2026.").
