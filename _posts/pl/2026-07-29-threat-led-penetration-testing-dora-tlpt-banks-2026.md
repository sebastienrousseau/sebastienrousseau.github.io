...
banner_alt: "Narożnik budynku pokrytego drobno perforowanym białym ekranem, sfotografowany od dołu na tle jasnego nieba."
banner_height: "1597"
banner_width: "2584"
...
date: "July 29, 2026"
description: "Reżim TLPT w DORA zamienia red teaming w nadzorowany obowiązek. Wiążące ograniczenia to rynek dostawców testów, kadencja testów i wasze strony trzecie."
format-detection: "telephone=no"
hreflang: "pl"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/pl/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
image_alt: "Czarno-biały portret Sebastiena Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "testy penetracyjne oparte na analizie zagrożeń, threat-led penetration testing, TLPT, DORA Article 26, DORA Article 27, rozporządzenie delegowane 2025/1190, TIBER-EU, red teaming, zespół czerwony, analiza zagrożeń, threat intelligence, purple teaming, ryzyko ICT stron trzecich, odporność operacyjna, podmioty finansowe, właściwy organ, bankowość korporacyjna, inżynieria detekcji"
language: "pl"
...
permalink: "https://sebastienrousseau.com/pl/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "DORA TLPT: zespół czerwony jako nadzorowany łańcuch dostaw"
short_name: "sebastienrousseau"
subtitle: "Odczyt operacyjny dla bankowych CISO i szefów odporności: regulacyjne standardy techniczne do Article 26 DORA zamieniły symulację działań przeciwnika w nadzorowany obowiązek wytwarzający dowody, a ograniczenia, które naprawdę wiążą, nie są techniczne — to rynek akredytowanych dostawców testów, trzyletnia kadencja i strony trzecie, na których działają wasze funkcje krytyczne."
tags: "DORA, testy penetracyjne oparte na analizie zagrożeń, TLPT, TIBER-EU, red teaming, zespół czerwony, odporność operacyjna, ryzyko stron trzecich, architektura bezpieczeństwa, bankowość, zgodność regulacyjna, inżynieria detekcji"
theme-color: "0, 83, 191"
title: "Zespół czerwony pod nadzorem: czego naprawdę wymaga TLPT w DORA"
...
item_description: "Reżim TLPT w DORA zamienia red teaming w nadzorowany obowiązek. Wiążące ograniczenia to rynek dostawców testów, kadencja testów i wasze strony trzecie."
...
item_title: "Zespół czerwony pod nadzorem: czego naprawdę wymaga TLPT w DORA"
...
twitter_description: "Reżim TLPT w DORA zamienia red teaming w nadzorowany obowiązek w cyklu trzyletnim. Ograniczają go rynek akredytowanych dostawców, zewnętrzna analiza zagrożeń i strony trzecie."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo Sebastiena Rousseau"
twitter_site: "@wwdseb"
twitter_title: "DORA TLPT: zespół czerwony jako nadzorowany łańcuch dostaw"
twitter_url: "https://sebastienrousseau.com/2026-07-29-threat-led-penetration-testing-dora-tlpt-banks-2026"
excerpt: "Większość banków wyceniła sam test. Mniej z nich wyceniło łańcuch dostaw, od którego test teraz zależy: rynek akredytowanych dostawców testów na zsynchronizowanym trzyletnim zegarze oraz analizę zagrożeń, która za każdym razem musi pochodzić z zewnątrz."
...
<ul class="post-lead-takeaways">
  <li><strong>Wskazanie, nie samoocena.</strong> Właściwe organy wskazują, które podmioty muszą przeprowadzać TLPT, kierując się znaczeniem systemowym, wielkością i profilem ryzyka ICT. Mikroprzedsiębiorstwa są poza reżimem. Nie zgłaszacie się sami i nie wypiszecie się po cichu.</li>
  <li><strong>Ograniczeniem jest rynek dostawców.</strong> Article 27 ustanawia wymóg akredytacji lub formalnego kodeksu postępowania, niezależnego raportu poświadczającego oraz ubezpieczenia odpowiedzialności cywilnej zawodowej obejmującego także nadużycia i zaniedbania. To wąska pula, a każdy wskazany podmiot w Unii działa na tym samym trzyletnim zegarze.</li>
  <li><strong>Wewnętrzne zespoły czerwone nie udźwigną programu.</strong> Są dopuszczone w maksymalnie dwóch z trzech testów, pod warunkiem zgody nadzoru i kontroli konfliktu interesów — a analiza zagrożeń i tak musi pochodzić spoza instytucji.</li>
  <li><strong>Wasze outsourcowane funkcje krytyczne są w zakresie testu.</strong> Gdy funkcja krytyczna lub istotna zależy od zewnętrznego dostawcy ICT, tego dostawcę można wciągnąć do testu. Umowa musi na to pozwalać przed rozmową o zakresie, a nie po niej.</li>
</ul>
<p class="post-lead-related"><strong>Powiązane lektury:</strong> <a href="https://sebastienrousseau.com/2026-06-08-banking-resilience-index-ai-cloud-quantum-payments-third-party-risk-2026">Indeks odporności bankowej w 2026 roku</a>, <a href="https://sebastienrousseau.com/2026-05-28-dora-ai-act-data-sovereignty-banking-compliance-stack-2026">DORA, unijny AI Act i suwerenność danych</a>.</p>
</aside>
<!-- lead-end -->
...
1. **Czy umowa na to pozwala?** Klauzule prawa do testu pisane pod konwencjonalną ocenę często nie przewidują zespołu czerwonego działającego na podstawie analizy zagrożeń przeciwko produkcji, bez uprzedzenia personelu operacyjnego dostawcy.
2. **Kto ponosi ryzyko, jeśli test wywoła incydent?** Między bankiem, dostawcą testów i dostawcą usług trzeba to rozstrzygnąć na piśmie przed ustaleniem zakresu, a nie negocjować pod presją czasu, gdy okno testowe jest już zarezerwowane.
3. **Czy dostawca obsłuży wszystkich naraz?** Skoncentrowany dostawca obsługujący wiele wskazanych podmiotów mierzy się z tym samym zsynchronizowanym popytem co rynek dostawców testów — i nie ma obowiązku traktować was priorytetowo.
...
1. **Ustalcie, czy spodziewacie się wskazania, i planujcie tak, jakby już nastąpiło.** Czas realizacji zakupów jest na tyle długi, że czekanie na formalne powiadomienie to opcja kosztowna.
2. **Wpiszcie zakup usług dostawcy testów w plan trzyletni, nie w harmonogram projektu.** Zakwalifikujcie panel dostawców wobec warunków Article 27 — akredytacja lub stosowanie kodeksu, raport poświadczający, ubezpieczenie odpowiedzialności — na długo przed tym, zanim okno testowe będzie potrzebne.
3. **Zakontraktujcie zewnętrzną analizę zagrożeń jako umowę stałą.** Jest wymagana w każdym cyklu niezależnie od tego, kto wykonuje test, więc nie jest kosztem zmiennym.
4. **Naprawcie klauzule dla stron trzecich w tym kwartale.** Prawo do testu, obowiązki udziału, alokacja ryzyka incydentu. To ma najdłuższy czas realizacji ze wszystkiego tutaj i nie jest zadaniem inżynierskim.
5. **Podnieście rozdzielczość telemetrii detekcji przed pierwszym ćwiczeniem.** Pakiet dowodowy jest wart tyle, ile zarejestrowano w czasie, gdy zespół czerwony działał.
6. **Raportujcie czasy, nie werdykt.** Czas do detekcji, atrybucji i zamknięcia incydentu, śledzony w kolejnych cyklach, to metryka, która pokazuje nadzorcy zdolność, a nie zdarzenie zgodnościowe.
...
* European Parliament and Council of the European Union, 2022\. *Regulation (EU) 2022/2554 on digital operational resilience for the financial sector (DORA)*. Bruksela: Dziennik Urzędowy Unii Europejskiej. Dostępne pod adresem: [European Parliament and Council of the European Union, 2022\.](https://eur-lex.europa.eu/eli/reg/2022/2554/oj "European Parliament and Council of the European Union, 2022.").  
* European Commission, 2025\. *Commission Delegated Regulation (EU) 2025/1190 supplementing Regulation (EU) 2022/2554 with regard to regulatory technical standards on threat-led penetration testing*. Bruksela: Dziennik Urzędowy Unii Europejskiej. Dostępne pod adresem: [European Commission, 2025\.](https://eur-lex.europa.eu/eli/reg_del/2025/1190/oj "European Commission, 2025.").  
* European Central Bank, 2026\. *TIBER-EU: European framework for threat intelligence-based ethical red-teaming*. Frankfurt nad Menem: Europejski Bank Centralny. Dostępne pod adresem: [European Central Bank, 2026\.](https://www.ecb.europa.eu/paym/cyber-resilience/tiber-eu/html/index.en.html "European Central Bank, 2026.").
