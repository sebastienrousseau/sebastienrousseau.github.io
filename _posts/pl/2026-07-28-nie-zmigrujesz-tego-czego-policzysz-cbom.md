...
banner_alt: "Oddalający się rząd lamp wiszących wzdłuż ciemnej ściany okiennej: najbliższa ostra i zapalona, każda kolejna coraz głębiej w cieniu."
banner_height: "1597"
banner_width: "2584"
...
date: "July 28, 2026"
description: "Termin rozpoznania NCSC na 2028 r. wypada przed każdym terminem migracji. Banki go nie dotrzymają, bo rejestr aktywów DORA nie zapisuje kryptografii."
format-detection: "telephone=no"
hreflang: "pl"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/pl/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
image_alt: "Czarno-biały portret Sebastiena Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "cryptographic bill of materials, CBOM, CycloneDX, ECMA-424, inwentaryzacja kryptograficzna, zwinność kryptograficzna, crypto-agility, migracja postkwantowa, harmonogram migracji NCSC, NIST IR 8547, FIPS 203, ML-KEM, DORA artykuł 8, rejestr aktywów ICT, SBOM, cykl życia certyfikatu, HSM, zarządzanie kluczami, bankowość korporacyjna"
language: "pl"
...
permalink: "https://sebastienrousseau.com/pl/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
rating: "general"
referrer: "no-referrer"
robots: "index, follow"
schema: "FAQPage, Article"
seo_title: "CBOM, którego banki nie mają: rozpoznanie kryptografii do 2028"
short_name: "sebastienrousseau"
subtitle: "Inżynierska lektura dla CTO banków i szefów architektury bezpieczeństwa: pierwszy termin postkwantowy nie jest terminem migracji, lecz terminem rozpoznania, a rejestr aktywów ICT, do którego prowadzenia DORA już Państwa zobowiązuje, zapisuje o aktywie wszystko poza kryptografią, która w nim pracuje."
tags: "postkwantowe, kryptografia, CBOM, CycloneDX, DORA, zwinność kryptograficzna, architektura bezpieczeństwa, bankowość, SBOM, NIST, NCSC, zgodność regulacyjna"
theme-color: "0, 83, 191"
title: "Nie zmigrujesz tego, czego nie policzysz: CBOM, którego banki nie mają"
...
item_description: "Termin rozpoznania NCSC na 2028 r. wypada przed każdym terminem migracji. Banki go nie dotrzymają, bo rejestr aktywów DORA nie zapisuje kryptografii."
...
item_title: "Nie zmigrujesz tego, czego nie policzysz: CBOM, którego banki nie mają"
...
apple-mobile-web-app-title: "Kryptograficzny BOM"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 83, 191"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "Pierwszy termin postkwantowy dotyczy rozpoznania, nie migracji. Rejestr aktywów ICT wymagany przez DORA zapisuje wszystko poza kryptografią."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo Sebastiena Rousseau"
twitter_site: "@wwdseb"
twitter_title: "CBOM, którego banki nie mają: rozpoznanie kryptografii do 2028"
twitter_url: "https://sebastienrousseau.com/2026-07-28-cryptographic-bill-of-materials-cbom-discovery-banks-2026"
excerpt: "Każdy plan postkwantowy zakłada inwentaryzację, która nie istnieje. Rejestr aktywów zna serwer i krytyczność; nie zna algorytmu, długości klucza ani biblioteki."
...
<ul class="post-lead-takeaways">
  <li><strong>Rozpoznanie jest ograniczeniem wiążącym.</strong> Wytyczne NCSC stawiają pełny obraz zależności kryptograficznych na 2028 rok, migrację najwyższego priorytetu na 2031, a zakończenie na 2035. NIST IR 8547 wycofuje RSA i ECC po 2030 roku, a po 2035 zakazuje ich stosowania. Pas startowy inżynierii jest krótszy, niż sugeruje nagłówkowa data.</li>
  <li><strong>Państwa rejestr DORA ma zły kształt.</strong> Artykuł 8 nakłada obowiązek identyfikacji, klasyfikacji i mapowania zależności aktywów ICT. Nic z tego nie wymaga zapisania ani jednego algorytmu, długości klucza czy zestawu szyfrów. Dwa rejestry, jedna luka.</li>
  <li><strong>CBOM to model danych, nie narzędzie.</strong> Obsługę aktywów kryptograficznych wniesiono do CycloneDX i ratyfikowano jako ECMA-424, więc CBOM jest dokumentem BOM, który płynie przez narzędzia SBOM już działające w banku.</li>
  <li><strong>Rozpoznanie to cztery problemy, nie jeden.</strong> Kod źródłowy, binaria i kontenery, negocjacja sieciowa na żywo oraz majątek dostawców i sprzętu. Trzy pierwsze da się skanować. Czwarty jest problemem atestacji kontraktowej i to w nim skupia się realna ekspozycja bankowości korporacyjnej.</li>
</ul>
<p class="post-lead-related"><strong>Powiązane lektury:</strong> <a href="https://sebastienrousseau.com/2026-06-29-post-quantum-security-scorecard-board-level-fiduciary-agility-2026">Karta wyników bezpieczeństwa postkwantowego 2026</a>, <a href="https://sebastienrousseau.com/2026-06-12-kyberlib-post-quantum-banking-migration-standards-code-2026">KyberLib i postkwantowa migracja bankowości</a>.</p>
</aside>
<!-- lead-end -->
...
1. **Przeformułować kamień milowy 2028 jako zdolność, nie raport.** Produktem jest utrzymywana, czytelna maszynowo inwentaryzacja, która sama się odtwarza, a nie dokument wytworzony raz dla nadzoru.
2. **Emitować CBOM z procesu budowania już teraz, najpierw dla nowych usług.** Proszę nie próbować objąć całego majątku jednym przebiegiem. Wpiąć to w potok dla wszystkiego, co jest budowane lub istotnie zmieniane w tym roku, żeby pokrycie narastało, zamiast wymagać kampanii.
3. **Wpisać klauzulę umowną do wzorca przedłużenia w tym kwartale.** Ujawnianie kryptografii i zobowiązanie do zwinności kryptograficznej. To ma najdłuższy czas realizacji ze wszystkiego na tej liście i nie zależy od żadnej decyzji narzędziowej.
4. **Uruchomić obserwację sieci najpierw na ścieżkach płatniczych i rozrachunkowych.** Tam luka między konfiguracją a rzeczywistością szkodzi najbardziej i tam koncentrują się starzy kontrahenci.
5. **Połączyć CBOM z rejestrem z artykułu 8 i uszeregować po złączeniu.** Opublikować uszeregowaną listę. To artefakt, który zamienia inwentaryzację inżynierską w rozmowę zarządu o kolejności i pieniądzach.
6. **Porównywać różnicowo każde odtworzenie i alarmować na nowych zależnościach podatnych na ataki kwantowe.** Inwentaryzacja bez porównania różnicowego to archiwum.
...
* European Parliament and Council of the European Union, 2022\. *Regulation (EU) 2022/2554 on digital operational resilience for the financial sector (DORA)*. Brussels: Official Journal of the European Union. Dostępne pod adresem: [European Parliament and Council of the European Union, 2022\.](https://eur-lex.europa.eu/eli/reg/2022/2554/oj "European Parliament and Council of the European Union, 2022.").  
* National Cyber Security Centre, 2025\. *Timelines for migration to post-quantum cryptography*. London: NCSC. Dostępne pod adresem: [National Cyber Security Centre, 2025\.](https://www.ncsc.gov.uk/guidance/pqc-migration-timelines "National Cyber Security Centre, 2025.").  
* National Institute of Standards and Technology, 2024\. *NIST IR 8547 (Initial Public Draft), Transition to Post-Quantum Cryptography Standards*. Gaithersburg: U.S. Department of Commerce. Dostępne pod adresem: [National Institute of Standards and Technology, 2024\.](https://csrc.nist.gov/pubs/ir/8547/ipd "National Institute of Standards and Technology, 2024.").  
* National Institute of Standards and Technology, 2024\. *FIPS 203, Module-Lattice-Based Key-Encapsulation Mechanism Standard*. Gaithersburg: U.S. Department of Commerce. Dostępne pod adresem: [National Institute of Standards and Technology, 2024\.](https://csrc.nist.gov/pubs/fips/203/final "National Institute of Standards and Technology, 2024.").  
* OWASP Foundation, 2026\. *CycloneDX Bill of Materials Specification (ECMA-424)*. Wakefield: OWASP Foundation. Dostępne pod adresem: [OWASP Foundation, 2026\.](https://owasp.org/www-project-cyclonedx/ "OWASP Foundation, 2026.").  
* OWASP CycloneDX, 2026\. *Cryptography Bill of Materials (CBOM)*. Wakefield: OWASP Foundation. Dostępne pod adresem: [OWASP CycloneDX, 2026\.](https://cyclonedx.org/capabilities/cbom/ "OWASP CycloneDX, 2026.").  
* IBM Research, 2026\. *CBOM: Cryptography Bill of Materials*. Armonk: IBM. Dostępne pod adresem: [IBM Research, 2026\.](https://github.com/IBM/CBOM "IBM Research, 2026.").
