...
banner_alt: "ויזואליזציה אבסטרקטית של רשת נוירונים בגוני כחול וסגול המייצגת עיבוד AI"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Nov 12, 2023"
description: "כיצד עובדים מודלי transformer, אילו מודלים ב-2023 קבעו את הבנצ'מרק, היכן generative AI נוחת ראשון בשירותים פיננסיים, ואילו שאלות ממשל נדרשות לפני פריסה."
format-detection: "telephone=no"
hreflang: "he"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/he/2023-11-12-exploring-generative-ai"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "161"
image_width: "161"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "generative AI, large language model, transformer architecture, GPT-4, AI בשירותים פיננסיים, hallucination, retrieval-augmented generation, AI governance, foundation model, fine-tuning"
language: "he"
layout: "report"
locale: "he_IL"
...
permalink: "https://sebastienrousseau.com/he/2023-11-12-exploring-generative-ai"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "מכניקת transformer, בנצ'מרקים של מודלים ב-2023, מקרי שימוש בשירותים פיננסיים, ושאלות הממשל שלא ניתן לדחות."
tags: "generative AI, LLM, GPT-4, transformer, שירותים פיננסיים, hallucination, RAG, ממשל AI, foundation model, fine-tuning, ISO 20022, DORA, קריפטוגרפיה פוסט-קוונטית, מחשוב קוונטי, AI"
theme-color: "0, 67, 165"
title: "Generative AI ב-2023: כיצד עובד, היכן נוחת"
...
item_description: "כיצד עובדים מודלי transformer, בנצ'מרקים ב-2023, היכן generative AI נוחת בשירותים פיננסיים, ושאלות הממשל הנדרשות."
...
item_title: "Generative AI ב-2023: כיצד עובד, היכן נוחת"
...
twitter_description: "מכניקת transformer, בנצ'מרקים של מודלים ב-2023, מקרי שימוש בשירותים פיננסיים, ושאלות הממשל שלא ניתן לדחות."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "Generative AI 2023: כיצד עובד והיכן נוחת"
...
excerpt: "Generative AI עבר ממחקר לפריסה בייצור ב-2023. GPT-4, Claude 2, Llama 2 ו-Mistral הוכיחו שמודלי שפה גדולים יכולים לטפל בסקירת מסמכים משפטיים, יצירת קוד ודיאלוג עם לקוחות באיכות הדומה לאנושית — מה שהעלה שאלות ממשל מיידיות לגבי hallucination, דליפת נתונים ועמידה ברגולציה בשירותים פיננסיים."
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="תקציר המאמר">
<p class="post-lead-tldr"><strong>תקציר.</strong> בינה מלאכותית גנרטיבית עברה ממחקר לפריסה ייצורית ב-2023. ארכיטקטורת transformer — ובפרט מנגנון ה-self-attention — הקנתה למודלי שפה גדולים את היכולת לעבד הקשר ארוך טווח על פני מסמכים. GPT-4, Claude 2, Llama 2 ו-Mistral הגדירו את נוף המדדים של 2023. השירותים הפיננסיים ראו את הפריסות הארגוניות הראשונות בייצור קוד, סיכום מסמכי רגולציה ואוטומציה של KYC, אך שימוש ייצורי מחייב התמודדות עם סיכוני הלוצינציה, ממשל נתונים וציפיות רגולטוריות של מפקחים שעוקבים אחר ההתפתחויות באופן פעיל.</p>
<p class="post-lead-heading"><strong>תובנות מרכזיות</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>ה-Transformer הוא הבסיס.</strong> כל ה-LLM המובילים של 2023 בנויים על ארכיטקטורת ה-transformer מבוססת תשומת הלב שהוצגה ב-"Attention Is All You Need" (2017). מנגנון ה-self-attention מאפשר למודל לשקלל את הרלוונטיות של כל טוקן ביחס לכל טוקן אחר בחלון ההקשר — מה שמאפשר יצירה קוהרנטית של טקסט ארוך על פני אלפי טוקנים.</li>
  <li><strong>הסקאלה הובילה לשינוי איכותי.</strong> GPT-4 (מרץ 2023) השיג ציונים השקולים לאחוזון ה-90 בבחינת עורכי הדין האמריקאית ולאחוזון ה-99 בחלק המילולי של ה-GRE — מה שמדגים שסקאלת המודל יצרה יכולות שלא ניתן היה להסיק מקודמיו הקטנים יותר.</li>
  <li><strong>מודלים עם משקולות פתוחות שינו את משוואת הגישה.</strong> Llama 2 (Meta, יולי 2023) ו-Mistral 7B (ספטמבר 2023) הראו שמודלים תחרותיים עם מערכות GPT-3 קודמות יכולים לרוץ על חומרה סטנדרטית או תשתית פרטית — וביטלו את התלות בענן כחסם עבור תעשיות מוסדרות עם דרישות קפדניות לאחסון נתונים.</li>
  <li><strong>מקרי השימוש בשירותים פיננסיים אמיתיים הם, אך הסיכונים אינם טריוויאליים.</strong> עד סוף 2023, בנקים גדולים הריצו פיילוטים פנימיים לסקירת חוזים, סיכום שינויי רגולציה ופרודוקטיביות מפתחים. הסיכונים הייצוריים שלא נפתרו — הלוצינציה, הזרקת הנחיות, מסלולי ביקורת ומקור המודל — נותרו החסמים העיקריים לפריסה רחבה.</li>
</ul>
<p class="post-lead-related"><strong>קריאה נוספת:</strong> <a href="https://sebastienrousseau.com/2024-01-01-ai-trends-2024-insights-and-predictions-for-the-future">מגמות AI לשנת 2024: תובנות ותחזיות</a>, <a href="https://sebastienrousseau.com/2024-01-23-advancements-in-ai-prompt-engineering">הנדסת הנחיות AI 2024: טכניקות שעובדות</a>, <a href="https://sebastienrousseau.com/2024-02-13-eus-ai-act-shaping-the-future-of-global-ai-regulation">חוק ה-AI של האיחוד האירופי: חלוץ בוויסות AI אתי ברחבי העולם</a>.</p>
</aside>
<!-- lead-end -->

![ויזואליזציה מופשטת של רשת עצבית בגוני כחול וסגול המייצגת עיבוד AI](https://cloudcdn.pro/stocks/images/getty-images-aTWKwJllPOA.webp).class=\"img-fluid clearfix\"

> **סיכום מנהלים / תובנות מרכזיות**
>
> - **הארכיטקטורה שהחלה הכול.** מאמר ה-transformer משנת 2017 הציג את ה-self-attention: מנגנון המחשב משקולות רלוונטיות בין כל זוג טוקנים בקלט, ומחליף את העיבוד הסדרתי של RNN בפעולות מטריציות הניתנות לביצוע מקביל. כל מודל שפה גדול משנת 2023 הוא וריאנט של transformer ([Vaswani et al., 2017](https://arxiv.org/abs/1706.03762 "Attention Is All You Need")).
> - **GPT-4 כאמת מידה של 2023.** שוחרר במרץ 2023, GPT-4 השיג אחוזון 90 בבחינת הבר האמריקאית, אחוזון 99 ב-GRE Verbal, והפגין חשיבה רב-שלבית על פני מסמכים ארוכים. הוא קבע את אמת מידת היכולת שמודלים מאוחרים שאפו להשיג או לעלות עליה ([OpenAI, 2023](https://arxiv.org/abs/2303.08774 "GPT-4 Technical Report")).
...
<article class="related-card"><a href="https://sebastienrousseau.com/2024-01-01-ai-trends-2024-insights-and-predictions-for-the-future" class="related-media" aria-label="מגמות AI לשנת 2024: תובנות ותחזיות" tabindex="-1"><img alt="מבט רחפן על לונדון" src="https://cloudcdn.pro/stocks/images/drone-view-of-london.webp" loading="lazy" decoding="async" width="600" height="400" /></a><footer class="related-body"><h3><a href="https://sebastienrousseau.com/2024-01-01-ai-trends-2024-insights-and-predictions-for-the-future">מגמות AI לשנת 2024: תובנות ותחזיות</a></h3><p><time datetime="2024-01-01">2024-01-01</time></p></footer></article>
<article class="related-card"><a href="https://sebastienrousseau.com/2024-01-23-advancements-in-ai-prompt-engineering" class="related-media" aria-label="הנדסת הנחיות AI 2024: טכניקות שעובדות" tabindex="-1"><img alt="אדם מנתח נתונים על מסכים" src="https://cloudcdn.pro/stocks/images/ai-prompt-engineering-modern-office.webp" loading="lazy" decoding="async" width="600" height="400" /></a><footer class="related-body"><h3><a href="https://sebastienrousseau.com/2024-01-23-advancements-in-ai-prompt-engineering">הנדסת הנחיות AI 2024: טכניקות שעובדות</a></h3><p><time datetime="2024-01-23">2024-01-23</time></p></footer></article>
<article class="related-card"><a href="https://sebastienrousseau.com/2024-02-13-eus-ai-act-shaping-the-future-of-global-ai-regulation" class="related-media" aria-label="חוק ה-AI של האיחוד האירופי: רגולציה אתית חלוצית בעולם" tabindex="-1"><img alt="אדם יושב על ספסל שחור וקורא עיתון" src="https://cloudcdn.pro/stocks/images/ryoji-iwata-a-qsFZimp1M.webp" loading="lazy" decoding="async" width="600" height="400" /></a><footer class="related-body"><h3><a href="https://sebastienrousseau.com/2024-02-13-eus-ai-act-shaping-the-future-of-global-ai-regulation">חוק ה-AI של האיחוד האירופי: רגולציה אתית חלוצית בעולם</a></h3><p><time datetime="2024-02-13">2024-02-13</time></p></footer></article>
</div>
</aside>
<!-- enrich-end -->
