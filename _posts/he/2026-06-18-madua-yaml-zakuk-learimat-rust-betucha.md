...
| **בקרת גישה לסוכנים** | הרשאות לקריאה-בלבד מתוחמות לכלי AI מקומיים הפועלים דרך תצורות MCP. | ניהול סיכון מודל ([SR 11-7](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm)) | גבולות שרת MCP המגבילים פעולות סוכן לספריות מאושרות. |
