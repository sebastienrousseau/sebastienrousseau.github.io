...
banner_alt: "בלוקים של פנקס חשבונות דיגיטלי מופשט המחוברים על ידי מסלולי אור על רקע כהה"
banner_height: "100vh"
banner_width: "100vw"
...
date: "Jan 09, 2018"
description: "מבוא טכני לאופן פעולת הבלוקצ'יין: שרשרות hash קריפטוגרפיות, עצי Merkle, קונסנזוס מבוזר, ומדוע שכבת ה-programmable של Ethereum הפכה פנקס תשלומים לפלטפורמה לחוזים חכמים ונכסים טוקניזציה."
format-detection: "telephone=no"
hreflang: "he"
icon: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
id: "https://sebastienrousseau.com/he/2018-01-09-understanding-the-technology-behind-blockchain"
image_alt: "Black and White Portrait of Sebastien Rousseau"
image_height: "162"
image_width: "162"
image: "https://cloudcdn.pro/stocks/images/sebastienrousseau.webp"
keywords: "טכנולוגיית blockchain, cryptographic hash, עץ Merkle, distributed consensus, proof of work, Ethereum, חוזים חכמים, EVM, Solidity, ERC-20, distributed ledger, decentralised finance"
language: "he"
layout: "report"
locale: "he_IL"
...
permalink: "https://sebastienrousseau.com/he/2018-01-09-understanding-the-technology-behind-blockchain"
rating: "general"
referrer: "no-referrer"
revisit-after: "7 days"
robots: "index, follow"
short_name: "sebastienrousseau"
subtitle: "משרשרות hash קריפטוגרפיות לחוזים חכמים תכנותיים: המכניקה שהפכה את הבלוקצ'יין לפלטפורמה, לא רק ל-ledger."
tags: "blockchain, Ethereum, חוזים חכמים, cryptography, עץ Merkle, consensus mechanism, proof of work, EVM, Solidity, ERC-20, decentralised finance, ISO 20022, קריפטוגרפיה פוסט-קוונטית, AI, סטייבלקוינים, פיקדונות מתואדים"
theme-color: "0, 67, 165"
title: "הבנת הטכנולוגיה מאחורי הבלוקצ'יין"
url: "https://sebastienrousseau.com/he/2018-01-09-understanding-the-technology-behind-blockchain"
...
item_description: "מבוא טכני לבלוקצ'יין: שרשרות hash קריפטוגרפיות, עצי Merkle, קונסנזוס מבוזר, וכיצד Ethereum הרחיב ledger תשלומים לפלטפורמה תכנותית."
...
item_title: "הבנת הטכנולוגיה מאחורי הבלוקצ'יין"
...
apple-mobile-web-app-title: "טכנולוגיית Blockchain"
apple-touch-fullscreen: "yes"
msapplication-navbutton-color: "0, 67, 165"
twitter_card: "summary_large_image"
twitter_creator: "@wwdseb"
twitter_description: "כיצד עובד הבלוקצ'יין: שרשרות hash, עצי Merkle, מנגנוני קונסנזוס, וכיצד Ethereum הפך ledger לפלטפורמה תכנותית."
twitter_image: "https://cloudcdn.pro/clients/sebastienrousseau/v1/logos/sebastienrousseau.svg"
twitter_image_alt: "Logo of Sebastien Rousseau"
twitter_site: "@wwdseb"
twitter_title: "הבנת הטכנולוגיה של הבלוקצ'יין"
...
excerpt: "הבלוקצ'יין הוא ledger מסוג append-only המאובטח על ידי שרשרות hash קריפטוגרפיות וקונסנזוס מבוזר — עיצוב שהופך את החבלה ליקרה מבחינה חישובית וניתנת לביקורת על ידי כל אחד. Ethereum הרחיב את הבסיס הזה עם שכבת ביצוע תכנותית, והפך רשומת תשלומים פשוטה לפלטפורמה לחוזים חכמים, טוקנים ופיננסים מבוזרים."
last_reviewed: "2026-05-24"
---

<!-- lead-start -->
<aside class="post-lead" aria-label="תקציר המאמר">
<p class="post-lead-tldr"><strong>בקצרה.</strong> Blockchain הוא ספר חשבונות מבוזר שבו כל רשומה (בלוק) מקושרת קריפטוגרפית לקודמת לה. שינוי רשומה היסטורית כלשהי מבטל כל בלוק עוקב — תכונה שנאכפת לא על ידי רשות מרכזית אלא על ידי רשת של מאמתים עצמאיים הפועלים לפי אותם כללים. Ethereum הרחיב את העיצוב הזה עם שכבת ביצוע שלמה לפי טיורינג, מה שהפך את ספר החשבונות לתכנותי ופתח את הדרך לחוזים חכמים, אסימונים דיגיטליים ופיננסים מבוזרים.</p>
<p class="post-lead-heading"><strong>נקודות מפתח</strong></p>
<ul class="post-lead-takeaways">
  <li><strong>הבעיה הליבתית שנפתרה.</strong> ה-blockchain של Bitcoin טיפל בבעיית ההוצאה הכפולה ללא צד שלישי מהימן על ידי הפיכת היסטוריית העסקאות לעמידה בפני חבלה ומתוחזקת ביחד. הפתרון הסתמך על 30 שנות עבודה קודמת בפונקציות hash קריפטוגרפיות ומערכות מבוזרות.</li>
  <li><strong>כיצד בלוקים מתחברים בשרשרת.</strong> כל בלוק מכיל hash SHA-256 של כותרת הבלוק הקודם. שינוי בלוק אחד שובר כל hash עוקב ומחייב תוקף לבצע מחדש את כל ה-proof-of-work העוקב — בלתי אפשרי חישובית מעבר לכמה בלוקים ראשונים בשרשרת בשלה.</li>
  <li><strong>שכבת התכנות של Ethereum.</strong> Ethereum הוסיף את Ethereum Virtual Machine (EVM), סביבת ביצוע דטרמיניסטית המריצה קוד בית Solidity בכל צומת מלא בו-זמנית. חוזים חכמים — קוד שנפרס בשרשרת — מבצעים אטומית: הם מסתיימים לגמרי או חוזרים בחזרה, ללא מצב חלקי.</li>
  <li><strong>מספר חשבונות לפלטפורמה.</strong> תקן האסימון ERC-20, שהוגדר ב-2015, הראה כיצד ה-EVM יכול לאחסן אסימונים פטריים מבלי לשנות את הפרוטוקול הבסיסי. מאות אסימוני תשלום, stablecoins ואסימוני ממשל נבנו עליו בין 2017 ל-2020 — כולל אסימון EXTC המתואר במאמרים הנלווים באתר זה.</li>
</ul>
<p class="post-lead-related"><strong>קריאה נוספת:</strong> <a href="https://sebastienrousseau.com/2018-01-24-the-erc-20-token-standard">ERC-20: The Ethereum Token Interface That Changed the World</a>, <a href="https://sebastienrousseau.com/2018-02-04-unveiling-a-new-cryptocurrency-and-offering-future-faster-payment-solution">Unveiling a New Cryptocurrency and Faster Payment Solution</a>, <a href="https://sebastienrousseau.com/2018-02-15-the-making-of-the-express-transaction-credits-platform">The Making of the Express Transaction Credits Platform</a>.</p>
</aside>
<!-- lead-end -->
...
>
> - **הבעיה.** מזומן דיגיטלי מחייב פתרון בעיית ההוצאה הכפולה: מניעת הוצאת אותה יחידה פעמיים ללא מסלקה מהימנה. הדף הלבן של Bitcoin משנת 2008 פתר זאת על ידי החלפת מתווכים מהימנים בהוכחה קריפטוגרפית והסכמה מבוזרת ([Nakamoto, 2008](https://bitcoin.org/bitcoin.pdf "Bitcoin: A Peer-to-Peer Electronic Cash System")).
...
> - **הרחבת Ethereum.** ה-Yellow Paper של Ethereum (2014) הציג את ה-EVM — מכונת ערימה דטרמיניסטית הפועלת בכל צומת מלא. חוזים חכמים הם קוד בית הנפרס בשרשרת; הם מבצעים בצורה זהה בכל הצמתים ומתיישבים אטומית, ומחליפים מתווכים מהימנים בקוד אכיפה עצמית ([Wood, 2014](https://ethereum.github.io/yellowpaper/paper.pdf "Ethereum Yellow Paper")).
...
- **דטרמיניסטי.** אותו קלט תמיד מייצר אותו פלט.
- **עמידות בפני קדם-תמונה.** בהינתן פלט hash, בלתי אפשרי חישובית לשחזר את הקלט.
- **אפקט מפולת.** שינוי סיבית אחת של קלט משנה כמחצית מסיביות הפלט, מה שהופך חיפוש כוח גס ללא יעיל.
- **עמידות בפני התנגשויות.** בלתי אפשרי חישובית למצוא שני קלטים שונים המייצרים אותו hash.
