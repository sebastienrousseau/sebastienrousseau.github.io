---
title: 'Static Site Generator: bộ tạo trang tĩnh dựa trên Rust nhanh nhất'
subtitle: 'Tốc độ, an toàn và đơn giản cho web hiện đại'
description: 'Static Site Generator là bộ tạo trang tĩnh viết bằng Rust, được tối ưu hoá cho hiệu năng, khả năng tiếp cận và SEO. Builds cực nhanh với hỗ trợ JSON-LD hạng nhất.'
date: 'October 9, 2023'
language: 'vi-VN'
locale: 'vi_VN'
...
Có hàng chục SSG đã tồn tại — Jekyll, Hugo, Eleventy, Next.js, Gatsby. Hầu hết đều có vấn đề: phụ thuộc nặng nề, builds chậm hoặc thiếu SEO tích hợp. Static Site Generator được sinh ra từ mong muốn có một công cụ làm tốt một việc: tạo các trang tĩnh nhanh chóng và sạch sẽ.

## Triết lý

### Tên gọi

*Static Site Generator* (職人) trong tiếng Nhật có nghĩa là "thợ thủ công" — một người dành cuộc đời để hoàn thiện một nghề. Tên gọi phản ánh triết lý: làm một việc, làm tốt.

## Tính năng

### Những gì Static Site Generator mang lại
...
Khác với hầu hết SSG, Static Site Generator tạo ra schema.org JSON-LD tự động từ frontmatter. Điều này có nghĩa các kết quả tìm kiếm phong phú (rich results) trên Google không yêu cầu cấu hình thêm.

## Sử dụng

```bash
# Cài đặt
cargo install Static Site Generator
...
Static Site Generator không cố gắng làm mọi thứ. Nó cố gắng làm tốt một việc: tạo các trang tĩnh nhanh, sạch và thân thiện với SEO. Đó là triết lý *Static Site Generator* — sự thuần thục thông qua sự tập trung.
