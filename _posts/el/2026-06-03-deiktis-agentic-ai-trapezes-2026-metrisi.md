...
Πρώτον, οι ρυθμιστικές αρχές έπαψαν να αντιμετωπίζουν τα LLM ως καινοτομία. Η Federal Reserve έχει διευκρινίσει ότι το [SR 11-7 ⧉](https://web.archive.org/web/20260414150921/https://www.federalreserve.gov/supervisionreg/srletters/sr1107.htm "SR 11-7: Guidance on Model Risk Management") ισχύει για τη λήψη αποφάσεων βασισμένη σε LLM, ανεξάρτητα από το αν το LLM ταξινομείται εσωτερικά ως μοντέλο. Το [SS1/23 ⧉](https://www.bankofengland.co.uk/prudential-regulation/publication/2023/may/model-risk-management-principles-for-banks-ss "Supervisory Statement SS1/23") της PRA ήταν πάντα αρκετά ευρύ ώστε να τα καλύπτει. Η ταξινόμηση υψηλού κινδύνου του Κανονισμού AI της ΕΕ καλύπτει τις περισσότερες χρήσεις LLM στις χρηματοπιστωτικές υπηρεσίες. Δεν απομένει κανένα επιχείρημα του τύπου «δεν είμαστε σίγουροι αν αυτό μετράει».
