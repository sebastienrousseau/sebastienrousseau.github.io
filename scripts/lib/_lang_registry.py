...
LANGUAGES: tuple[Language, ...] = (
    ...
    Language("bn", "bn-BD", "bn_BD", "BN", "বাংলা", "🇧🇩", active=True),
    ...
    Language("fil", "fil-PH", "fil_PH", "FIL", "Filipino", "🇵🇭", active=True),
    Language("ha", "ha-NG", "ha_NG", "HA", "Hausa", "🇳🇬", active=True),
    Language("he", "he-IL", "he_IL", "HE", "עברית", "🇮🇱", rtl=True, active=True),
    ...
    Language("nl", "nl-NL", "nl_NL", "NL", "Nederlands", "🇳🇱", active=True),
    Language("pl", "pl-PL", "pl_PL", "PL", "Polski", "🇵🇱", active=True),
    Language("pt-br", "pt-BR", "pt_BR", "PT", "Português", "🇧🇷", active=True),
    Language("ro", "ro-RO", "ro_RO", "RO", "Română", "🇷🇴", active=True),
    ...
    Language("uk", "uk-UA", "uk_UA", "UK", "Українська", "🇺🇦", active=True),
