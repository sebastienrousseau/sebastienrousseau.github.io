...
# digraphs first
EL_DI = [('ου','ou'),('αι','ai'),('ει','ei'),('οι','oi'),('ευ','ef'),('αυ','af'),
         ('ντ','nt'),('μπ','b'),('γκ','gk'),('τσ','ts'),('τζ','tz')]
...
MR = {
 ...
 'ष':'sh','स':'s','ह':'h','ळ':'l','ऱ':'r','ऴ':'l','क्ष':'ksh','ज्ञ':'dny',
 'ा':'a','ॉ':'o','ॅ':'e','ॊ':'o','ि':'i','ी':'i','ु':'u','ू':'u','ृ':'ri','े':'e','ै':'ai','ो':'o','ौ':'au',
 '्':'','ं':'n','ः':'h','ँ':'n','़':'',
...
TA = {
 ...
 'க':'k','ங':'ng','ச':'ch','ஞ':'nj','ட':'t','ண':'n','த':'th','ந':'n','ப':'p','ம':'m',
 'ய':'y','ர':'r','ல':'l','வ':'v','ழ':'zh','ள':'l','ற':'r','ன':'n','ஜ':'j','ஷ':'sh',
 'ஸ':'s','ஹ':'h','ா':'a','ி':'i','ீ':'i','ு':'u','ூ':'u','ெ':'e','ே':'e','ை':'ai',
 'ொ':'o','ோ':'o','ௌ':'au','்':'','ஃ':'h',
}
# Telugu
TE = {
 'అ':'a','ఆ':'aa','ఇ':'i','ఈ':'ii','ఉ':'u','ఊ':'uu','ఋ':'ru','ఎ':'e','ఏ':'ee','ఐ':'ai',
 'ఒ':'o','ఓ':'oo','ఔ':'au','క':'k','ఖ':'kh','గ':'g','ఘ':'gh','ఙ':'ng','చ':'ch','ఛ':'chh',
 'జ':'j','ఝ':'jh','ఞ':'n','ట':'t','ఠ':'th','డ':'d','ఢ':'dh','ణ':'n','త':'t','థ':'th',
 'ద':'d','ధ':'dh','న':'n','ప':'p','ఫ':'ph','బ':'b','భ':'bh','మ':'m','య':'y','ర':'r',
 'ల':'l','వ':'v','శ':'sh','ష':'sh','స':'s','హ':'h','ళ':'l','ా':'a','ి':'i','ీ':'i',
 'ు':'u','ూ':'u','ృ':'ru','ె':'e','ే':'e','ై':'ai','ొ':'o','ో':'o','ౌ':'au','్':'','ం':'m','ః':'h',
}
# Arabic / Persian
AR = {
...
TABLES = {'el':EL,'ru':RU,'uk':UK,'hi':MR,'bn':BN,'mr':MR,'ta':TA,'te':TE,'ar':AR,'fa':AR,'he':HE}
DIGRAPHS = {'el':EL_DI}
...
STOP = {
 ...
 'ru':{'i','v','na','s','po','dlya','ot','do','za','kak','chto','eto','ne','pri','iz'},
 'uk':{'i','v','na','z','po','dlya','vid','do','za','yak','shcho','tse','ne','pry','iz'},
 'hi':{'ke','ki','ka','mein','se','aur','par','hai','ko','ek','ye','is'},
 'el':{'kai','to','tis','tou','ton','ti','sto','stin','gia','me','apo','o','i','ta','tha','einai','pos'},
 ...
 'ar':{'al','wa','fi','min','ila','ala','an','ma','hadha','allati','allathi','li','bi','la'},
 'fa':{'va','dar','az','be','ba','ke','in','an','ra','bar','ast','mi'},
 'he':{'ve','ha','be','le','shel','al','im','et','me','ki'},
 'hu':{'a','az','es','egy','hogy','nem','is','mint','vagy','ez','ezt','ami','meg','fel','ki','be'},
 'ms':{'dan','yang','di','ke','dari','untuk','pada','ini','itu','adalah','dengan','akan','atau'},
 'ro':{'si','in','la','de','pe','cu','un','o','este','pentru','care','din','ce','ale','al'},
 ...
 'cs':{'a','v','na','pro','se','je','od','do','po','za','ke','ku','o','u','s','z'},
 'de':{'der','die','das','und','fur','von','mit','im','in','den','dem','des','zu','auf','ein','eine'},
 'es':{'el','la','los','las','de','del','y','en','para','con','un','una','al','por','que'},
 'fr':{'le','la','les','des','du','de','et','en','pour','avec','un','une','au','aux','dans','qui'},
 'fil':{'ang','ng','mga','sa','at','na','ay','para','ito','isang','nang'},
 'id':{'dan','yang','di','ke','dari','untuk','pada','ini','itu','adalah','dengan','akan','atau'},
 'it':{'il','lo','la','i','gli','le','di','del','della','e','in','per','con','un','una','al','che'},
 'nl':{'de','het','een','en','van','voor','met','in','op','bij','aan','die','dat'},
 'pl':{'i','w','na','dla','z','do','po','za','o','u','od','the','jest','ktore'},
 'pt-br':{'o','a','os','as','de','do','da','dos','das','e','em','para','com','um','uma','ao','que'},
...
EXTRA = {'ɓ':'b','ɗ':'d','ƙ':'k','ƴ':'y','Ɓ':'b','Ɗ':'d','Ƙ':'k','Ƴ':'y',
         'ẹ':'e','ọ':'o','ṣ':'s','Ẹ':'e','Ọ':'o','Ṣ':'s','ŋ':'n','đ':'d','Đ':'d','ı':'i','İ':'i'}
...
_KO_INITIAL = ["g","kk","n","d","tt","r","m","b","pp","s","ss","","j","jj",
               "ch","k","t","p","h"]
_KO_MEDIAL = ["a","ae","ya","yae","eo","e","yeo","ye","o","wa","wae","oe","yo",
              "u","wo","we","wi","yu","eu","ui","i"]
_KO_FINAL = ["","k","k","ks","n","nj","nh","t","l","lk","lm","lb","ls","lt",
...
TH = {
 ...
 'ล':'l','ฦ':'lue','ว':'w','ศ':'s','ษ':'s','ส':'s','ห':'h','ฬ':'l','อ':'o',
 'ฮ':'h',
 'ะ':'a','ั':'a','า':'a','ำ':'am','ิ':'i','ี':'i','ึ':'ue','ื':'ue','ุ':'u',
 'ู':'u','ๅ':'a','ๆ':'','็':'','์':'','ฺ':'',
 '่':'','้':'','๊':'','๋':'','ํ':'','๎':'',
