...
CATEGORIES = [
    ...
    },
    {
        ...
        "items": [
            ...
            P("Rust · SSG",
              ...
              "Banner for the Shokunin Static Site Generator",
    ...
    },
    {
        ...
        "lede": "Starter templates and content destinations. From a Shokunin starter kit to two industry-focused publications on the future of banking.",
        "items": [
            P("Web · Template",
              "Kaishi. A Shokunin starter template",
              "https://cloudcdn.pro/clients/kaishi/v1/titles/title-kaishi.svg",
              "Banner for Kaishi, a starter template",
              "Make beautiful websites with Kaishi, a Shokunin Static Site Generator starter template designed for clean, accessible, performant sites.",
