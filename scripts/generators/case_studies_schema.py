...
def _study_url(lang: str, url_segment: str, slug: str) -> str:
    return f"/case-studies/{slug}/" if lang == "en" else f"/{lang}/{url_segment}/{slug}/"
...
def _build_article_jsonld(
    ...
    date_published = f"{period_year_match.group(1)}-01-01" if period_year_match else "2025-09-01"
    article: dict = {
        "@context": "https://schema.org",
        "@type": "Article",
        "@id": url + "#article",
