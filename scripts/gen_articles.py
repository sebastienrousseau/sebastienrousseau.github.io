...
ARTICLES = [
    ...
    ("2026-05-14", "May 14, 2026", "Post-Quantum · Treasury · Governance",
    ...
    ("2026-05-12", "May 12, 2026", "ISO 20022 · Payments · CBPR+",
    ...
    ("2026-05-11", "May 11, 2026", "AI · Quantum · Philosophy",
    ...
    ("2026-04-11", "April 11, 2026", "Quantum",
    ...
    ("2024-04-22", "April 22, 2024", "Quantum",
    ...
    ("2024-04-15", "April 15, 2024", "Quantum",
    ...
    ("2024-03-25", "March 25, 2024", "Quantum",
    ...
    ("2024-03-12", "March 12, 2024", "AI · macOS",
    ...
    ("2024-03-08", "March 8, 2024", "Open source · Rust",
    ...
    ("2024-02-26", "February 26, 2024", "AI",
    ...
    ("2024-02-19", "February 19, 2024", "AI",
    ...
    ("2024-02-13", "February 13, 2024", "Policy",
    ...
    ("2024-02-12", "February 12, 2024", "AI",
    ...
    ("2024-02-08", "February 8, 2024", "AI · Advertising",
    ...
    ("2024-01-15", "January 15, 2024", "Art",
    ...
    ("2024-01-08", "January 8, 2024", "Quantum · Finance",
    ...
    ("2023-12-25", "December 25, 2023", "Quantum · Finance",
    ...
    ("2023-12-18", "December 18, 2023", "AI · Quantum",
    ...
    ("2023-12-11", "December 11, 2023", "Quantum · Banking",
    ...
    ("2023-12-04", "December 4, 2023", "Open source · Rust",
    ...
    ("2023-11-28", "November 28, 2023", "Quantum · Rust",
    ...
    ("2023-11-19", "November 19, 2023", "Quantum",
    ...
    ("2023-11-12", "November 12, 2023", "AI",
    ...
    ("2023-11-05", "November 5, 2023", "Open source · Rust",
    ...
    ("2023-10-26", "October 26, 2023", "Open source · Rust",
    ...
    ("2023-10-16", "October 16, 2023", "Quantum · Rust",
    ...
    ("2023-09-29", "September 29, 2023", "Payments",
    ...
    ("2018-02-15", "February 15, 2018", "Blockchain",
    ...
    ("2018-02-04", "February 4, 2018", "Blockchain · Payments",
    ...
    ("2018-01-24", "January 24, 2018", "Blockchain",
    ...
    ("2018-01-09", "January 9, 2018", "Blockchain",
    ...
    ("2018-01-02", "January 2, 2018", "Blockchain",
    ...
    ("2018-01-01", "January 1, 2018", "Blockchain",
...
def card_block(eyebrow: str, title: str, image: str, alt: str, date_iso: str,
               date_display: str, excerpt: str, href: str) -> str:
