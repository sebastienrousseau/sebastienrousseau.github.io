 ...
 * @returns {string}
 */
export function argon2id_phc(password) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        wasm.argon2id_phc(retptr, ptr0, len0);
 ...
 * @returns {string}
 */
export function blake3_hex(input) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hsh_demo_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
